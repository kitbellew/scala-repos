...
object SecurityHeadersFilterSpec extends PlaySpecification {
  ...
  "security headers" should {
    ...
    "frame options" should {
      ...
      "work with custom frame options" in
        withApplication(
          Ok("hello"),
          """
        ...
        """.stripMargin) {
          ...
          header(X_FRAME_OPTIONS_HEADER, result) must
            beSome("some frame option")
        }
    ...
    "xss protection" should {
      ...
      "work with custom xss protection" in
        withApplication(
          Ok("hello"),
          """
    ...
    "content type options protection" should {
      ...
      "work with custom content type options protection" in
        withApplication(
          Ok("hello"),
          """
      ...
      "work with no content type options protection" in
        withApplication(
          Ok("hello"),
          """
