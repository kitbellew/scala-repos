...
trait JavaResultsHandlingSpec
  ...
  "Java results handling" should {
    ...
    "treat headers case insensitively" in
      makeRequest(
        new MockController {
          def action = {
    ...
    "chunk results that are streamed" in
      makeRequest(
        new MockController {
          def action = {
            Results.ok(
    ...
    "chunk legacy event source results" in
      makeRequest(
        new MockController {
          def action = {
            Results.ok(
    ...
    "chunk comet results from string" in
      makeRequest(
        new MockController {
          def action = {
    ...
    "chunk comet results from json" in
      makeRequest(
        new MockController {
          def action = {
