...
object TextBodyParserSpec extends PlaySpecification {
  ...
  "The text body parser" should {
    ...
    "parse text bodies" in
      new WithApplication() {
        parse("bar", Some("text/plain"), "utf-8") must beRight("bar")
      }

    "honour the declared charset" in
      new WithApplication() {
