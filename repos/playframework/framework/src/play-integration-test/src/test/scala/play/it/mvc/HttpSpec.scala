...
object HttpSpec extends org.specs2.mutable.Specification {
  ...
  "Absolute URL" should {
    ...
    "have HTTP scheme" in {
      (Call("GET", "/playframework").absoluteURL()(req)
        ...
        .and(
          Call("GET", "/playframework").absoluteURL(secure = false)(req)
    ...
    "have HTTPS scheme" in {
      ...
      )) and (Call("GET", "/playframework").absoluteURL(secure = true)(req).aka(
  ...
  "Web socket URL" should {
    ...
    "have WSS scheme" in {
      ...
      )) and (Call("GET", "/playframework").webSocketURL(secure = true)(req)
        .aka("absolute URL 2") must_== (
        "wss://playframework.com/playframework"
      ))
    }
