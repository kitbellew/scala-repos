  ...
  "DBModule" should {
    ...
    "bind databases by name" in
      new WithApplication(
        ...
        app.injector.instanceOf[DefaultComponent].db.url must_==
          "jdbc:h2:mem:default"
        app.injector.instanceOf[NamedDefaultComponent].db.url must_==
          "jdbc:h2:mem:default"
        app.injector.instanceOf[NamedOtherComponent].db.url must_==
          "jdbc:h2:mem:other"
      }

    "not bind default databases without configuration" in
      new WithApplication(
        _.configure(
          "db.other.driver" -> "org.h2.Driver",
          "db.other.url" -> "jdbc:h2:mem:other")) {
        app.injector.instanceOf[DBApi].databases must have size (1)
        app.injector.instanceOf[DefaultComponent] must
          throwA[com.google.inject.ConfigurationException]
        app.injector.instanceOf[NamedDefaultComponent] must
          throwA[com.google.inject.ConfigurationException]
        app.injector.instanceOf[NamedOtherComponent].db.url must_==
          "jdbc:h2:mem:other"
      }

    "not bind databases without configuration" in
      new WithApplication() {
        ...
        app.injector.instanceOf[NamedDefaultComponent] must
          throwA[com.google.inject.ConfigurationException]
        app.injector.instanceOf[NamedOtherComponent] must
          throwA[com.google.inject.ConfigurationException]
      }

    "allow default database name to be configured" in
      new WithApplication(
        _.configure(
    ...
    "allow db config key to be configured" in
      new WithApplication(
        _.configure(
