...
class HikariCPConfigSpec extends Specification {
  ...
  "When reading configuration" should {
    ...
    "set connectionInitSql config" in
      new Configs {
        val config = from("hikaricp.connectionInitSql" -> "SELECT 1")
        new HikariCPConfig(dbConfig, config)
          .toHikariConfig
          .getConnectionInitSql must beEqualTo("SELECT 1")
      }

    "respect the defaults as" in {
      "autoCommit to true" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
      ...
      "connectionTimeout to 30 seconds" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getConnectionTimeout must beEqualTo(30.seconds.toMillis)
        }
      ...
      "idleTimeout to 10 minutes" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getIdleTimeout must beEqualTo(10.minutes.toMillis)
        }
      ...
      "maxLifetime to 30 minutes" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getMaxLifetime must beEqualTo(30.minutes.toMillis)
        }
      ...
      "validationTimeout to 5 seconds" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getValidationTimeout must beEqualTo(5.seconds.toMillis)
        }
      ...
      "minimumIdle to 10" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getMinimumIdle must beEqualTo(10)
        }
      ...
      "maximumPoolSize to 10" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getMaximumPoolSize must beEqualTo(10)
        }
      ...
      "initializationFailFast to true" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .isInitializationFailFast must beTrue
        }
      ...
      "isolateInternalQueries to false" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .isIsolateInternalQueries must beFalse
        }
      ...
      "allowPoolSuspension to false" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .isAllowPoolSuspension must beFalse
        }
      ...
      "leakDetectionThreshold to 0 (zero)" in
        new Configs {
          new HikariCPConfig(dbConfig, reference)
            .toHikariConfig
            .getLeakDetectionThreshold must beEqualTo(0)
        }
    }
    ...
    "override the defaults for property" in {
      ...
      "connectionTimeout" in
        new Configs {
          ...
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .getConnectionTimeout must beEqualTo(40.seconds.toMillis)
        }
      ...
      "validationTimeout" in
        new Configs {
          val config = from("hikaricp.validationTimeout" -> "10 seconds")
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .getValidationTimeout must beEqualTo(10.seconds.toMillis)
        }
      ...
      "maximumPoolSize" in
        new Configs {
          ...
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .getMaximumPoolSize must beEqualTo(20)
        }

      "initializationFailFast" in
        new Configs {
          val config = from("hikaricp.initializationFailFast" -> "false")
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .isInitializationFailFast must beFalse
        }

      "isolateInternalQueries" in
        new Configs {
          val config = from("hikaricp.isolateInternalQueries" -> "true")
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .isIsolateInternalQueries must beTrue
        }

      "allowPoolSuspension" in
        new Configs {
          val config = from("hikaricp.allowPoolSuspension" -> "true")
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .isAllowPoolSuspension must beTrue
        }
      ...
      "leakDetectionThreshold" in
        new Configs {
          val config = from("hikaricp.leakDetectionThreshold" -> "3 seconds")
          new HikariCPConfig(dbConfig, config)
            .toHikariConfig
            .getLeakDetectionThreshold must beEqualTo(3000L)
        }
    }
  }
}
