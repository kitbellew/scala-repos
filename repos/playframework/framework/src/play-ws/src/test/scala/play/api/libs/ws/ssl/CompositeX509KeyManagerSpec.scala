  ...
  "CompositeX509KeyManager" should {
    ...
    "chooseEngineClientAlias" should {
      "not do anything with a X509KeyManager" in {
        ...
        val serverAlias = keyManager.chooseEngineClientAlias(
          keyType = keyType,
          issuers = issuers,
          engine = engine)
      ...
      "return a result" in {
        val mockKeyManager = mockExtendedX509KeyManager(clientResponse =
          "clientAlias")
        val keyManager = new CompositeX509KeyManager(Seq(mockKeyManager))
        val keyType = Array("derp")
        val issuers = Array[Principal]()
    ...
    "chooseEngineServerAlias" should {
      ...
      "not do anything with a X509KeyManager" in {
        ...
        val serverAlias = keyManager.chooseEngineServerAlias(
          keyType = keyType,
          issuers = issuers,
          engine = engine)
        serverAlias must beNull
      ...
      "return a result" in {
        val mockKeyManager = mockExtendedX509KeyManager(serverResponse =
          "serverAlias")
        val keyManager = new CompositeX509KeyManager(Seq(mockKeyManager))
        val keyType = "derp"
        val issuers = Array[Principal]()
    ...
    "chooseClientAlias" should {
      "return a result" in {
        ...
        mockKeyManager.chooseClientAlias(keyType, issuers, socket) returns
          "clientAlias"
    ...
    "getClientAliases" should {
      ...
      "return a result" in {
        ...
        mockKeyManager.getClientAliases(keyType, issuers) returns
          Array("clientAliases")
    ...
    "getServerAliases" should {
      "return a result" in {
        ...
        mockKeyManager.getServerAliases(keyType, issuers) returns
          Array("serverAliases")
    ...
    "chooseServerAlias" should {
      "work fine" in {
        ...
        mockKeyManager.chooseServerAlias(keyType, issuers, socket) returns
          "serverAlias"
