  ...
  "SSLConfigParser" should {
    ...
    "parse ws.ssl.debug section" in
      new WithApplication() {
        ...
        actual.debug.handshake must
          beSome.which { handshake =>
