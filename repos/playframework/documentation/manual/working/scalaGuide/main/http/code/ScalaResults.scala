  ...
  class ScalaResultsSpec extends PlaySpecification with Controller {
    ...
    "A scala result" should {
      ...
      "Setting and discarding cookies" in {
        ...
        val result3 = result.withCookies(
          Cookie("theme", "blue")).discardingCookies(DiscardingCookie("skin"))
        //#setting-discarding-cookies
      ...
      "HTML method works" in {
        val result = scalaguide.http.scalaresults.full.CodeShow.HTML(
          Codec.javaSupported("iso-8859-1"))
