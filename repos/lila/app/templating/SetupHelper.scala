...
trait SetupHelper {
  ...
  def translatedReasonChoices(implicit ctx: Context) =
    List(
  ...
  private def variantTuple(variant: chess.variant.Variant)(implicit
      ctx: Context): (String, String, Option[String]) =
    (variant.id.toString, variant.name, variant.title.some)

  def translatedVariantChoices(implicit ctx: Context) =
    List((
  ...
  def translatedSpeedChoices(implicit ctx: Context) =
    Speed.limited map { s =>
      (
        s.id.toString, {
  ...
  def translatedAnimationChoices(implicit ctx: Context) =
    List(
  ...
  def translatedBoardCoordinateChoices(implicit ctx: Context) =
    List(
  ...
  def translatedTakebackChoices(implicit ctx: Context) =
    List(
  ...
  def submitMoveChoices(implicit ctx: Context) =
    List(
  ...
  def translatedMessageChoices(implicit ctx: Context) =
    List(
