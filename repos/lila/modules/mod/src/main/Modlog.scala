...
case class Modlog(
  ...
  def showAction =
    action match {
      case Modlog.engine =>
        "mark as engine"
      case Modlog.unengine =>
        "un-mark as engine"
      case Modlog.booster =>
        "mark as booster"
      case Modlog.unbooster =>
        "un-mark as booster"
      case Modlog.deletePost =>
        "delete forum post"
      case Modlog.ban =>
        "ban user"
      case Modlog.ipban =>
      ...
      case Modlog.ipunban =>
        "unban IPs"
      case Modlog.closeAccount =>
        "close account"
      case Modlog.reopenAccount =>
        "reopen account"
      case Modlog.openTopic =>
        "reopen topic"
      case Modlog.closeTopic =>
        "close topic"
      case Modlog.showTopic =>
        "show topic"
      case Modlog.hideTopic =>
        "unfeature topic"
      case Modlog.setTitle =>
        "set FIDE title"
      case Modlog.removeTitle =>
        "remove FIDE title"
      case Modlog.setEmail =>
        "set email address"
      case Modlog.deleteQaQuestion =>
        "delete Q&A question"
      case Modlog.deleteQaAnswer =>
        "delete Q&A answer"
      case Modlog.deleteQaComment =>
        "delete Q&A comment"
      case Modlog.streamConfig =>
        "update streams config"
      case Modlog.deleteTeam =>
        "delete team"
      case Modlog.terminateTournament =>
...
object Modlog {
  ...
  private[mod] lazy val tube = JsTube[Modlog](
    (__.json update (merge(defaults) andThen readDate('date))) andThen
      Json.reads[Modlog],
