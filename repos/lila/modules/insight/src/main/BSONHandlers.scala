...
private object BSONHandlers {
  ...
  implicit val ColorBSONHandler =
    new BSONHandler[BSONBoolean, Color] {
  ...
  implicit val EcopeningBSONHandler =
    new BSONHandler[BSONString, Ecopening] {
  ...
  implicit val CastlingBSONHandler =
    new BSONHandler[BSONInteger, Castling] {
      def read(b: BSONInteger) =
  ...
  implicit val QueenTradeBSONHandler =
    new BSONHandler[BSONBoolean, QueenTrade] {
