...
object Quote {
  ...
  val all = Vector(
    ...
    new Quote(
      ...
      "Mikhail Botvinnik"),
    new Quote(
      "Althought the Knight is generally considered to be on a par with the Bishop in strength, the latter piece is somehat stronger in the majority of cases in which they are opposed to each other.",
      "Jose Capablanca"),
    new Quote(
