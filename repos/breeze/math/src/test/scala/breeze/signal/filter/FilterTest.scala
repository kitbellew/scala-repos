...
class FilterTest extends FunSuite {
  ...
  test(
    ...
    val spFirwin1 = DenseVector(
      1.40718797e-02, -7.94274374e-18, -1.16636001e-01, -1.75719493e-01,
      1.37640418e-01, 4.04633024e-01, 1.37640418e-01, -1.75719493e-01,
      -1.16636001e-01, -7.94274374e-18, 1.40718797e-02)

    val testSignal = DenseVector(
      -1.27168894, -1.48442932, -0.5481519, -0.53087595, 1.55426056, 1.30248503,
      0.06143029, 0.69251918, 0.68418296, 0.00401513, -0.52352089, 0.07456588,
      -0.68864501, 1.24677189, 0.48492816, -1.10078968, 0.41359423, 0.13732803,
      -0.05686372, -0.17045011)
    val spTestSignalFiltered1 = DenseVector(
      -0.01789505, -0.02088871, 0.14061118, 0.38912801, 0.17161298, -0.54231618,
    ...
    assert(
      norm(filtered1(0 to -6) - spTestSignalFiltered1(5 to -1)) <
        testNormThreshold,
  ...
  test("filterMedian") {
    ...
    val result2 =
      filterMedian(dataSmall, 5, OptOverhang.PreserveLength).toScalaVector
    ...
    val result4 =
      filterMedian(dataLarge, 5, OptOverhang.PreserveLength).toScalaVector
    assert(
