...
class SparseVectorOps_DoubleTest
    extends DoubleValuedTensorSpaceTestBase[SparseVector[Double], Int] {
...
/**
  ...
  */
@RunWith(classOf[JUnitRunner])
class SparseVectorOps_FloatTest
...
/**
  ...
  */
@RunWith(classOf[JUnitRunner])
class SparseVectorOps_IntTest
    extends TensorSpaceTestBase[SparseVector[Int], Int, Int] {
