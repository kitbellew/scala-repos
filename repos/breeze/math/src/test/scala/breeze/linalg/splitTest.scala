...
class splitTest extends FunSuite {
  test("split works on arrays with even multiple") {
    ...
    val expectedResult = Seq(
      DenseVector[Double](1, 2, 3, 4),
      DenseVector[Double](5, 6, 7, 8),
      DenseVector[Double](9, 10, 11, 12))
  ...
  test("hsplit works on dense matrix") {
    ...
    val expectedResult = List(
      DenseMatrix((0, 1, 2), (3, 4, 5), (3, 4, 5), (5, 4, 5)),
      DenseMatrix((3, 4, 5), (6, 7, 8), (6, 7, 8), (9, 7, 8)))
  ...
  test("vsplit works on dense matrix") {
    val mbig = DenseMatrix(
      ...
      (5, 4, 5, 9, 7, 8))
    val expectedResult = List(
      DenseMatrix((0, 1, 2, 3, 4, 5), (3, 4, 5, 6, 7, 8)),
      DenseMatrix((3, 4, 5, 6, 7, 8), (5, 4, 5, 9, 7, 8)))
