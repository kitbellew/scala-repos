...
object Gaussian
    extends ExponentialFamily[Gaussian, Double]
    with ContinuousDistributionUFuncProvider[Double, Gaussian] {
  ...
  /**
    ...
    */
  final case class SufficientStatistic(n: Double, mean: Double, M2: Double)
  ...
  def sufficientStatisticFor(t: Double) = { SufficientStatistic(1, t, 0) }
