...
object PaintScale {
  ...
  implicit def literalColorMap[T](
      map: PartialFunction[T, Paint]): CategoricalPaintScale[T] =
  ...
  lazy val MaroonToGold =
    createGradient(new Color(0xa0, 0x00, 0x00), new Color(0xff, 0xff, 0x00), 256)
