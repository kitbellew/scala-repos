...
/**
  ...
  */
case class SbtIncrementalOptions(
    nameHashing: Boolean,
    recompileOnMacroDef: Boolean,
    transitiveStep: Int,
    recompileAllFraction: Double) {
  def asString: String =
    s"$nameHashing;$recompileOnMacroDef;$transitiveStep;$recompileAllFraction"
...
object SbtIncrementalOptions {
  val Default = SbtIncrementalOptions(
    nameHashing = true,
