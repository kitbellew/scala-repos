...
object Dependencies {
  ...
  val sbtStructureExtractor012 = "org.jetbrains" %
    "sbt-structure-extractor-0-12" % sbtStructureVersion
  val sbtStructureExtractor013 = "org.jetbrains" %
    "sbt-structure-extractor-0-13" % sbtStructureVersion
  ...
  val sbtStructureCore = "org.jetbrains" % "sbt-structure-core_2.11" %
    sbtStructureVersion
  val evoInflector = "org.atteo" % "evo-inflector" % "1.2"
  val scalatestFindersPatched = "org.scalatest" % "scalatest-finders-patched" %
    "0.9.8"

  val plexusContainerDefault = "org.codehaus.plexus" %
    "plexus-container-default" % "1.5.5"
  val plexusClassworlds = "org.codehaus.plexus" % "plexus-classworlds" % "2.4"
  val plexusUtils = "org.codehaus.plexus" % "plexus-utils" % "3.0.8"
  val plexusComponentAnnotations = "org.codehaus.plexus" %
  ...
  val luceneHighlighter = "org.apache.lucene" % "lucene-highlighter" %
    luceneVersion
  ...
  val luceneQueryParser = "org.apache.lucene" % "lucene-queryparser" %
    luceneVersion
  val luceneAnalyzers = "org.apache.lucene" % "lucene-analyzers-common" %
    luceneVersion
  ...
  val sisuInjectPlexus = "org.sonatype.sisu" % "sisu-inject-plexus" %
    sisuInjectVersion
  val sisuInjectBean = "org.sonatype.sisu" % "sisu-inject-bean" %
    sisuInjectVersion
  val sisuGuice = "org.sonatype.sisu" % "sisu-guice" % "3.0.3"

  val wagonHttp = "org.apache.maven.wagon" % "wagon-http" % wagonVersion
  val wagonHttpShared = "org.apache.maven.wagon" % "wagon-http-shared" %
    wagonVersion
  val wagonProviderApi = "org.apache.maven.wagon" % "wagon-provider-api" %
    wagonVersion
  ...
  val macroParadise = "org.scalamacros" % "paradise" % "2.1.0-M5" cross
    CrossVersion.full

  val nailgun = "org.jetbrains" % "nailgun-patched" % "1.0.0"
  val compilerInterfaceSources = "org.jetbrains" %
    "compiler-interface-sources" % "1.0.0"
...
object DependencyGroups {
  ...
  val mavenIndexer = Seq(mavenIndexerCore, mavenModel) ++ plexusContainer ++
    lucene ++ aether ++ sisu ++ wagon
  ...
  val scalaRunner = Seq(
    "org.specs2" %% "specs2" % "2.3.11" % "provided" excludeAll
  ...
  val sbtLaunchTestDownloader = Seq(
    "0.12.4",
    "0.13.0",
    "0.13.1",
    "0.13.2",
