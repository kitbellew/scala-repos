...
class RedundantHeadOptionTest extends OperationsOnCollectionInspectionTest {
  ...
  def test1(): Unit = {
    doTest(s"Some(1).${START}headOption$END", "Some(1).headOption", "Some(1)")
  }
  ...
  def test3(): Unit = {
    doTest(s"None.${START}headOption$END", "None.headOption", "None")
  }
...
class RedundantLastOptionTest extends OperationsOnCollectionInspectionTest {
  ...
  def test1(): Unit = {
    doTest(s"Some(1).${START}lastOption$END", "Some(1).lastOption", "Some(1)")
  }
  ...
  def test3(): Unit = {
    doTest(s"None.${START}lastOption$END", "None.lastOption", "None")
  }
