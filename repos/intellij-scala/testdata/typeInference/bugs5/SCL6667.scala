object SCL6667 {
  ...
  case class DivideNumeric(expression1: Expression, expression2: Expression)
      extends Expression.Aux[DivideNumeric]

  case class AddNumeric(expressions: List[Expression])
