...
object PhoneCode {
  ...
  def main(args: Array[String]) {
    ...
    val foundButNotExpected =
      resultFormatted.filterNot(correctResult).toList.sorted
    val expectedButNotFound =
      correctResult.filterNot(resultFormatted).toList.sorted
