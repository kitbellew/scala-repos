...
object HoconSyntaxHighlighter extends SyntaxHighlighter {
  ...
  private val tokenHighlights = Map[IElementType, Array[TextAttributesKey]](
    ...
    StringEscapesTokenTypes
      .VALID_STRING_ESCAPE_TOKEN -> Array(HHC.ValidStringEscape),
    StringEscapesTokenTypes
      .INVALID_CHARACTER_ESCAPE_TOKEN -> Array(HHC.InvalidStringEscape),
    StringEscapesTokenTypes
      .INVALID_UNICODE_ESCAPE_TOKEN -> Array(HHC.InvalidStringEscape)
  )
