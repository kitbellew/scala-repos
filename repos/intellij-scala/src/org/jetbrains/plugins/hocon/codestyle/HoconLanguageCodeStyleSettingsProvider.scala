    ...
    settingsType match {
      case SPACING_SETTINGS =>
        ...
        showCustomOption(
          ...
          SPACES_AROUND_OPERATORS)
        showCustomOption(
          "SPACE_BEFORE_ASSIGNMENT",
          "Before assignment ('=' and '+=')",
          SPACES_AROUND_OPERATORS)
        showCustomOption(
          "SPACE_AFTER_ASSIGNMENT",
          "After assignment ('=' and '+=')",
          SPACES_AROUND_OPERATORS)
        showCustomOption(
          "SPACE_BEFORE_LBRACE_AFTER_PATH",
          "Immediately after path expression",
          SPACES_BEFORE_LEFT_BRACE)
        showCustomOption(
          "SPACE_WITHIN_SUBSTITUTION_BRACES",
          "Substitution braces",
          SPACES_WITHIN)
      ...
      case WRAPPING_AND_BRACES_SETTINGS =>
        ...
        showCustomOption(
          "HASH_COMMENTS_AT_FIRST_COLUMN",
          "Hash comments at first column",
          WRAPPING_KEEP)
        showCustomOption(
          "DOUBLE_SLASH_COMMENTS_AT_FIRST_COLUMN",
        ...
        showCustomOption(
          ...
          WRAP_VALUES)
        showCustomOption(
          "LISTS_ALIGN_WHEN_MULTILINE",
          "Align when multiline",
          ListsWrap)
        showCustomOption(
          "LISTS_NEW_LINE_AFTER_LBRACKET",
          "New line after '['",
          ListsWrap)
        showCustomOption(
          "LISTS_RBRACKET_ON_NEXT_LINE",
          "Place ']' on new line",
          ListsWrap)
        ...
        showCustomOption(
          "OBJECT_FIELDS_COLON_ON_NEXT_LINE",
          "Colon on next line",
          ObjectFieldsWithColonWrap)
      ...
      case BLANK_LINES_SETTINGS =>
        ...
        showCustomOption(
          ...
          BLANK_LINES_KEEP)
        showCustomOption(
          "KEEP_BLANK_LINES_IN_LISTS",
          "In lists",
          BLANK_LINES_KEEP)
        showCustomOption(
          "KEEP_BLANK_LINES_BEFORE_RBRACKET",
          "Before ']'",
          BLANK_LINES_KEEP)
