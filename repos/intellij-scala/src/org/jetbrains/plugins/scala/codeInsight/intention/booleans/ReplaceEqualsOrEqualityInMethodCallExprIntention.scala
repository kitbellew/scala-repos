...
class ReplaceEqualsOrEqualityInMethodCallExprIntention
  ...
  override def invoke(project: Project, editor: Editor, element: PsiElement) {
    ...
    expr.append(
      methodCallExpr.getInvokedExpr.asInstanceOf[
        ScReferenceExpression].qualifier.get.getText).append(".").append(
      replaceOper(oper)).append(methodCallExpr.args.getText)
