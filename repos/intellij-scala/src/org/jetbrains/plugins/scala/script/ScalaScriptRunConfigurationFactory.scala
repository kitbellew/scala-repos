...
/**
  ...
  * Date: 04.02.2009
  */
class ScalaScriptRunConfigurationFactory(val typez: ConfigurationType)
  ...
  override def createConfiguration(
    ...
    val configuration = (super.createConfiguration(
      name,
      template)).asInstanceOf[ScalaScriptRunConfiguration]
