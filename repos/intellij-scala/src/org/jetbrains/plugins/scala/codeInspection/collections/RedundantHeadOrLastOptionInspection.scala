...
/**
  ...
  */
class RedundantHeadOrLastOptionInspection
    extends OperationOnCollectionInspection {
  override def possibleSimplificationTypes: Array[SimplificationType] =
    Array(RedundantHeadOption, RedundantLastOption)
}

object RedundantHeadOption extends SimplificationType {
  override def hint: String =
    InspectionBundle.message("remove.redundant.headOption")
...
object RedundantLastOption extends SimplificationType {
  override def hint: String =
    InspectionBundle.message("remove.redundant.lastOption")
