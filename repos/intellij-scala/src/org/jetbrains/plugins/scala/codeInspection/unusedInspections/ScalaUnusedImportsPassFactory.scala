...
/**
  ...
  * Date: 15.06.2009
  */
class ScalaUnusedImportsPassFactory(
    project: Project,
  ...
  def createHighlightingPass(
    ...
    val textRange: TextRange = FileStatusMap
      .getDirtyTextRange(editor, Pass.UPDATE_ALL)
  ...
  override def createMainHighlightingPass(
      file: PsiFile,
      document: Document,
