...
trait ScTemplateDefinition extends ScNamedElement with PsiClass {
  ...
  def allVals =
    TypeDefinitionMembers
      ...
      .map {
        case (_, n) =>
          (n.info.namedElement, n.substitutor)
      }
      ...
      case None =>
        ...
        eBlockNode.addChild(
          ScalaPsiElementFactory
            .createBodyFromMember(member, member.getManager)
            .getNode)
        return members(0)
    }
    member
        ...
        drv match {
          case drg: ScTemplateDefinition =>
            ...
            while (supersIterator.hasNext) {
              ...
              val value =
                baseClass match {
                  case _: ScTrait if c.isInstanceOf[ScTrait] =>
                    true
                  case _: ScClass if c.isInstanceOf[ScClass] =>
                    true
                  case _ if !c.isInstanceOf[ScTemplateDefinition] =>
                    true
                  case _ =>
                    false
                }
