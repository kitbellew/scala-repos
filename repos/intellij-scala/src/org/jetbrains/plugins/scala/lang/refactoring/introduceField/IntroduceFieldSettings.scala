...
class IntroduceFieldSettings[T <: PsiElement](ifc: IntroduceFieldContext[T]) {
  ...
  val canBeInitLocally: Boolean = canBeInitLocalIfReplaceAll ||
  ...
  def defineVar = isVar
  def defineVar_=(value: Boolean) {
    isVar = value
  }
  def setDefineVar(value: Boolean) {
    defineVar = value
  }
  ...
  def setReplaceAll(value: Boolean) {
    replaceAll = value
  }
  ...
  def explicitType_=(value: Boolean) {
    explType = value
  }
  def setExplicitType(value: Boolean) {
    explicitType = value
  }
  ...
  def setInitInDeclaration(value: Boolean) {
    initInDeclaration = value
  }
