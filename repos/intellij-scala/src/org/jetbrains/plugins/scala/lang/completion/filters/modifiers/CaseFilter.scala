    ...
    if (leaf != null && leaf.getParent != null) {
      ...
      if (parent.getParent != null) {
        parent.getParent.getParent match {
          case _: ScCaseClause =>
            if (parent.getParent.getParent.getNode
        ...
        case _: ScBlockExpr | _: ScTemplateBody =>
          ...
          if (leaf.getPrevSibling == null ||
              ...
              leaf.getPrevSibling.getPrevSibling.getNode.getElementType !=
                ScalaTokenTypes.kDEF) return true
        case _: ScCaseClause =>
          if (parent.getParent.getNode
                .findChildByType(ScalaTokenTypes.tFUNTYPE) != null) return true
          else return false
        case _ =>
      }
      if (leaf.getPrevSibling != null &&
      ...
      if (parent.isInstanceOf[ScTemplateBody]) {
        if (leaf.getPrevSibling != null &&
            ...
            leaf.getPrevSibling.getPrevSibling.getLastChild.getNode
