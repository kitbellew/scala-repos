  ...
  def mirrorMethodCall: Option[ScMethodCall] = {
    getLExpression match {
      case ref: ScReferenceExpression =>
        ...
        mirrorExpr match {
          case call: ScMethodCall =>
            call.getInvokedExpr.asInstanceOf[ScReferenceExpression]
      ...
      case methodCall: ScMethodCall =>
        ...
        val text = s"${invokedExpr.getText}.update(${methodCall.args.exprs
            ...
            ScalaPsiUtil.nameContext(r.element) match {
              ...
              case fun: ScFunction
                ...
                val processor = new MethodResolveProcessor(
                  ref,
                  fun.name + "_=",
                  getRExpression.map(expr => List(Seq(new Expression(expr))))
                    .getOrElse(Nil),
                  Nil,
