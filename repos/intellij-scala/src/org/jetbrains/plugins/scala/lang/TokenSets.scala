...
object TokenSets {
  val WHITESPACE_OR_COMMENT_SET = TokenSet.create(
  ...
  val TMPL_OR_PACKAGING_DEF_BIT_SET = TokenSet.create(
    PACKAGING,
    OBJECT_DEF,
    CLASS_DEF,
    TRAIT_DEF,
  ...
  val SELF_TYPE_ID = TokenSet.create(
  ...
  val FUNCTIONS = TokenSet.create(
    ...
    ScalaElementTypes.MACRO_DEFINITION)
