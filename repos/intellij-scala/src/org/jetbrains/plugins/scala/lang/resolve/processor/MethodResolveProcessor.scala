...
object MethodResolveProcessor {
  private def problemsFor(
    ...
    val realResolveResult =
      c.innerResolveResult match {
        case Some(rr) =>
          rr
        case _ =>
          c
    ...
    def constructorCompatibility(
      ...
      val classTypeParameters: Seq[ScTypeParam] = constr
