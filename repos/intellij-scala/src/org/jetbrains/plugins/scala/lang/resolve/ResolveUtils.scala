    ...
    memb.getContainingFile match {
      case file: ScalaFile if file.isCompiled =>
        place.getContainingFile match {
          ...
          case _ =>
          //todo: is it neccessary? added to avoid performance and other problems
        }
      case _ =>
    }
        ...
        scMember.getModifierList.accessModifier match {
          ...
          case Some(am: ScAccessModifier) =>
            if (am.isPrivate) {
              ...
              if (ref != null) {
                ...
                def processPackage(packageName: String): Boolean = {
                  ...
                  while (placeEnclosing != null &&
                         placeEnclosing
                           .isInstanceOf[ScObject] && !placeEnclosing
              ...
              //todo: it's wrong if reference after not appropriate class type
              val withCompanion =
              ...
              if (ref != null) {
                ...
                bind match {
                  ...
                  case pack: PsiPackage =>
                    //like private (nothing related to real life)
                    val packageName = pack.getQualifiedName
