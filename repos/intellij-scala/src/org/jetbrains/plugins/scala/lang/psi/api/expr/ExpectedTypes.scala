      ...
      expr.getContext match {
        ...
        case b: ScBlockExpr =>
          b.lastExpr match {
            case Some(e)
                if b
                  .needCheckExpectedType && e == expr.getSameElementInContext =>
            ...
            case ref: ScReferenceExpression
                if (
                  !a.getContext.isInstanceOf[ScArgumentExprList] && !(
                    a.getContext.isInstanceOf[ScInfixArgumentExpression] && a
                      .getContext
            ...
            val tps =
              callExpression match {
                ...
                case _ =>
                  Array(
                    (
                      callExpression.getNonValueType(TypingContext.empty),
                      false))
              }
            tps.foreach {
        ...
        case infix: ScInfixExpr
            if (
              (
                ...
                (
                  !infix
                    .isLeftAssoc && infix.rOp == expr.getSameElementInContext
                )
        ...
        case args: ScArgumentExprList =>
          ...
          if (callExpression != null) {
            var tps: Array[(TypeResult[ScType], Boolean)] =
              callExpression match {
                case ref: ScReferenceExpression =>
                  if (!withResolvedFunction)
                    mapResolves(ref.shapeResolve, ref.shapeMultiType)
