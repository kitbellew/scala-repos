...
class ScalaTestGenerator extends TestGenerator {
  ...
  private def generateTestInternal(
      project: Project,
      d: CreateTestDialog): PsiFile = {
    ...
    val typeDefinition = file.depthFirst.filterByType(classOf[ScTypeDefinition])
      .next()
    ...
    val positionElement = typeDefinition.extendsBlock.templateBody
      .map(_.getFirstChild).getOrElse(typeDefinition)
  ...
  private def addSuperClass(
      typeDefinition: ScTypeDefinition,
      psiClass: Option[PsiClass],
      fqName: String) = {
    ...
    psiClass match {
      case Some(cls) =>
        ...
        classParents.depthFirst
          .filterByType(classOf[ScStableCodeReferenceElement]).next()
          .bindToElement(cls)
      ...
      case Some(body) =>
        ...
        if (isInheritor(typeDef, "org.scalatest.FeatureSpecLike") ||
          ...
          ScalaTestGenerator.generateScalaTestBeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.addScalaTestFlatSpecMethods(
            methodsList,
            psiManager,
            body,
            className)
          ...
          ScalaTestGenerator.generateScalaTestBeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.addScalaTestFunSpecMethods(
            methodsList,
            psiManager,
            body,
            className)
          ...
          ScalaTestGenerator.generateScalaTestBeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.addScalaTestWordSpecMethods(
            methodsList,
            psiManager,
            body,
            className)
          ...
          ScalaTestGenerator.generateSpecs2BeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.generateSpecs2ScriptSpecificationMethods(
            methodsList,
            psiManager,
            body,
            className,
          ...
          ScalaTestGenerator.generateSpecs2BeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.addSpecs2SpecificationMethods(
            methodsList,
            psiManager,
            body,
            className,
          ...
          ScalaTestGenerator.generateSpecs2BeforeAndAfter(
            ...
            typeDef,
            editor.getProject)
          ScalaTestGenerator.generateSpecs2MutableSpecificationMethods(
            methodsList,
            psiManager,
            body,
            className)
          ...
          ScalaTestGenerator.generateUTestMethods(
            methodsList,
            psiManager,
            body,
            className,
...
object ScalaTestGenerator {
  ...
  private def generateScalaTestBeforeAndAfter(
      generateBefore: Boolean,
      generateAfter: Boolean,
      typeDef: ScTypeDefinition,
      project: Project) {
    ...
    typeDef.extendsBlock.templateBody match {
      case Some(body) =>
        Option(ScalaPsiManager.instance(project).getCachedClass(
  ...
  private def generateSpecs2BeforeAndAfter(
      generateBefore: Boolean,
      generateAfter: Boolean,
      typeDef: ScTypeDefinition,
      project: Project) {
        ...
        if (generateBefore) {
          ...
          beforeOpt match {
            case Some(beforeTypeDef) =>
              ExtractSuperUtil.addExtendsTo(
                typeDef,
                beforeTypeDef.asInstanceOf[ScTypeDefinition])
              body.addBefore(
                ScalaPsiElementFactory.createMethodFromText(
        ...
        if (generateAfter) {
          ...
          afterOpt match {
            case Some(afterTypeDef) =>
              ExtractSuperUtil.addExtendsTo(
                typeDef,
                afterTypeDef.asInstanceOf[ScTypeDefinition])
              body.addBefore(
                ScalaPsiElementFactory.createMethodFromText(
  ...
  private def addScalaTestFeatureSpecMethods(
  ...
  private def addScalaTestFreeSpecMethods(
      methods: List[MemberInfo],
      psiManager: PsiManager,
      templateBody: ScTemplateBody) {
    if (methods.nonEmpty) {
  ...
  private def addScalaTestPropSpecMethods(
      methods: List[MemberInfo],
      psiManager: PsiManager,
      templateBody: ScTemplateBody) {
    if (methods.nonEmpty) {
  ...
  private def addScalaTestWordSpecMethods(
      methods: List[MemberInfo],
      psiManager: PsiManager,
      templateBody: ScTemplateBody,
      className: String) {
  ...
  private def generateSpecs2MutableSpecificationMethods(
      methods: List[MemberInfo],
      psiManager: PsiManager,
      templateBody: ScTemplateBody,
      className: String) {
