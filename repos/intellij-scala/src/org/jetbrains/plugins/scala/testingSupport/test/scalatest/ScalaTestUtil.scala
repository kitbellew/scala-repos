...
object ScalaTestUtil {
  def getFunSuiteBases: List[String] = List(
  ...
  def getFeatureSpecBases: List[String] = List(
  ...
  def getFreeSpecBases: List[String] = List(
  ...
  def getJUnit3SuiteBases: List[String] = List(
    "org.scalatest.junit.JUnit3Suite")

  def getJUnitSuiteBases: List[String] =
    List("org.scalatest.junit.JUnitSuite", "org.scalatest.junit.JUnitSuiteLike")

  def getPropSpecBases: List[String] = List(
  ...
  def getFunSpecBasesPre2_0: List[String] = List(
    "org.scalatest.Spec",
  ...
  def getFunSpecBasesPost2_0: List[String] = List(
  ...
  def getTestNGSuiteBases: List[String] = List(
    "org.scalatest.testng.TestNGSuite",
    "org.scalatest.testng.TestNGSuiteLike")

  def getFlatSpecBases: List[String] = List(
  ...
  def getWordSpecBases: List[String] = List(
