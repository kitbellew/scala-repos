...
object SimpleBuildFileModifier {
  ...
  def buildLibraryDependenciesPsi(
      project: IJProject,
      inName: Option[String],
      dependencies: Seq[String]): Option[PsiElement] =
    createSeqPsiExpr(project, inName, "libraryDependencies", dependencies)

  def buildResolversPsi(
      project: IJProject,
      inName: Option[String],
      resolvers: Seq[String]): Option[PsiElement] =
    createSeqPsiExpr(project, inName, "resolvers", resolvers)

  def buildScalacOptionsPsi(
      project: IJProject,
      inName: Option[String],
      options: Seq[String]): Option[PsiElement] =
