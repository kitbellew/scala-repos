    ...
    "Handle V1 formats" in {
      ...
      records mustEqual Success(
        List(
          ...
          APIKeyRecord(
            "01D60F6D-E8B6-480C-8D55-2986853D67A6",
            Some("root-apiKey"),
            Some("The root API key"),
            "(undefined)",
            Set("e5fa39314ca748818e52c50d2d445a6f4d9f9a224ddb4e55bf7c03e2a21fb36ff2bbff861aec43a18cccf2ee7f38841e"),
            true
          ),
          APIKeyRecord(
            "F2440B9B-D8CA-42AD-BF83-C693F0A5F018",
            None,
            None,
            "17D42117-EF8E-4F43-B833-005F4EBB262C",
            Set("75826da768b64748b8423cdd047d7e8f6361e5bb50d8428080feaf1c0c6269600982be9e1c9f4299bf521aac95065ace"),
            false
          ),
          APIKeyRecord(
            "D9302C66-1F43-412E-B277-4E2EF675A304",
            Some("root-apiKey"),
            Some("The root API key"),
            "(undefined)",
            Set("f0fcc670d19d44fd9f99bd5d03e569fbcab6b5a679fb48089944772d16a43eb73643dca2c885431db100fb3d650c342b"),
            true
          ),
          APIKeyRecord(
            "A09D8293-A28F-4422-B375-9C0CDF75DC68",
            Some("root-apiKey"),
            Some("The root API key"),
            "(undefined)",
...
{ "gid" : "da22fe7", "cid": "(undefined)", "issuer" : "91cb868", "permission" : { "type" : "write", "path" : "/test/", "expirationDate" : null } }
    ...
    "Deserialize NewGrantRequest without parentIds" in {
      (JObject("permissions" -> JArray()))
        .validated[v1.NewGrantRequest] must beLike { case Success(_) =>
        ok
      }
    }
  }
