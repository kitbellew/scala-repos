...
trait LinearRegressionSpecs extends EvalStackSpecs {
  ...
  "linear regression" should {
    ...
    "handle multiple indep vars, one of which is a constant" in {
      ...
      def testResult(
          resValues: Array[BigDecimal],
          resVarCovar: Array[Vector[SValue]],
          elems: Map[String, SValue],
          constant: Boolean) = {
        elems.keys mustEqual Set("model1")
    ...
    "predict when nulls are present in the regression model" in {
      ...
      val count = resultCount.collectFirst {
      ...
      predResults mustEqual Set(
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.29431560466544177), SDecimal(0.7010718864763299))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0851091500695673), SDecimal(1.4918654318804554)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.09168503550146807),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5851022333835115), SDecimal(0.4017321623805754))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3785265042883241), SDecimal(1.1951564332853881)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.41044957243898667),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.13780702485772428), SDecimal(0.9587061697356976))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.8983994376088162), SDecimal(1.7192985824867897)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.34350266219169356),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.15613475300076995), SDecimal(0.8431400773841571))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9457366411511546), SDecimal(1.6327419655345419)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.3664477456323341),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.23055994092248494), SDecimal(0.9634554321871531))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9635592515031257), SDecimal(1.6964547427677938)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.29914967551765137),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.7742788311824955), SDecimal(0.17597948014719278))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.5790903574191737), SDecimal(0.9807910063838711)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.022684748200555035),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.4898668510205224), SDecimal(0.4444973546194123))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2996967104855732), SDecimal(1.2543272140844632)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.23185255903279373),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.6846724956403343), SDecimal(0.22096737757474683))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.5036805071503851), SDecimal(1.0399753890847976)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(Vector(
              ...
              SDecimal(0.37108611306600403))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.1137130683009206), SDecimal(1.322393503553235)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.12491148621376584),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5735350403390753), SDecimal(0.3237120679115436))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3952514123515578), SDecimal(1.145428439924026)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.07369191728264393),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5673976301980359), SDecimal(0.7147814647633237))),
            "predictionInterval" -> SArray(
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.32431880487926934), SDecimal(0.6439553450087723))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.1234935166648408), SDecimal(1.4431300567943437)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.17753635730419182),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.6672157676701567), SDecimal(0.31214305306177303))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.4629492713361403), SDecimal(1.1078765567277564)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.05314337388394709),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.4396759324088084), SDecimal(0.33338918464091427))),
            "predictionInterval" -> SArray(
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.7744700890718244), SDecimal(0.14679958506541996))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.588466527213795), SDecimal(0.9607960232073907)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.24955772615782634),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.8258596856896088), SDecimal(0.3267442333739561))),
            "predictionInterval" -> SArray(
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.17900619990234334), SDecimal(0.7560923694692102))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9886032530470941), SDecimal(1.5656894226139608)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.21068040495425405),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.588435827141518), SDecimal(0.16707501723300994))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.4577568234690235), SDecimal(1.0363960135605153)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.08002882783141475),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.543625794379431), SDecimal(0.38356813871660156))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.355733567187771), SDecimal(1.1956759115249416)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.16098562305018183),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.2120317372092274), SDecimal(0.5340029833095911))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0846637600743971), SDecimal(1.4066350061747608)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.2163660943315413),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.12064440737692839), SDecimal(0.553376596040011))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0189785996245788), SDecimal(1.4517107882876614)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(-0.009355951358066453),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5430850388059062), SDecimal(0.5243731360897733))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3121863982741837), SDecimal(1.2934744955580506)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.23267835643463947),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.17818883336490904), SDecimal(0.6435455462341879))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0248240420829635), SDecimal(1.4901807549522426)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.023449692507401948),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.36960590484028055), SDecimal(0.4165052898550844))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2283462721889578), SDecimal(1.2752456572037616)))
          )))),
        SObject(
          Map("model1" -> SObject(Map(
            "fit" -> SDecimal(0.03949810192952638),
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.52151233487641), SDecimal(0.6005085387354628))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2747443204678535), SDecimal(1.3537405243269063)))
          ))))
      )
    }
  }
