                                ...
                                Map(
                                  "x1" ->
                                    SObject(
                                      Map(
                                        "estimate" ->
                                          SDecimal(-0.000353609260803943),
                                        "standardError" ->
                                          SDecimal(0.0004151165550576799))),
                                  "x2" ->
                                    SObject(
                                      Map(
                                        "standardError" ->
                                          SDecimal(0.03963546815108074),
                                        "estimate" ->
                                          SDecimal(0.058266092643983664))),
                                  "x3" ->
                                    SObject(
                                      Map(
                                        "standardError" ->
                                          SDecimal(37.2780177420194),
                                        "estimate" ->
                                          SDecimal(-13.04059432806976)))
                                )),
                              SObject(
                                Map(
                                  "estimate" -> SDecimal(0.06398145974561122),
                                  "standardError" ->
                                    SDecimal(0.17081889453560964)))
                            )),
                ...
                SObject(
                  Map(
                    ...
                    "predictionInterval" ->
                      SArray(
                        Vector(
                          SDecimal(-1.276677011015371),
                          SDecimal(1.424060845580659)))
                  )))),
          SObject(
            Map(
              "model1" ->
                ...
                SObject(
                  Map(
                    ...
                    "predictionInterval" ->
                      SArray(
                        Vector(
                          SDecimal(-1.302906492808298),
                          SDecimal(1.196619745040404)))
                  )))),
          SObject(
            Map(
              "model1" ->
                ...
                SObject(
                  Map(
                    ...
                    "predictionInterval" ->
                      SArray(
                        Vector(
                          SDecimal(-1.5704000268068927),
                          SDecimal(1.07128457449124)))
                  )))),
          SObject(
            Map(
              "model1" ->
