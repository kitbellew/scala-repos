...
object LevenshteinSpecs extends Specification with ScalaCheck {
  "levenshtein algorithm" should {
    ...
    "satisfy triangle inequality" in
      check { (s: String, t: String, u: String) =>
        val d = Levenshtein.distance(s, t)
