...
import blueeyes.json.serialization.IsoSerialization.{
  serialization => isoSerialization
}
...
object UserQuery {
  ...
  object Serialization {
    implicit val SortOrderDecomposer =
    ...
    implicit val SortOrderExtractor =
      new Extractor[DesiredSortOrder] {
        def validated(
