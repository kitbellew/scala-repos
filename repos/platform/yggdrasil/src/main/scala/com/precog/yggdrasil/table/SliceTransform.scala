...
trait ArrayConcatHelpers extends ConcatHelpers {
  ...
  def buildEmptyArrays(emptyBits: BitSet) = Map(
    ColumnRef(CPath.Identity, CEmptyArray) -> EmptyArrayColumn(emptyBits))
