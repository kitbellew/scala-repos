      ...
      result mustEqual Set(
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(3.487261531994447e-19))),
              "model1" -> SObject(
                Map("fit" -> SDecimal(8.644057113036095e-22)))))
        ),
        (
          SObject(
            Map(
        ...
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(0.0003353501304664781))),
              "model1" -> SObject(
        ...
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(4.1399375473943306e-8))),
              "model1" -> SObject(
                Map("fit" -> SDecimal(0.0013585199504289591)))))
        ),
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(5.109089028037222e-12))),
              "model1" -> SObject(
        ...
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(2.543665647376276e-13))),
              "model1" -> SObject(
        ...
        (
          SObject(
            Map(
              "model3" -> SObject(
                Map("fit" -> SDecimal(0.0009110511944006454)))))
        ),
        (
          SObject(
        ...
        (
          SObject(
            Map(
              "model3" -> SObject(
                Map("fit" -> SDecimal(2.646573631904765e-9)))))
        ),
        (
          SObject(
            Map(
        ...
        (
          SObject(
            Map(
              "model3" -> SObject(
                Map("fit" -> SDecimal(5.043474082014517e-7)))))
        ),
        (
          SObject(
            Map(
        ...
        (
          SObject(
            Map(
              "model3" -> SObject(
                Map("fit" -> SDecimal(2.289734845593124e-11)))))
        ),
        (
          SObject(
            Map(
      ...
      result mustEqual Set(
          ...
          SObject(
            Map(
              "model1" -> SObject(
                Map("fit" -> SDecimal(0.0003353501304664781))),
              "model3" -> SObject(
                Map("fit" -> SDecimal(1.522997951276035e-8)))))
        ),
        (
          SObject(
            Map(
        ...
        (
          SObject(
            Map(
              "model3" -> SObject(
                Map("fit" -> SDecimal(0.000746028833836697)))))
        ),
        (
          SObject(
            Map(
        ...
        (
          SObject(
            Map(
              "model2" -> SObject(
                Map("fit" -> SDecimal(2.319522830243569e-16)))))
        ),
        (
          SObject(
            Map(
