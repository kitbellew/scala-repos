...
trait TimeDifferenceSpecs[M[+_]]
  ...
  "time difference functions (homogeneous case across slices)" should {
    ...
    "compute difference of months" in {
      ...
      result2 must
        contain(
          -27, 10, -22, 14, 28, -4, 13, 41, 32, -5, -10, 7, 16, 43, -13, 30,
          -24, -17)
    }
    "compute difference of weeks" in {
      val input =
      ...
      result2 must
        contain(
          -98, -96, -118, -76, 189, 121, 132, 70, -75, -23, 141, -19, 32, 59,
          -20, -106, 182, 72, -56, 47, -45, 62)
    }
    "compute difference of days" in {
      val input =
        Join(
      ...
      result2 must
        contain(
          1327, 930, -826, -536, -675, 1279, 853, -139, -691, -163, 509, 434,
          494, 330, -747, 226, -527, -321, -398, 415, 987, -144)
    }
    "compute difference of hours" in {
      val input =
        Join(
      ...
      result2 must
        contain(
          -3458, 31864, 11859, -12655, -9552, -3347, -16600, -12887, 12233,
          22340, -16211, -17950, -19836, 10417, 23694, -3923, 20483, 9983,
          -7713, 30710, 7925, 5445)
    }
    "compute difference of minutes" in {
      val input =
        Join(
      ...
      result2 must
        contain(
          -573157, 1911875, 1228981, 599021, -1077003, 1421696, -1190164,
          1340430, -235403, -773234, 1842644, -462836, 625023, -200840, -972705,
          326713, 475549, 711599, -996031, 733998, -759345, -207496)
    }
    "compute difference of seconds" in {
      val input =
        Join(
    ...
    "compute difference of ms" in {
      ...
      result2 must
        contain(
          ...
          35941265077L, 110558640261L, -64620189172L, 44039920965L,
          28532980863L, 85301793775L, -46394099354L, -12449791417L,
          19602785480L, 80425853610L, 37501386405L, 42695984162L, -59761902164L,
          -27770192599L, 73738905032L, -14124214357L, -12050411758L,
          -58362317732L)
    }
  }
  ...
  "time difference functions (heterogeneous case across slices)" should {
    ...
    "compute difference of seconds" in {
      ...
      result2 must
        contain(
          -2654273, 100892632, -5059008, -23697928, 73397157, 70263579,
          -50869487, 60464942, -33189258, 34821554)
    }
    "compute difference of ms" in {
      val input =
        Join(
      ...
      result2 must
        contain(
          60464942676L, -50869487651L, 34821554007L, -2654273728L,
          100892632209L, -5059008412L, -33189258109L, -23697928353L,
