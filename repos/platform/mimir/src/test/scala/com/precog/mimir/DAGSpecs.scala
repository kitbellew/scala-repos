...
object DAGSpecs extends Specification with DAG with FNDummyModule {
  ...
  "dag decoration" should {
    ...
    "recognize a join instruction" in {
      ...
      "map2_cross" >> {
        ...
        result mustEqual Right(
          Join(Add, Cross(None), Const(CTrue)(line), Const(CFalse)(line))(line))
      }
        ...
        result mustEqual Right(
          IUI(
            ...
            IUI(
              ...
              IUI(true, Const(CFalse)(line), Const(CTrue)(line))(line))(line))(
            line))
      }
    }
  ...
  "foldDown" should {
    "look within a Split branch" in {
      ...
      val result = input.foldDown[Int](true) { case _: AbsoluteLoad => 1 }
