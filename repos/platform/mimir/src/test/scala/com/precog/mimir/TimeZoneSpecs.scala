...
trait TimeZoneSpecs[M[+_]]
  ...
  "changing time zones (homogenous case)" should {
    "change to the correct time zone" in {
      ...
      result must contain(
        "2011-02-21T01:09:59.165-10:00",
        "2012-02-11T06:11:33.394-10:00",
        "2011-09-06T06:44:52.848-10:00",
        "2010-04-28T15:37:52.599-10:00",
        "2012-12-28T06:38:19.430-10:00"
      ).only
    }
    ...
    "not modify millisecond value" in {
      ...
      val result2 = result collect {
        case (ids, SString(time)) if ids.length == 1 =>
          val newTime =
            ISODateTimeFormat.dateTimeParser().withOffsetParsed.parseDateTime(
              time)
    ...
    "work correctly for fractional zones" in {
      ...
      result2 must contain(
        "2011-02-21T00:39:59.165-10:30",
        "2012-02-11T05:41:33.394-10:30",
        "2011-09-06T06:14:52.848-10:30",
        "2010-04-28T15:07:52.599-10:30",
        "2012-12-28T06:08:19.430-10:30"
      )
    }
  }
