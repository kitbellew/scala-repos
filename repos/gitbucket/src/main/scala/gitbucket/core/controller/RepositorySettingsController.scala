...
trait RepositorySettingsControllerBase extends ControllerBase {
  ...
  /**
    ...
    */
  post("/:owner/:repository/settings/options", optionsForm)(
      ...
      if (repository.name != form.repositoryName) {
        ...
        defining(getRepositoryDir(repository.owner, repository.name)) { dir =>
          FileUtils.moveDirectory(
            dir,
            getRepositoryDir(repository.owner, form.repositoryName))
        }
        ...
        defining(getWikiRepositoryDir(repository.owner, repository.name)) {
          dir =>
            FileUtils.moveDirectory(
              dir,
              getWikiRepositoryDir(repository.owner, form.repositoryName))
        }
      }
  ...
  get("/:owner/:repository/settings/branches")(
    ownerOnly { repository =>
      val protecteions = getProtectedBranchList(
        repository.owner,
        repository.name)
  ...
  get("/:owner/:repository/settings/branches/:branch")(
    ownerOnly { repository =>
  ...
  get("/:owner/:repository/settings/hooks")(
    ownerOnly { repository =>
      html.hooks(
        getWebHooks(repository.owner, repository.name),
        repository,
        flash.get("info"))
    })
  ...
  /**
    ...
    */
  ajaxPost("/:owner/:repository/settings/hooks/test")(
    ownerOnly { repository =>
        ...
        git =>
          ...
          val toErrorMap: PartialFunction[Throwable, Map[String, String]] = {
            ...
            case e: org.apache.http.client.ClientProtocolException =>
              Map("error" -> ("invalid url"))
            case NonFatal(e) =>
              Map("error" -> (e.getClass + " " + e.getMessage))
          }
  ...
  /**
    ...
    */
  get("/:owner/:repository/settings/danger")(
    ownerOnly {
      html.danger(_)
    })
  ...
  /**
    ...
    */
  post("/:owner/:repository/settings/transfer", transferForm)(
    ownerOnly { (form, repository) =>
  ...
  /**
    ...
    */
  post("/:owner/:repository/settings/delete")(
    ownerOnly { repository =>
      LockUtil.lock(s"${repository.owner}/${repository.name}") {
