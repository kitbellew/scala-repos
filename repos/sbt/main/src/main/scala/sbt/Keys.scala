...
object Keys {
  ...
  val logLevel = SettingKey[Level.Value](
    ...
    ASetting)
  val persistLogLevel = SettingKey[Level.Value](
    "persist-log-level",
    "The amount of logging sent to a file for persistence.",
    CSetting)
  val traceLevel = SettingKey[Int](
    "trace-level",
    "The amount of a stack trace displayed.  " + TraceValues,
    ASetting)
  val persistTraceLevel = SettingKey[Int](
    "persist-trace-level",
    "The amount of stack trace persisted.",
    CSetting)
  val showSuccess = SettingKey[Boolean](
    "show-success",
    "If true, displays a success message after running a command successfully.",
    CSetting)
  val showTiming = SettingKey[Boolean](
    "show-timing",
    "If true, the command success message includes the completion time.",
    CSetting)
  val timingFormat = SettingKey[java.text.DateFormat](
    "timing-format",
    "The format used for displaying the completion time.",
    CSetting)
  val extraLoggers = SettingKey[ScopedKey[_] => Seq[AbstractLogger]](
    "extra-loggers",
  ...
  val projectCommand = AttributeKey[Boolean](
    "project-command",
    "Marks Commands that were registered for the current Project.",
    Invisible)
  val sessionSettings = AttributeKey[SessionSettings](
    "session-settings",
    "Tracks current build, project, and setting modifications.",
    DSetting)
  val stateBuildStructure = AttributeKey[BuildStructure](
    "build-structure",
    "Data structure containing all information about the build definition.",
    BSetting)
  ...
  val appConfiguration = SettingKey[xsbti.AppConfiguration](
    "app-configuration",
  ...
  val initialize = SettingKey[Unit](
    "initialize",
    "A convenience setting for performing side-effects during initialization.",
    BSetting)
  val onLoad = SettingKey[State => State](
    "on-load",
    "Transformation to apply to the build state when the build is loaded.",
    DSetting)
  val onUnload = SettingKey[State => State](
    "on-unload",
    "Transformation to apply to the build state when the build is unloaded.",
    DSetting)
  ...
  val transformState = AttributeKey[State => State](
    "transform-state",
    "State transformation to apply after tasks run.",
    DSetting)
  ...
  val analysis = AttributeKey[CompileAnalysis](
    "analysis",
    "Analysis of compilation, including dependencies and generated outputs.",
    DSetting)
  val watch = SettingKey(BasicKeys.watch)
  val pollInterval = SettingKey[Int](
    "poll-interval",
  ...
  val watchSources = TaskKey[Seq[File]](
    ...
    BMinusSetting)
  val watchTransitiveSources = TaskKey[Seq[File]](
    "watch-transitive-sources",
    "Defines the sources in all projects for continuous execution to watch.",
    CSetting)
  val watchingMessage = SettingKey[WatchState => String](
    "watching-message",
    "The message to show when triggered execution waits for sources to change.",
    DSetting)
  val triggeredMessage = SettingKey[WatchState => String](
    "triggered-message",
  ...
  val sourceManaged = SettingKey[File](
    ...
    BPlusSetting)
  val scalaSource =
    SettingKey[File]("scala-source", "Default Scala source directory.", ASetting)
  val javaSource =
    SettingKey[File]("java-source", "Default Java source directory.", ASetting)
  ...
  val unmanagedResourceDirectories = SettingKey[Seq[File]](
    "unmanaged-resource-directories",
  ...
  val classpathOptions = SettingKey[ClasspathOptions](
    ...
    DSetting)
  val definedSbtPlugins = TaskKey[Set[String]](
    "defined-sbt-plugins",
    "The set of names of Plugin implementations defined by this project.",
    CTask)
  val discoveredSbtPlugins = TaskKey[PluginDiscovery.DiscoveredNames](
    "discovered-sbt-plugins",
  ...
  val consoleProject = TaskKey[Unit](
    ...
    AMinusTask)
  val compile =
    TaskKey[CompileAnalysis]("compile", "Compiles sources.", APlusTask)
  ...
  val compilerCache = TaskKey[GlobalsCache](
    ...
    DTask)
  val stateCompilerCache =
    AttributeKey[GlobalsCache]("compiler-cache", "Internal use: Global cache.")
  val definesClass = TaskKey[DefinesClass](
    "defines-class",
    "Internal use: provides a function that determines whether the provided file contains a given class.",
    Invisible)
  ...
  val packageOptions = TaskKey[Seq[PackageOption]](
    ...
    BTask)
  val packageConfiguration = TaskKey[Package.Configuration](
  ...
  val artifactPath = SettingKey[File](
    ...
    BPlusSetting)
  val artifact =
    SettingKey[Artifact]("artifact", "Describes an artifact.", BMinusSetting)
  ...
  val fileMappings = TaskKey[Seq[(File, File)]](
    "file-mappings",
    "Defines the mappings from a file to a file, used for copying files, for example.",
    BMinusTask)
  ...
  val fork = SettingKey[Boolean](
    ...
    ASetting)
  val outputStrategy = SettingKey[Option[sbt.OutputStrategy]](
    "output-strategy",
  ...
  val definedTestNames = TaskKey[Seq[String]](
    ...
    BMinusTask)
  val executeTests = TaskKey[Tests.Output](
    "execute-tests",
  ...
  val testForkedParallel = SettingKey[Boolean](
    "test-forked-parallel",
    "Whether forked tests should be executed in parallel",
    CTask)
  val testExecution = TaskKey[Tests.Execution](
    "test-execution",
  ...
  val testResultLogger = SettingKey[TestResultLogger](
    ...
    DTask)
  val testGrouping = TaskKey[Seq[Tests.Group]](
    "test-grouping",
  ...
  val normalizedName = SettingKey[String](
    ...
    BSetting)
  val description =
    SettingKey[String]("description", "Project description.", BSetting)
  val homepage =
    SettingKey[Option[URL]]("homepage", "Project homepage.", BSetting)
  ...
  val licenses = SettingKey[Seq[(String, URL)]](
    ...
    BMinusSetting)
  val organization =
    SettingKey[String]("organization", "Organization/group ID.", APlusSetting)
  ...
  val entryApiURL = AttributeKey[URL](
    "entry-api-url",
    "Base URL for the API documentation for a classpath entry.")
  ...
  val products = TaskKey[Seq[File]](
    ...
    BMinusTask)
  @deprecated(
    "This task is unused by the default project and will be removed.",
    "0.13.0")
  ...
  val unresolvedWarningConfiguration = TaskKey[UnresolvedWarningConfiguration](
    "unresolved-warning-configuration",
  ...
  val dependencyPositions = TaskKey[Map[ModuleID, SourcePosition]](
    ...
    DTask)
  val ivySbt =
    TaskKey[IvySbt]("ivy-sbt", "Provides the sbt interface to Ivy.", CTask)
  val ivyModule = TaskKey[IvySbt#Module](
    "ivy-module",
  ...
  val deliverLocal = TaskKey[File](
    ...
    BTask)
  val publish =
    TaskKey[Unit]("publish", "Publishes artifacts to a repository.", APlusTask)
  ...
  val pomExtra = SettingKey[NodeSeq](
    ...
    BSetting)
  val pomPostProcess = SettingKey[XNode => XNode](
    "pom-post-process",
  ...
  val moduleID = SettingKey[ModuleID](
    "module-id",
    "A dependency management descriptor.  This is currently used for associating a ModuleID with a classpath entry.",
    BPlusSetting)
  ...
  val fullResolvers = TaskKey[Seq[Resolver]](
    ...
    CTask)
  val otherResolvers = SettingKey[Seq[Resolver]](
    "other-resolvers",
  ...
  val libraryDependencies = SettingKey[Seq[ModuleID]](
    ...
    APlusSetting)
  val dependencyOverrides = SettingKey[Set[ModuleID]](
    "dependency-overrides",
    "Declares managed dependency overrides.",
    BSetting)
  val excludeDependencies = SettingKey[Seq[SbtExclusionRule]](
  ...
  val ivyXML = SettingKey[NodeSeq](
    ...
    BSetting)
  val ivyScala = SettingKey[Option[IvyScala]](
    "ivy-scala",
  ...
  val ivyValidate = SettingKey[Boolean](
    ...
    BSetting)
  val ivyLoggingLevel = SettingKey[UpdateLogging.Value](
    "ivy-logging-level",
    "The logging level for updating.",
    BSetting)
  val publishTo = SettingKey[Option[Resolver]](
    "publish-to",
  ...
  val projectDescriptors = TaskKey[Map[ModuleRevisionId, ModuleDescriptor]](
    ...
    DTask)
  val autoUpdate =
    SettingKey[Boolean]("auto-update", "<unimplemented>", Invisible)
  ...
  val classifiersModule =
    TaskKey[GetClassifiersModule]("classifiers-module", rank = CTask)
  ...
  // special
  val sessionVars = AttributeKey[SessionVar.Map](
    "session-vars",
    "Bindings that exist for the duration of the session.",
    Invisible)
  val parallelExecution = SettingKey[Boolean](
    "parallel-execution",
    "Enables (true) or disables (false) parallel execution of tasks.",
    BMinusSetting)
  val tags = SettingKey[Seq[(Tags.Tag, Int)]](
    "tags",
    ConcurrentRestrictions.tagsKey.label,
    BSetting)
  val concurrentRestrictions = SettingKey[Seq[Tags.Rule]](
    "concurrent-restrictions",
    "Rules describing restrictions on concurrent task execution.",
    BSetting)
  val cancelable = SettingKey[Boolean](
    "cancelable",
    "Enables (true) or disables (false) the ability to interrupt task execution with CTRL+C.",
    BMinusSetting)
  val forcegc = SettingKey[Boolean](
    "forcegc",
    "Enables (true) or disables (false) forcing garbage collection after task run when needed.",
    BMinusSetting)
  val minForcegcInterval = SettingKey[Duration](
    "min-forcegc-interval",
    "Minimal interval to check for forcing garbage collection.")
  ...
  val stateStreams = AttributeKey[Streams](
    "streams-manager",
    "Streams manager, which provides streams for different contexts.  Setting this on State will override the default Streams implementation."
  )
  val resolvedScoped = Def.resolvedScoped
  val pluginData = TaskKey[PluginData](
    "plugin-data",
    "Information from the plugin build needed in the main build definition.",
    DTask)
  ...
  private[sbt] val executeProgress = SettingKey[State => TaskProgress](
    "executeProgress",
  ...
  @deprecated("Implementation detail.", "0.13.1")
  def dummy[T: Manifest](name: String, description: String): (TaskKey[T], Task[T]) =
