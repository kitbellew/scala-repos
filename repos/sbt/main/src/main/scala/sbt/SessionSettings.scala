...
final case class SessionSettings(
  ...
  def current: ProjectRef =
    ProjectRef(currentBuild, currentProject(currentBuild))
  ...
  /**
    ...
    */
  def appendRaw(ss: Seq[Setting[_]]): SessionSettings =
  ...
  /**
    ...
    */
  def clearExtraSettings: SessionSettings =
    copy(append = Map.empty, rawAppend = Nil)
