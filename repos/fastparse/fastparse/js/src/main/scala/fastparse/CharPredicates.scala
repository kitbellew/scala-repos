...
object CharPredicates {
  ...
  lazy val isMathSymbol =
    MacroUtils.preCompute(_.getType == Character.MATH_SYMBOL)
  lazy val isOtherSymbol =
    MacroUtils.preCompute(_.getType == Character.OTHER_SYMBOL)
}
