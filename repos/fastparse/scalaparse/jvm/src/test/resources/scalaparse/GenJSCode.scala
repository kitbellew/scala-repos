  ...
  class JSCodePhase(prev: Phase) extends StdPhase(prev) with JSExportsPhase {
    ...
    private def genReflCallProxy(sym: Symbol): js.MethodDef = {
      ...
      withNewLocalNameScope {
        withScopedVars(
          ...
          js.MethodDef(static = false, proxyIdent, jsParams, jstpe.AnyType, body)(
            OptimizerHints.empty,
            None)
        }
      }
    ...
    def genIsInstanceOf(value: js.Tree, to: Type)(implicit
      ...
      if (sym == ObjectClass) {
        ...
        if (sym.isTrait) {
          ...
          js.Unbox(
            js.JSBinaryOp(js.JSBinaryOp.instanceof, value, genGlobalJSObject(sym)),
            'Z')
        }
      } else {
    ...
    private def genAnonFunction(originalFunction: Function): js.Tree = {
      ...
      val (allFormalCaptures, body, allActualCaptures) = if (!isInImplClass) {
        ...
        val body =
          genTraitImplApply(target, thisCaptureArg :: actualArgs ::: captureArgs)
