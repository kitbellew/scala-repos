...
object coproduct {
  ...
  object Selector {
    ...
    implicit def tlSelector[H, T <: Coproduct, S](implicit
        st: Selector[T, S]): Selector[H :+: T, S] =
      new Selector[H :+: T, S] {
  ...
  object At {
    ...
    implicit def coproductAtN[H, T <: Coproduct, N <: Nat](implicit
        att: At[T, N]): Aux[H :+: T, Succ[N], att.A] =
      new At[H :+: T, Succ[N]] {
        type A = att.A
    ...
    implicit def lstUnifier[H]: Aux[H :+: CNil, H] =
      new Unifier[H :+: CNil] {
        ...
        def apply(c: H :+: CNil): Out =
          (c: @unchecked) match { case Inl(h) => h }
      }
  ...
  object ZipOne {
    ...
    implicit def cpZipOne[
      ...
      new ZipOne[C1H :+: C1T, C2H :+: C2T] {
        ...
        def apply(c: C1H :+: C1T, c2: C2H :+: C2T): Out =
          extend(Coproduct[(C1H, C2H) :+: CNil](c.head.get, c2.head.get))
      }
  }
  ...
  object Length {
    ...
    implicit def cnilLength: Aux[CNil, Nat._0] =
      new Length[CNil] {
        type Out = Nat._0
  ...
  object Basis {
    ...
    def apply[Super <: Coproduct, Sub <: Coproduct](implicit
        basis: Basis[Super, Sub]): Aux[Super, Sub, basis.Rest] = basis
