...
object tuple {
  ...
  trait MapFolder[T, R, P] extends Serializable {
    // Nb. Not a dependent function signature
  ...
  object LeftFolder {
    def apply[T, U, P](
        implicit folder: LeftFolder[T, U, P]): Aux[T, U, P, folder.Out] =
      folder
  ...
  object ZipApply {
    ...
    implicit def zipApply[FT, FL <: HList, AT, AL <: HList, RL <: HList](
        implicit genf: Generic.Aux[FT, FL],
  ...
  object ZipOne {
    ...
    implicit def zipOne[
        ...
        RLL <: HList,
        RL <: HList](
        implicit genh: Generic.Aux[HT, HL],
  ...
  object LeftScanner {
    def apply[T, In, P <: Poly](
        implicit scanL: LeftScanner[T, In, P]): Aux[T, In, P, scanL.Out] =
      scanL
