...
object hlist {
  ...
  object ToCoproduct {
    ...
    type Aux[L <: HList, Out0 <: Coproduct] =
      ToCoproduct[L] {
        type Out = Out0
      }
  ...
  object Mapper {
    ...
    type Aux[HF, In <: HList, Out0 <: HList] =
      Mapper[HF, In] {
        type Out = Out0
      }
  ...
  object Unifier {
    ...
    implicit val hnilUnifier: Aux[HNil, HNil] =
      new Unifier[HNil] {
        type Out = HNil
  ...
  trait LowPriorityToCoproductTraversable {
    type Aux[L <: HList, M[_], C <: Coproduct] =
      ToCoproductTraversable[L, M] {
        type Cop = C
      }
  ...
  object ToSized {
    ...
    type Aux[L <: HList, M[_], Lub0, N0 <: Nat] =
      ToSized[L, M] {
        type Lub = Lub0;
        type N = N0
      }
  ...
  object SelectMany {
    ...
    type Aux[L <: HList, Ids <: HList, Out0 <: HList] =
      SelectMany[L, Ids] {
        type Out = Out0
      }
  ...
  object Grouper extends LowPriorityGrouper {
    ...
    type Aux[L <: HList, N <: Nat, Step <: Nat, Out0] =
      Grouper[L, N, Step] {
        type Out = Out0
      }
  ...
  object RemoveAll {
    ...
    type Aux[L <: HList, SL <: HList, Out0] =
      RemoveAll[L, SL] {
        type Out = Out0
      }
  ...
  object ModifierAt {
    ...
    type Aux[L <: HList, N <: Nat, U, V, Out0] =
      ModifierAt[L, N, U, V] {
        type Out = Out0
      }
  ...
  object ReverseSplit {
    ...
    type Aux[L <: HList, N <: Nat, Prefix0, Suffix0] =
      ReverseSplit[L, N] {
        type Prefix = Prefix0
        type Suffix = Suffix0
      }
  ...
  object Align {
    ...
    implicit val hnilAlign: Align[HNil, HNil] =
      new Align[HNil, HNil] {
  ...
  trait LowPriorityPrepend extends LowestPriorityPrepend {
    ...
    /**
      ...
      */
    override type Aux[P <: HList, S <: HList, Out0 <: HList] =
      Prepend[P, S] {
        type Out = Out0
      }
  ...
  object ZipOne {
    ...
    type Aux[H <: HList, T <: HList, Out0 <: HList] =
      ZipOne[H, T] {
        type Out = Out0
      }
  ...
  object ZipApply {
    ...
    type Aux[FL <: HList, AL <: HList, Out0 <: HList] =
      ZipApply[FL, AL] {
        type Out = Out0
      }
  ...
  object Collect extends LowPriorityCollect {
    ...
    type Aux[L <: HList, P <: Poly, Out0 <: HList] =
      Collect[L, P] {
        type Out = Out0
      }
  ...
  object LiftAll {
    type Aux[F[_], In0 <: HList, Out0 <: HList] =
      LiftAll[F, In0] {
        type Out = Out0
      }
    class Curried[F[_]] {
