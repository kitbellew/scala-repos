...
object hlist {
  ...
  object IsHCons {
    def apply[L <: HList](implicit
        isHCons: IsHCons[L]): Aux[L, isHCons.H, isHCons.T] = isHCons
  ...
  object Mapped {
    def apply[L <: HList, F[_]](implicit
        mapped: Mapped[L, F]): Aux[L, F, mapped.Out] = mapped
    ...
    implicit def hlistMapped2[H, T <: HList, F, OutM <: HList](implicit
        mt: Mapped.Aux[T, Const[F]#λ, OutM])
  ...
  trait LowPriorityComapped {
    type Aux[L <: HList, F[_], Out0 <: HList] = Comapped[L, F] {
      type Out = Out0
    }
  ...
  object Comapped extends LowPriorityComapped {
    def apply[L <: HList, F[_]](implicit
        comapped: Comapped[L, F]): Aux[L, F, comapped.Out] = comapped
    ...
    implicit def hlistComapped[H, T <: HList, F[_]](implicit
        mt: Comapped[T, F]): Aux[F[H] :: T, F, H :: mt.Out] =
    ...
    implicit def hlistNatTRel1[H, F1[_], F2[_], T1 <: HList, T2 <: HList](
      ...
      new NatTRel[F1[H] :: T1, F1, F2[H] :: T2, F2] {
        def map(f: F1 ~> F2, fa: F1[H] :: T1): F2[H] :: T2 =
          f(fa.head) :: nt.map(f, fa.tail)
      }

    implicit def hlistNatTRel2[H, F2[_], T1 <: HList, T2 <: HList](implicit
        nt: NatTRel[T1, Id, T2, F2]) =
      new NatTRel[H :: T1, Id, F2[H] :: T2, F2] {
        def map(f: Id ~> F2, fa: H :: T1): F2[H] :: T2 =
          f(fa.head) :: nt.map(f, fa.tail)
      }

    implicit def hlistNatTRel3[H, F1[_], T1 <: HList, T2 <: HList](implicit
        nt: NatTRel[T1, F1, T2, Id]) =
      new NatTRel[F1[H] :: T1, F1, H :: T2, Id] {
        def map(f: F1 ~> Id, fa: F1[H] :: T1): H :: T2 =
          f(fa.head) :: nt.map(f, fa.tail)
      }

    implicit def hlistNatTRel4[H1, F1[_], T1 <: HList, H2, T2 <: HList](implicit
        nt: NatTRel[T1, F1, T2, Const[H2]#λ]) =
      new NatTRel[F1[H1] :: T1, F1, H2 :: T2, Const[H2]#λ] {
        def map(f: F1 ~> Const[H2]#λ, fa: F1[H1] :: T1): H2 :: T2 =
          f(fa.head) :: nt.map(f, fa.tail)
      }

    implicit def hlistNatTRel5[H1, T1 <: HList, H2, T2 <: HList](implicit
        nt: NatTRel[T1, Id, T2, Const[H2]#λ]) =
      new NatTRel[H1 :: T1, Id, H2 :: T2, Const[H2]#λ] {
        def map(f: Id ~> Const[H2]#λ, fa: H1 :: T1): H2 :: T2 =
          f(fa.head) :: nt.map(f, fa.tail)
      }
  }
  ...
  final case class HConsHKernel[H, T <: HKernel](tail: T) extends HKernel {
    ...
    def tabulate[C](from: Int)(f: Int => C): C :: tail.Mapped[Const[C]#λ] =
      f(from) :: tail.tabulate(from + 1)(f)

    def toList[C](l: C :: tail.Mapped[Const[C]#λ]): List[C] =
      l.head :: tail.toList(l.tail)
  ...
  object ToCoproduct {
    ...
    implicit def hlistToCoproduct[H, T <: HList](implicit
        ut: ToCoproduct[T]): Aux[H :: T, H :+: ut.Out] =
      new ToCoproduct[H :: T] {
        type Out = H :+: ut.Out
      }
  }
  ...
  trait lowPriorityToSum {
    implicit def hlistToSum[H, T <: HList](implicit
        ut: ToSum[T]): ToSum.Aux[H :: T, H :+: ut.Out] =
      new ToSum[H :: T] {
        type Out = H :+: ut.Out
      }
  }
  ...
  /**
    ...
    * @author Miles Sabin
    */
  trait Mapper[HF, In <: HList] extends DepFn1[In] with Serializable {
    type Out <: HList
  }

  object Mapper {
    def apply[F, L <: HList](implicit
        mapper: Mapper[F, L]): Aux[F, L, mapper.Out] = mapper

    type Aux[HF, In <: HList, Out0 <: HList] = Mapper[HF, In] {
      type Out = Out0
    }
    ...
    implicit def hlistMapper1[HF <: Poly, InH, InT <: HList](implicit
        hc: Case1[HF, InH],
        mt: Mapper[HF, InT]): Aux[HF, InH :: InT, hc.Result :: mt.Out] =
  ...
  object FlatMapper {
    def apply[F, L <: HList](implicit
        mapper: FlatMapper[F, L]): Aux[F, L, mapper.Out] = mapper

    type Aux[HF, In <: HList, Out0 <: HList] = FlatMapper[HF, In] {
      type Out = Out0
    }
  ...
  object ConstMapper {
    def apply[C, L <: HList](implicit
        mapper: ConstMapper[C, L]): Aux[C, L, mapper.Out] = mapper

    type Aux[C, L <: HList, Out0 <: HList] = ConstMapper[C, L] {
      type Out = Out0
    }
    ...
    implicit def hlistConstMapper[H, T <: HList, C](implicit
        mct: ConstMapper[C, T]): Aux[C, H :: T, C :: mct.Out] =
  ...
  object MapFolder {
    def apply[L <: HList, R, F](implicit
        folder: MapFolder[L, R, F]): MapFolder[L, R, F] = folder

    implicit def hnilMapFolder[R, HF]: MapFolder[HNil, R, HF] =
      new MapFolder[HNil, R, HF] {
        def apply(l: HNil, in: R, op: (R, R) => R): R = in
      }

    implicit def hlistMapFolder[H, T <: HList, R, HF <: Poly](implicit
        hc: Case1.Aux[HF, H, R],
        tf: MapFolder[T, R, HF]): MapFolder[H :: T, R, HF] =
      new MapFolder[H :: T, R, HF] {
        def apply(l: H :: T, in: R, op: (R, R) => R): R =
          op(hc(l.head), tf(l.tail, in, op))
      }
  }
  ...
  object LeftFolder {
    def apply[L <: HList, In, F](implicit
        folder: LeftFolder[L, In, F]): Aux[L, In, F, folder.Out] = folder

    type Aux[L <: HList, In, HF, Out0] = LeftFolder[L, In, HF] {
      type Out = Out0
    }
    ...
    implicit def hlistLeftFolder[H, T <: HList, In, HF, OutH](implicit
        f: Case2.Aux[HF, In, H, OutH],
        ft: LeftFolder[T, OutH, HF]): Aux[H :: T, In, HF, ft.Out] =
  ...
  object RightFolder {
    def apply[L <: HList, In, F](implicit
        folder: RightFolder[L, In, F]): Aux[L, In, F, folder.Out] = folder

    type Aux[L <: HList, In, HF, Out0] = RightFolder[L, In, HF] {
      type Out = Out0
    }
    ...
    implicit def hlistRightFolder[H, T <: HList, In, HF, OutT](implicit
        ft: RightFolder.Aux[T, In, HF, OutT],
        f: Case2[HF, H, OutT]): Aux[H :: T, In, HF, f.Result] =
  ...
  object LeftReducer {
    def apply[L <: HList, F](implicit
        reducer: LeftReducer[L, F]): Aux[L, F, reducer.Out] = reducer

    type Aux[L <: HList, HF, Out0] = LeftReducer[L, HF] { type Out = Out0 }
    implicit def leftReducer[H, T <: HList, HF](implicit
        folder: LeftFolder[T, H, HF]): Aux[H :: T, HF, folder.Out] =
  ...
  object RightReducer {
    def apply[L <: HList, F](implicit
        reducer: RightReducer[L, F]): Aux[L, F, reducer.Out] = reducer
    ...
    implicit def hlistRightReducer[H, T <: HList, HF, OutT](implicit
        rt: RightReducer.Aux[T, HF, OutT],
        f: Case2[HF, H, OutT]): Aux[H :: T, HF, f.Result] =
  ...
  /**
    ...
    * @author Miles Sabin
    */
  trait Unifier[L <: HList] extends DepFn1[L] with Serializable {
    type Out <: HList
  }

  object Unifier {
    def apply[L <: HList](implicit unifier: Unifier[L]): Aux[L, unifier.Out] =
      unifier
    ...
    implicit def hlistUnifier[H1, H2, L, T <: HList](implicit
        u: Lub[H1, H2, L],
        lt: Unifier[L :: T]): Aux[H1 :: H2 :: T, L :: lt.Out] =
      new Unifier[H1 :: H2 :: T] {
        type Out = L :: lt.Out
        def apply(l: H1 :: H2 :: T): Out =
          u.left(l.head) :: lt(u.right(l.tail.head) :: l.tail.tail)
      }
  }
  ...
  object SubtypeUnifier {
    def apply[L <: HList, B](implicit
        unifier: SubtypeUnifier[L, B]): Aux[L, B, unifier.Out] = unifier

    type Aux[L <: HList, B, Out0 <: HList] = SubtypeUnifier[L, B] {
      type Out = Out0
    }
    ...
    implicit def hlistSubtypeUnifier1[H, T <: HList, B](implicit
        st: H <:< B,
        sut: SubtypeUnifier[T, B]): Aux[H :: T, B, B :: sut.Out] =
      new SubtypeUnifier[H :: T, B] {
        type Out = B :: sut.Out
        def apply(l: H :: T): Out = st(l.head) :: sut(l.tail)
      }

    implicit def hlistSubtypeUnifier2[H, T <: HList, B](implicit
        nst: H <:!< B,
        sut: SubtypeUnifier[T, B]): Aux[H :: T, B, H :: sut.Out] =
      new SubtypeUnifier[H :: T, B] {
        type Out = H :: sut.Out
  ...
  object ToTraversable {
    def apply[L <: HList, M[_]](implicit
        toTraversable: ToTraversable[L, M]): Aux[L, M, toTraversable.Lub] =
      toTraversable

    type Aux[L <: HList, M[_], Lub0] = ToTraversable[L, M] { type Lub = Lub0 }

    implicit def hnilToTraversable[L <: HNil, M[_], T](implicit
        cbf: CanBuildFrom[M[T], T, M[T]]): Aux[L, M, T] =
    ...
    implicit def hnilToTraversableNothing[L <: HNil, M[_]](implicit
        cbf: CanBuildFrom[M[Nothing], Nothing, M[Nothing]])
        : Aux[L, M, Nothing] = hnilToTraversable[L, M, Nothing]

    implicit def hsingleToTraversable[T, M[_], Lub0](implicit
        ev: T <:< Lub0,
        cbf: CanBuildFrom[Nothing, Lub0, M[Lub0]]): Aux[T :: HNil, M, Lub0] =
    ...
    implicit def hlistToTraversable[H1, H2, T <: HList, LubT, Lub0, M[_]](
        ...
        u: Lub[H1, LubT, Lub0],
        cbf: CanBuildFrom[M[Lub0], Lub0, M[Lub0]])
        : Aux[H1 :: H2 :: T, M, Lub0] =
  ...
  trait LowPriorityToCoproductTraversable {
    type Aux[L <: HList, M[_], C <: Coproduct] = ToCoproductTraversable[L, M] {
      type Cop = C
    }
    ...
    object NotIn {
      ...
      implicit def notInCCons[CH, CT <: Coproduct, T](implicit
          diff: CH =:!= T,
          notInTail: NotIn[CT, T]): NotIn[CH :+: CT, T] =
        new NotIn[CH :+: CT, T] {}
    }

    implicit def hconsToCoproductTraversable1[LH, LT <: HList, M[
        _], CT <: Coproduct](implicit
  ...
  object ToCoproductTraversable extends LowPriorityToCoproductTraversable {
    ...
    implicit def hnilToCoproductTraversable[L <: HNil, M[_]](implicit
        cbf: CanBuildFrom[M[CNil], CNil, M[CNil]]): Aux[L, M, CNil] =
      new ToCoproductTraversable[L, M] {
        type Cop = CNil
        def apply(l: L) = cbf().result()
      }

    implicit def hconsToCoproductTraversable0[LH, LT <: HList, M[
        _], CT <: Coproduct](implicit
        coproductOfT: Aux[LT, M, CT],
        ...
        basisTail: coproduct.Basis[LH :+: CT, CT])
        : Aux[LH :: LT, M, LH :+: CT] =
      new ToCoproductTraversable[LH :: LT, M] {
        type Cop = LH :+: CT
        def apply(l: LH :: LT): Out = {
  ...
  object ToSized {
    def apply[L <: HList, M[_]](implicit
        toSized: ToSized[L, M]): Aux[L, M, toSized.Lub, toSized.N] = toSized
    ...
    implicit def hnilToSized[L <: HNil, M[_], T](implicit
        cbf: CanBuildFrom[M[T], T, M[T]],
        ev: AdditiveCollection[M[T]]): Aux[L, M, T, Nat._0] =
      new ToSized[L, M] {
        type Lub = T
        type N = Nat._0
    ...
    implicit def hnilToSizedNothing[L <: HNil, M[_]](implicit
        cbf: CanBuildFrom[M[Nothing], Nothing, M[Nothing]],
        ev: AdditiveCollection[M[Nothing]]): Aux[L, M, Nothing, Nat._0] =
      hnilToSized[L, M, Nothing]

    implicit def hsingleToSized[T, M[_], Lub0](implicit
        ub: T <:< Lub0,
        cbf: CanBuildFrom[Nothing, Lub0, M[Lub0]],
        ev: AdditiveCollection[M[Lub0]]): Aux[T :: HNil, M, Lub0, Nat._1] =
  ...
  object Last {
    ...
    implicit def hlistLast[H, T <: HList](implicit
        lt: Last[T]): Aux[H :: T, lt.Out] =
      new Last[H :: T] {
        type Out = lt.Out
  ...
  object Init {
    ...
    implicit def hlistInit[H, T <: HList, OutH, OutT <: HList](implicit
        it: Init[T]): Aux[H :: T, H :: it.Out] =
      new Init[H :: T] {
        type Out = H :: it.Out
  ...
  object Selector {
    ...
    def apply[L <: HList, U](implicit
        selector: Selector[L, U]): Selector[L, U] = selector
    ...
    implicit def recurse[H, T <: HList, U](implicit
        st: Selector[T, U]): Selector[H :: T, U] =
      new Selector[H :: T, U] {
  ...
  object SelectAll {
    ...
    implicit def hconsSelectAll[L <: HList, H, S <: HList](implicit
        sh: Selector[L, H],
        st: SelectAll[L, S]): SelectAll[L, H :: S] =
      new SelectAll[L, H :: S] {
  ...
  object SelectMany {
    def apply[L <: HList, Ids <: HList](implicit
        sel: SelectMany[L, Ids]): Aux[L, Ids, sel.Out] = sel

    type Aux[L <: HList, Ids <: HList, Out0 <: HList] = SelectMany[L, Ids] {
      type Out = Out0
    }
    ...
    implicit def SelectManyHList[L <: HList, H <: Nat, T <: HList](implicit
        sel: SelectMany[L, T],
        at: At[L, H]): Aux[L, H :: T, at.Out :: sel.Out] =
  ...
  object SelectRange {
    def apply[L <: HList, A <: Nat, B <: Nat](implicit
        sel: SelectRange[L, A, B]): Aux[L, A, B, sel.Out] = sel
    ...
    implicit def SelectRangeAux[L <: HList, A <: Nat, B <: Nat, Ids <: HList](
        ...
        sel: SelectMany[L, Ids]): Aux[L, A, B, sel.Out] =
  ...
  object Partition {
    ...
    implicit def hlistPartition1[
        ...
        p: Aux[L, H, LPrefix, LSuffix]): Aux[H :: L, H, H :: LPrefix, LSuffix] =
      new Partition[H :: L, H] {
    ...
    implicit def hlistPartition2[
        ...
        e: U =:!= H): Aux[H :: L, U, LPrefix, H :: LSuffix] =
      new Partition[H :: L, U] {
        type Prefix = LPrefix
  ...
  object Grouper extends LowPriorityGrouper {
    def apply[L <: HList, N <: Nat, Step <: Nat](implicit
        grouper: Grouper[L, N, Step]): Aux[L, N, Step, grouper.Out] = grouper

    type Aux[L <: HList, N <: Nat, Step <: Nat, Out0] = Grouper[L, N, Step] {
      type Out = Out0
    }

    implicit def hnilGrouper[N <: Nat, Step <: Nat]: Aux[HNil, N, Step, HNil] =
    ...
    implicit def hlistGrouper1[L <: HList, A <: Nat, N <: Nat, Step <: Nat](
        ...
        lt: ops.nat.LT[A, N]): Aux[L, N, Step, HNil] =
      new Grouper[L, N, Step] {
        type Out = HNil
  ...
  trait LowPriorityPaddedGrouper {
    ...
    implicit def incompletePaddedGrouper[
        ...
        : PaddedGrouper.Aux[L, N, Step, Pad, grouper.Out] =
  ...
  object PaddedGrouper extends LowPriorityPaddedGrouper {
    ...
    implicit def defaultPaddedGrouper[
        ...
        eq: B =:= _0,
        grouper: Grouper[L, N, Step]): Aux[L, N, Step, Pad, grouper.Out] =
      new PaddedGrouper[L, N, Step, Pad] {
  ...
  /**
    ...
    * @author Alois Cochard
    */
  trait FilterNot[L <: HList, U] extends DepFn1[L] with Serializable {
    type Out <: HList
  }

  object FilterNot {
    def apply[L <: HList, U](implicit
        filter: FilterNot[L, U]): Aux[L, U, filter.Out] = filter
    ...
    implicit def hlistFilterNot[
        ...
        LPrefix <: HList,
        LSuffix <: HList](implicit
        partition: Partition.Aux[L, U, LPrefix, LSuffix]): Aux[L, U, LSuffix] =
      new FilterNot[L, U] {
        type Out = LSuffix
  ...
  trait LowPriorityRemove {
    ...
    implicit def recurse[H, T <: HList, E, OutT <: HList](implicit
        r: Aux[T, E, (E, OutT)]): Aux[H :: T, E, (E, H :: OutT)] =
      new Remove[H :: T, E] {
        type Out = (E, H :: OutT)
        def apply(l: H :: T): Out = {
          val (e, tail) = r(l.tail)
  ...
  object Remove extends LowPriorityRemove {
    def apply[L <: HList, E](implicit
        remove: Remove[L, E]): Aux[L, E, remove.Out] = remove
  ...
  object RemoveAll {
    def apply[L <: HList, SL <: HList](implicit
        remove: RemoveAll[L, SL]): Aux[L, SL, remove.Out] = remove

    type Aux[L <: HList, SL <: HList, Out0] = RemoveAll[L, SL] {
      type Out = Out0
    }
  ...
  /**
    ...
    */
  trait Union[L <: HList, M <: HList] extends DepFn2[L, M] with Serializable {
    type Out <: HList
  }

  trait LowPriorityUnion {
    type Aux[L <: HList, M <: HList, Out0 <: HList] = Union[L, M] {
      type Out = Out0
    }

    // buggy version; let (H :: T) ∪ M  =  H :: (T ∪ M)
    @deprecated("Incorrectly witnesses that {x} ∪ {x} = {x, x}", "2.3.1")
    def hlistUnion1[H, T <: HList, M <: HList](implicit
        u: Union[T, M]): Aux[H :: T, M, H :: u.Out] =
      new Union[H :: T, M] {
        type Out = H :: u.Out
  ...
  object Union extends LowPriorityUnion {
    def apply[L <: HList, M <: HList](implicit
        union: Union[L, M]): Aux[L, M, union.Out] = union
    ...
    implicit def hlistUnion1[H, T <: HList, M <: HList](implicit
        u: Union[T, M],
        f: FilterNot.Aux[M, H, M]): Aux[H :: T, M, H :: u.Out] =
      new Union[H :: T, M] {
        type Out = H :: u.Out
        def apply(l: H :: T, m: M): Out = l.head :: u(l.tail, m)
      }
    ...
    implicit def hlistUnion2[H, T <: HList, M <: HList, MR <: HList](implicit
        r: Remove.Aux[M, H, (H, MR)],
        u: Union[T, MR]): Aux[H :: T, M, H :: u.Out] =
      new Union[H :: T, M] {
        type Out = H :: u.Out
  ...
  trait LowPriorityIntersection {
    ...
    def hlistIntersection1[H, T <: HList, M <: HList](implicit
        i: Intersection[T, M]): Aux[H :: T, M, i.Out] =
  ...
  object Intersection extends LowPriorityIntersection {
    def apply[L <: HList, M <: HList](implicit
        intersection: Intersection[L, M]): Aux[L, M, intersection.Out] =
      intersection
    ...
    implicit def hlistIntersection1[H, T <: HList, M <: HList](implicit
        i: Intersection[T, M],
        f: FilterNot.Aux[M, H, M]): Aux[H :: T, M, i.Out] =
      new Intersection[H :: T, M] {
        type Out = i.Out
        def apply(l: H :: T): Out = i(l.tail)
      }
    ...
    implicit def hlistIntersection2[H, T <: HList, M <: HList, MR <: HList](
        implicit
        r: Remove.Aux[M, H, (H, MR)],
        i: Intersection[T, MR]): Aux[H :: T, M, H :: i.Out] =
      new Intersection[H :: T, M] {
        type Out = H :: i.Out
  ...
  trait LowPriorityDiff {
    ...
    implicit def hconsDiff1[L <: HList, H, T <: HList](implicit
        d: Diff[L, T]): Aux[L, H :: T, d.Out] =
      new Diff[L, H :: T] {
        type Out = d.Out
  ...
  object Diff extends LowPriorityDiff {
    def apply[L <: HList, M <: HList](implicit
        diff: Diff[L, M]): Aux[L, M, diff.Out] = diff
    ...
    implicit def hconsDiff2[L <: HList, LT <: HList, H, T <: HList](implicit
        r: Remove.Aux[L, H, (H, LT)],
        d: Diff[LT, T]): Aux[L, H :: T, d.Out] =
      new Diff[L, H :: T] {
        type Out = d.Out
  ...
  object Replacer {
    def apply[L <: HList, U, V](implicit
        replacer: Replacer[L, U, V]): Aux[L, U, V, replacer.Out] = replacer
    ...
    implicit def hlistReplacer2[H, T <: HList, U, V, OutT <: HList](implicit
  ...
  object Modifier {
    def apply[L <: HList, U, V](implicit
        modifier: Modifier[L, U, V]): Aux[L, U, V, modifier.Out] = modifier
    ...
    implicit def hlistModify2[H, T <: HList, U, V, OutT <: HList](implicit
        ut: Aux[T, U, V, (U, OutT)]): Aux[H :: T, U, V, (U, H :: OutT)] =
  ...
  object ModifierAt {
    def apply[L <: HList, N <: Nat, U, V](implicit
        modifier: ModifierAt[L, N, U, V]): Aux[L, N, U, V, modifier.Out] =
      modifier

    type Aux[L <: HList, N <: Nat, U, V, Out0] = ModifierAt[L, N, U, V] {
      type Out = Out0
    }
  ...
  object ReplaceAt {
    def apply[L <: HList, N <: Nat, V](implicit
        replacer: ReplaceAt[L, N, V]): Aux[L, N, V, replacer.Out] = replacer

    type Aux[L <: HList, N <: Nat, V, Out0] = ReplaceAt[L, N, V] {
      type Out = Out0
    }
    ...
    implicit def hlistReplaceAt2[H, T <: HList, N <: Nat, U, V, Out0 <: HList](
        implicit
        ut: Aux[T, N, V, (U, Out0)]): Aux[H :: T, Succ[N], V, (U, H :: Out0)] =
  ...
  object At {
    def apply[L <: HList, N <: Nat](implicit at: At[L, N]): Aux[L, N, at.Out] =
      at
    ...
    implicit def hlistAtN[H, T <: HList, N <: Nat](implicit
        att: At[T, N]): Aux[H :: T, Succ[N], att.Out] =
      new At[H :: T, Succ[N]] {
        type Out = att.Out
  ...
  object Drop {
    def apply[L <: HList, N <: Nat](implicit
        drop: Drop[L, N]): Aux[L, N, drop.Out] = drop

    type Aux[L <: HList, N <: Nat, Out0 <: HList] = Drop[L, N] {
      type Out = Out0
    }
    ...
    implicit def hlistDrop2[H, T <: HList, N <: Nat](implicit
        dt: Drop[T, N]): Aux[H :: T, Succ[N], dt.Out] =
      new Drop[H :: T, Succ[N]] {
        type Out = dt.Out
  ...
  object Take {
    def apply[L <: HList, N <: Nat](implicit
        take: Take[L, N]): Aux[L, N, take.Out] = take

    type Aux[L <: HList, N <: Nat, Out0 <: HList] = Take[L, N] {
      type Out = Out0
    }
    ...
    implicit def hlistTake2[H, T <: HList, N <: Nat, Out <: HList](implicit
        tt: Take[T, N]): Aux[H :: T, Succ[N], H :: tt.Out] =
      new Take[H :: T, Succ[N]] {
        type Out = H :: tt.Out
  ...
  object Split {
    def apply[L <: HList, N <: Nat](implicit
        split: Split[L, N]): Aux[L, N, split.Prefix, split.Suffix] = split
    ...
    implicit def split[L <: HList, N <: Nat, P <: HList, S <: HList](implicit
        split: Split0[HNil, L, N, P, S]): Aux[L, N, P, S] =
      new Split[L, N] {
        type Prefix = P
        type Suffix = S
  ...
  object ReverseSplit {
    def apply[L <: HList, N <: Nat](implicit
        split: ReverseSplit[L, N]): Aux[L, N, split.Prefix, split.Suffix] =
      split
  ...
  object SplitLeft {
    def apply[L <: HList, U](implicit
        split: SplitLeft[L, U]): Aux[L, U, split.Prefix, split.Suffix] = split
    ...
    implicit def splitLeft[L <: HList, U, P <: HList, S <: HList](implicit
        splitLeft: SplitLeft0[HNil, L, U, P, S]): Aux[L, U, P, S] =
      new SplitLeft[L, U] {
        type Prefix = P
        type Suffix = S
  ...
  object ReverseSplitLeft {
    def apply[L <: HList, U](implicit
        split: ReverseSplitLeft[L, U]): Aux[L, U, split.Prefix, split.Suffix] =
      split
    ...
    implicit def reverseSplitLeft[L <: HList, U, P <: HList, S <: HList](
        implicit
        splitLeft: ReverseSplitLeft0[HNil, L, U, P, S]): Aux[L, U, P, S] =
  ...
  object SplitRight {
    def apply[L <: HList, U](implicit
        split: SplitRight[L, U]): Aux[L, U, split.Prefix, split.Suffix] = split
    ...
    implicit def splitRight[L <: HList, U, P <: HList, S <: HList](implicit
        splitRight: SplitRight0[L, HNil, HNil, U, P, S]): Aux[L, U, P, S] =
      new SplitRight[L, U] {
        type Prefix = P
        type Suffix = S
    ...
    trait LowPrioritySplitRight0 {
      implicit def hlistSplitRight1[
          ...
          P <: HList,
          S <: HList](implicit
          srt: SplitRight0[RevT, RevH :: AccP, HNil, U, P, S])
      ...
      implicit def hlistSplitRight2[
          ...
          P <: HList,
          S <: HList](implicit
          srt: SplitRight0[HNil, AccPT, AccPH :: AccS, U, P, S])
    ...
    object SplitRight0 extends LowPrioritySplitRight0 {
      implicit def hlistSplitRight3[PH, PT <: HList, S <: HList](implicit
          reverse: Reverse[PH :: PT])
          : SplitRight0[HNil, PH :: PT, S, PH, reverse.Out, S] =
        new SplitRight0[HNil, PH :: PT, S, PH, reverse.Out, S] {
          def apply(
              rev: HNil,
              accP: PH :: PT,
              accS: S): reverse.Out :: S :: HNil = accP.reverse :: accS :: HNil
        }
    }
  }
  ...
  object ReverseSplitRight {
    def apply[L <: HList, U](implicit
        split: ReverseSplitRight[L, U]): Aux[L, U, split.Prefix, split.Suffix] =
      split
    ...
    trait LowPriorityReverseSplitRight0 {
      implicit def hlistReverseSplitRight1[
          ...
          P <: HList,
          S <: HList](implicit
          srt: ReverseSplitRight0[RevT, RevH :: AccP, HNil, U, P, S])
      ...
      implicit def hlistReverseSplitRight2[
          ...
          P <: HList,
          S <: HList](implicit
          srt: ReverseSplitRight0[HNil, AccPT, AccPH :: AccS, U, P, S])
      ...
      implicit def hlistReverseSplitRight3[PH, PT <: HList, S <: HList]
        ...
        new ReverseSplitRight0[HNil, PH :: PT, S, PH, PH :: PT, S] {
          def apply(
              rev: HNil,
              accP: PH :: PT,
              accS: S): (PH :: PT) :: S :: HNil = accP :: accS :: HNil
        }
    }
  }
  ...
  object Reverse {
    ...
    implicit def reverse[L <: HList, Out0 <: HList](implicit
        reverse: Reverse0[HNil, L, Out0]): Aux[L, Out0] =
      new Reverse[L] {
        type Out = Out0
  ...
  object Align {
    def apply[L <: HList, M <: HList](implicit alm: Align[L, M]): Align[L, M] =
      alm
  ...
  trait LowestPriorityPrepend {
    ...
    implicit def hlistPrepend[PH, PT <: HList, S <: HList](implicit
        pt: Prepend[PT, S]): Prepend.Aux[PH :: PT, S, PH :: pt.Out] =
      new Prepend[PH :: PT, S] {
        type Out = PH :: pt.Out
  ...
  trait LowPriorityPrepend extends LowestPriorityPrepend {
    ...
    /**
      ...
      */
    override type Aux[P <: HList, S <: HList, Out0 <: HList] = Prepend[P, S] {
      type Out = Out0
    }
  ...
  object Prepend extends LowPriorityPrepend {
    def apply[P <: HList, S <: HList](implicit
        prepend: Prepend[P, S]): Aux[P, S, prepend.Out] = prepend
  ...
  trait LowPriorityReversePrepend {
    ...
    implicit def hnilReversePrepend0[P <: HList, S <: HNil](implicit
        rv: Reverse[P]): Aux[P, S, rv.Out] =
  ...
  object ReversePrepend extends LowPriorityReversePrepend {
    def apply[P <: HList, S <: HList](implicit
        prepend: ReversePrepend[P, S]): Aux[P, S, prepend.Out] = prepend
    ...
    implicit def hlistReversePrepend[PH, PT <: HList, S <: HList](implicit
        rpt: ReversePrepend[PT, PH :: S]): Aux[PH :: PT, S, rpt.Out] =
  ...
  /**
    ...
    * @author Miles Sabin
    */
  trait ZipOne[H <: HList, T <: HList] extends DepFn2[H, T] with Serializable {
    type Out <: HList
  }

  object ZipOne {
    def apply[H <: HList, T <: HList](implicit
        zip: ZipOne[H, T]): Aux[H, T, zip.Out] = zip

    type Aux[H <: HList, T <: HList, Out0 <: HList] = ZipOne[H, T] {
      type Out = Out0
    }
    ...
    implicit def zipOne4[HH, HT <: HList, TH <: HList, TT <: HList](implicit
        zot: ZipOne[HT, TT]): Aux[HH :: HT, TH :: TT, (HH :: TH) :: zot.Out] =
      new ZipOne[HH :: HT, TH :: TT] {
        type Out = (HH :: TH) :: zot.Out
        def apply(h: HH :: HT, t: TH :: TT): Out =
          (h.head :: t.head) :: zot(h.tail, t.tail)
      }
  }
  ...
  /**
    ...
    * @author Miles Sabin
    */
  trait Transposer[L <: HList] extends DepFn1[L] with Serializable {
    type Out <: HList
  }

  object Transposer {
    def apply[L <: HList](implicit
        transposer: Transposer[L]): Aux[L, transposer.Out] = transposer
    ...
    implicit def hlistTransposer1[H <: HList, MC <: HList, Out0 <: HList](
        implicit
        mc: ConstMapper.Aux[HNil, H, MC],
        zo: ZipOne.Aux[H, MC, Out0]): Aux[H :: HNil, Out0] =
  ...
  /**
    ...
    * @author Miles Sabin
    */
  trait Zip[L <: HList] extends DepFn1[L] with Serializable {
    type Out <: HList
  }
  ...
  object Zip {
    ...
    implicit def zipper[L <: HList, OutT <: HList](implicit
  ...
  object Unzip {
    ...
    implicit def unzipper[L <: HList, OutM <: HList, OutT <: HList](implicit
  ...
  object ZipApply {
    def apply[FL <: HList, AL <: HList](implicit
        zip: ZipApply[FL, AL]): Aux[FL, AL, zip.Out] = zip

    type Aux[FL <: HList, AL <: HList, Out0 <: HList] = ZipApply[FL, AL] {
      type Out = Out0
    }
    ...
    implicit def hconsZipApply[T, R, FLT <: HList, ALT <: HList](implicit
        ztt: ZipApply[FLT, ALT]): Aux[(T => R) :: FLT, T :: ALT, R :: ztt.Out] =
      new ZipApply[(T => R) :: FLT, T :: ALT] {
        type Out = R :: ztt.Out
        def apply(fl: (T => R) :: FLT, al: T :: ALT): Out =
          fl.head(al.head) :: ztt(fl.tail, al.tail)
      }
  }
  ...
  object ZipConst {
    ...
    implicit def constZipper[C, L <: HList, M <: HList](implicit
  ...
  object ZipWith {
    def apply[L <: HList, R <: HList, P <: Poly2](implicit
        zipWith: ZipWith[L, R, P]): Aux[L, R, P, zipWith.Out] = zipWith
  ...
  object ZipWithKeys {
    ...
    def apply[K <: HList, V <: HList](implicit
        zipWithKeys: ZipWithKeys[K, V]): Aux[K, V, zipWithKeys.Out] =
      zipWithKeys

    type Aux[K <: HList, V <: HList, Out0 <: HList] = ZipWithKeys[K, V] {
      type Out = Out0
    }

    implicit val hnilZipWithKeys: Aux[HNil, HNil, HNil] =
      new ZipWithKeys[HNil, HNil] {
        type Out = HNil
        def apply(v: HNil) = HNil
      }

    implicit def hconsZipWithKeys[KH, VH, KT <: HList, VT <: HList](implicit
        zipWithKeys: ZipWithKeys[KT, VT],
        wkh: Witness.Aux[KH])
  ...
  object ZipWithIndex {
    def apply[L <: HList](implicit
        zipWithIndex: ZipWithIndex[L]): Aux[L, zipWithIndex.Out] = zipWithIndex
    ...
    object Helper {
      def apply[L <: HList, N <: Nat](implicit
          helper: Helper[L, N]): Aux[L, N, helper.Out] = helper

      type Aux[L <: HList, N <: Nat, Out0 <: HList] = Helper[L, N] {
        type Out = Out0
      }
      ...
      implicit def hcons[H, T <: HList, OutT <: HList, N <: Nat](implicit
          tail: Helper.Aux[T, Succ[N], OutT]): Aux[H :: T, N, (H, N) :: OutT] =
        new Helper[H :: T, N] {
          type Out = (H, N) :: OutT
    ...
    implicit def default[L <: HList, P <: HList](implicit
        helper: Helper.Aux[L, _0, P]): Aux[L, P] =
      new ZipWithIndex[L] {
        type Out = P
  ...
  object Collect extends LowPriorityCollect {
    def apply[L <: HList, P <: Poly](implicit
        collect: Collect[L, P]): Aux[L, P, collect.Out] = collect

    type Aux[L <: HList, P <: Poly, Out0 <: HList] = Collect[L, P] {
      type Out = Out0
    }

    implicit def hnilCollect[P <: Poly]: Aux[HNil, P, HNil] =
      new Collect[HNil, P] {
        type Out = HNil
    ...
    implicit def hlistCollect[LH, LT <: HList, P <: Poly](implicit
        collect: Collect[LT, P],
        clr: Case1[P, LH]): Aux[LH :: LT, P, clr.Result :: collect.Out] =
      new Collect[LH :: LT, P] {
  ...
  trait LowPriorityCollect {
    implicit def hlistNoPolyCase[LH, LT <: HList, P <: Poly](implicit
        collect: Collect[LT, P]): Collect.Aux[LH :: LT, P, collect.Out] =
      new Collect[LH :: LT, P] {
  ...
  implicit def hlistOrdering[H, T <: HList](implicit
      ...
      tOrdering: Ordering[T]): Ordering[H :: T] =
    new Ordering[H :: T] {
  ...
  object MapCons {
    def apply[A, M <: HList](implicit
        mapCons: MapCons[A, M]): Aux[A, M, mapCons.Out] = mapCons
    ...
    implicit def hlistMapCons[A, H <: HList, TM <: HList](implicit
        mapCons: MapCons[A, TM]): Aux[A, H :: TM, (A :: H) :: mapCons.Out] =
      new MapCons[A, H :: TM] {
  ...
  object Interleave {
    def apply[A, L <: HList](implicit
        interleave: Interleave[A, L]): Aux[A, L, interleave.Out] = interleave

    type Aux[A, L <: HList, Out0 <: HList] = Interleave[A, L] {
      type Out = Out0
    }
    ...
    implicit def hlistInterleave[A, H, T <: HList, LI <: HList](implicit
        interleave: Interleave.Aux[A, T, LI],
        mapCons: MapCons[H, LI]): Aux[A, H :: T, (A :: H :: T) :: mapCons.Out] =
      new Interleave[A, H :: T] {
        type Out = (A :: H :: T) :: mapCons.Out

        def apply(a: A, l: H :: T): Out =
          (a :: l) :: mapCons(l.head, interleave(a, l.tail))
      }
  }
  ...
  object FlatMapInterleave {
    def apply[A, M <: HList](implicit
        flatMapInterleave: FlatMapInterleave[A, M])
        : Aux[A, M, flatMapInterleave.Out] = flatMapInterleave

    type Aux[A, M <: HList, Out0 <: HList] = FlatMapInterleave[A, M] {
      type Out = Out0
    }
    ...
    implicit def hlistFlatMapInterleave[
        ...
        HO <: HList,
        TMO <: HList](implicit
        interleave: Interleave.Aux[A, H, HO],
  ...
  /**
    ...
    * @author Stacy Curl
    */
  trait Permutations[L <: HList] extends DepFn1[L] with Serializable {
    type Out <: HList
  }

  object Permutations {
    def apply[L <: HList](implicit
        permutations: Permutations[L]): Aux[L, permutations.Out] = permutations

    type Aux[L <: HList, Out0] = Permutations[L] { type Out = Out0 }

    implicit def hnilPermutations[L <: HNil]: Aux[L, HNil :: HNil] =
      new Permutations[L] {
        type Out = HNil :: HNil
    ...
    implicit def hlistPermutations[H, T <: HList, TP <: HList](implicit
        permutations: Permutations.Aux[T, TP],
        flatMapInterleave: FlatMapInterleave[H, TP])
        : Aux[H :: T, flatMapInterleave.Out] =
      new Permutations[H :: T] {
        type Out = flatMapInterleave.Out

        def apply(l: H :: T): Out =
          flatMapInterleave(l.head, permutations(l.tail))
      }
  }
  ...
  /**
    ...
    * @author Stacy Curl
    */
  trait RotateLeft[L <: HList, N <: Nat] extends DepFn1[L] with Serializable {
    type Out <: HList
  }

  object RotateLeft extends LowPriorityRotateLeft {
    def apply[L <: HList, N <: Nat](implicit
        rotateLeft: RotateLeft[L, N]): Aux[L, N, rotateLeft.Out] = rotateLeft

    implicit def hnilRotateLeft[L <: HNil, N <: Nat]: RotateLeft.Aux[L, N, L] =
      new RotateLeft[L, N] {
        type Out = L
        def apply(l: L) = l
      }
  ...
  object RotateRight extends LowPriorityRotateRight {
    def apply[L <: HList, N <: Nat](implicit
        rotateRight: RotateRight[L, N]): Aux[L, N, rotateRight.Out] =
      rotateRight
  ...
  trait LowPriorityRotateRight {
    type Aux[L <: HList, N <: Nat, Out0 <: HList] = RotateRight[L, N] {
      type Out = Out0
    }
  ...
  object LeftScanner {
    def apply[L <: HList, In, P <: Poly](implicit
        scan: LeftScanner[L, In, P]): Aux[L, In, P, scan.Out] = scan

    type Aux[L <: HList, In, P <: Poly, Out0 <: HList] = LeftScanner[L, In, P] {
      type Out = Out0
    }
    ...
    implicit def hlistLeftScanner[H, T <: HList, In, P <: Poly, OutP](implicit
        ev: Case2.Aux[P, H, In, OutP],
        scan: LeftScanner[T, OutP, P]): Aux[H :: T, In, P, In :: scan.Out] =
      new LeftScanner[H :: T, In, P] {
        type Out = In :: scan.Out

        def apply(l: H :: T, in: In) =
          in :: scan(l.tail, ev(l.head, in)) // check it's (h, in) vs (in, h)
      }
  }
  ...
  object RightScanner {
    def apply[L <: HList, In, P <: Poly](implicit
        scanR: RightScanner[L, In, P]) = scanR
    ...
    implicit def hlistRightScanner0[H, H0, T <: HList, P <: Poly](implicit
        ev: Case2[P, H0, H]) =
    ...
    type Aux[L <: HList, In, P <: Poly, Out0 <: HList] =
      RightScanner[L, In, P] { type Out = Out0 }
  ...
  object Fill {
    ...
    implicit def fill1Succ[N <: Nat, A, OutT <: HList](implicit
        prev: Aux[N, A, OutT]): Aux[Succ[N], A, A :: OutT] =
      new Fill[Succ[N], A] {
        type Out = A :: OutT
        def apply(elem: A) = elem :: prev(elem)
      }

    implicit def fill2[A, N1 <: Nat, N2 <: Nat, SubOut, OutT <: HList](implicit
        subFill: Aux[N2, A, SubOut],
        fill: Aux[N1, SubOut, OutT]): Aux[(N1, N2), A, OutT] =
      new Fill[(N1, N2), A] {
        type Out = OutT
  ...
  object Patcher {
    def apply[N <: Nat, M <: Nat, L <: HList, In <: HList](implicit
        patch: Patcher[N, M, L, In]) = patch
  ...
  object CollectFirst extends LowPriorityCollectFirst {
    def apply[L <: HList, P <: Poly](implicit
        cf: CollectFirst[L, P]): Aux[L, P, cf.Out] = cf

    implicit def hlistEval[H, T <: HList, P <: Poly](implicit
        ev: Case1[P, H]): Aux[H :: T, P, ev.Result] =
  ...
  trait LowPriorityCollectFirst {
    type Aux[L <: HList, P <: Poly, Out0] = CollectFirst[L, P] {
      type Out = Out0
    }

    implicit def hlistIterate[H, T <: HList, P <: Poly](implicit
        cf: CollectFirst[T, P]): Aux[H :: T, P, cf.Out] =
      new CollectFirst[H :: T, P] {
        type Out = cf.Out
  ...
  private def toTuple2[Prefix, Suffix](
      l: Prefix :: Suffix :: HNil): (Prefix, Suffix) = (l.head, l.tail.head)
  ...
  object LiftAll {
    type Aux[F[_], In0 <: HList, Out0 <: HList] = LiftAll[F, In0] {
      type Out = Out0
    }
    class Curried[F[_]] {
  ...
  /**
    ...
    * @author ryoppy
    */
  trait PadTo[N, A, L <: HList] extends DepFn2[A, L] with Serializable {
    type Out <: HList
  }

  object PadTo {
    def apply[N, A, L <: HList](implicit
        padTo: PadTo[N, A, L]): Aux[N, A, L, padTo.Out] = padTo
    ...
    implicit def padToHNil[N <: Nat, A](implicit
        padTo: PadTo[N, A, HNil]): Aux[Succ[N], A, HNil, A :: padTo.Out] =
      new PadTo[Succ[N], A, HNil] {
        type Out = A :: padTo.Out
        def apply(a: A, l: HNil) = a :: padTo(a, l)
      }

    implicit def padTo1[N <: Nat, A, H, T <: HList](implicit
        padTo: PadTo[N, A, T]): Aux[Succ[N], A, H :: T, H :: padTo.Out] =
  ...
  object Slice {
    def apply[N, U, L <: HList](implicit
        slice: Slice[N, U, L]): Aux[N, U, L, slice.Out] = slice
    ...
    implicit def slice1[N <: Nat, U <: Nat, H, T <: HList](implicit
        slice: Slice[N, U, T]): Aux[Succ[N], Succ[U], H :: T, slice.Out] =
      new Slice[Succ[N], Succ[U], H :: T] {
        type Out = slice.Out
        def apply(l: H :: T): Out = slice(l.tail)
      }

    implicit def slice2[U <: Nat, H, T <: HList](implicit
        slice: Slice[_0, U, T]): Aux[_0, Succ[U], H :: T, H :: slice.Out] =
