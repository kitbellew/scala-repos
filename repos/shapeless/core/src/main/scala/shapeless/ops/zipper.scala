...
object zipper {
  ...
  object RightBy {
    ...
    type Aux[Z, N <: Nat, Out0] = RightBy[Z, N] {
      type Out = Out0
    }
  ...
  object LeftBy {
    ...
    type Aux[Z, N <: Nat, Out0] = LeftBy[Z, N] {
      type Out = Out0
    }
  ...
  object Modify {
    ...
    type Aux[Z, E1, E2, Out0] = Modify[Z, E1, E2] {
      type Out = Out0
    }
