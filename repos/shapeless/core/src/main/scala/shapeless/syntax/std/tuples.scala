...
final class TupleOps[T](t: T) extends Serializable {
  ...
  def reverse_:::[U](u: U)(implicit
      prepend: ReversePrepend[U, T]): prepend.Out = prepend(u, t)
  ...
  def updatedElem[U, R](u: U)(implicit
      replacer: Replacer.Aux[T, U, U, (U, R)]): R = replacer(t, u)._2

  class UpdatedTypeAux[U] {
    def apply[V, R](v: V)(implicit replacer: Replacer.Aux[T, V, U, (U, R)]): R =
      replacer(t, v)._2
  }
  ...
  class UpdateWithAux[U] {
    def apply[V, R](f: U => V)(implicit
        modifier: Modifier.Aux[T, U, V, (U, R)]): R = modifier(t, f)._2
  }
  ...
  def updateAtWith[U](
      n: NatWith[
        ({
          type λ[t <: Nat] = At[T, t]
        })#λ])(f: n.instance.Out => U)(implicit
      upd: ModifierAt[T, n.N, n.instance.Out, U]): upd.Out = upd(t, f)

  class UpdatedAtAux[N <: Nat] {
    def apply[U, V, R](u: U)(implicit
        replacer: ReplaceAt.Aux[T, N, U, (V, R)]): R = replacer(t, u)._2
  }
  ...
  def updatedAt[U, V, R](n: Nat, u: U)(implicit
      replacer: ReplaceAt.Aux[T, n.N, U, (V, R)]): R = replacer(t, u)._2
  ...
  def reverse_splitLeft[U](implicit
      splitLeft: ReverseSplitLeft[T, U]): splitLeft.Out = splitLeft(t)
  ...
  def reverse_splitRight[U](implicit
      splitRight: ReverseSplitRight[T, U]): splitRight.Out = splitRight(t)
  ...
  def foldMap[R](z: R)(f: Poly)(op: (R, R) => R)(implicit
      folder: MapFolder[T, R, f.type]): R = folder(t, z, op)
  ...
  def foldLeft[R](z: R)(op: Poly)(implicit
      folder: LeftFolder[T, R, op.type]): folder.Out = folder(t, z)
  ...
  def foldRight[R](z: R)(op: Poly)(implicit
      folder: RightFolder[T, R, op.type]): folder.Out = folder(t, z)
  ...
  def reduceLeft(op: Poly)(implicit
      reducer: LeftReducer[T, op.type]): reducer.Out = reducer(t)
  ...
  def reduceRight(op: Poly)(implicit
      reducer: RightReducer[T, op.type]): reducer.Out = reducer(t)
  ...
  def unifySubtypes[B](implicit
      subtypeUnifier: SubtypeUnifier[T, B]): subtypeUnifier.Out =
    subtypeUnifier(t)
  ...
  /**
    ...
    * of this tuple.
    */
  def to[M[_]](implicit toTraversable: ToTraversable[T, M]): toTraversable.Out =
    toTraversable(t)
  ...
  def mkString(start: String, sep: String, end: String)(implicit
      toTraversable: ToTraversable.Aux[T, List, Any]): String =
  ...
  def rotateLeft(n: Nat)(implicit
      rotateLeft: RotateLeft[T, n.N]): rotateLeft.Out = rotateLeft(t)

  /**
    * Rotate this tuple right by N
    */
  def rotateRight(n: Nat)(implicit
      rotateRight: RotateRight[T, n.N]): rotateRight.Out = rotateRight(t)
  ...
  def scanLeft[Z, P <: Poly](z: Z)(op: Poly)(implicit
      scanL: LeftScanner[T, Z, op.type]): scanL.Out = scanL(t, z)
  ...
  def patch[In](n: Nat, in: In, m: Nat)(implicit
      patcher: Patcher[n.N, m.N, T, In]): patcher.Out = patcher(t, in)
  ...
  class PatchAux[N <: Nat, M <: Nat] {
    def apply[In](in: In)(implicit patcher: Patcher[N, M, T, In]): patcher.Out =
      patcher(t, in)
  }
  ...
  def group(n: Nat, step: Nat)(implicit
      grouper: Grouper[T, n.N, step.N]): grouper.Out = grouper(t)
  ...
  def group[Pad](n: Nat, step: Nat, pad: Pad)(implicit
      grouper: PaddedGrouper[T, n.N, step.N, Pad]): grouper.Out =
    grouper(t, pad)
}
