...
final class HListOps[L <: HList](l: L) extends Serializable {
  ...
  /**
    ...
    */
  def updateAtWith[V](n: NatWith[({
    type λ[n <: Nat] = At[L, n]
  })#λ])(f: n.instance.Out => V)(
  ...
  /**
    ...
    */
  def splitRight[U](
      implicit split: SplitRight[L, U]): (split.Prefix, split.Suffix) = split(l)
  def splitRightP[U](
  ...
  def rotateRight[N <: Nat](
      implicit rotateRight: RotateRight[L, N]): rotateRight.Out = rotateRight(l)
