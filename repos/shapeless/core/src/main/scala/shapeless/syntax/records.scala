...
final class RecordOps[L <: HList](val l: L) extends AnyVal with Serializable {
  ...
  /**
    ...
    */
  def apply(k: Witness)(implicit selector: Selector[L, k.T]): selector.Out =
    selector(l)
  ...
  /**
    ...
    */
  def remove(k: Witness)(implicit remover: Remover[L, k.T]): remover.Out =
    remover(l)
  ...
  /**
    ...
    */
  def merge[M <: HList](m: M)(implicit merger: Merger[L, M]): merger.Out =
    merger(l, m)
