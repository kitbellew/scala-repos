...
class HListTests {
  ...
  trait M2[A, B]
  type M2IM2SM2IM2IM2D =
    M2[Int, Unit] :: M2[String, Unit] :: M2[Int, Unit] :: M2[Int, Unit] :: M2[
      Double,
      Unit] :: HNil
  ...
  type M2EIM2ESM2EIM2EEM2ED =
    M2[Int, _] :: M2[String, _] :: M2[Int, _] :: M2[Int, _] :: M2[
      Double,
      _] :: HNil
  ...
  def testNatTRelMap {
    type L1 =
      Option[Int] :: Option[Boolean] :: Option[String] :: Option[
        Nothing] :: HNil
    type L2 =
