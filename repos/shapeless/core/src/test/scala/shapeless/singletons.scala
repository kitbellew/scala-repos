...
class SingletonTypesTests {
  ...
  object Show {
    implicit val showTrue =
      new Show[True] {
        def show = "true"
      }
    implicit val showFalse =
      new Show[False] {
        def show = "false"
      }

    implicit val showOne =
      new Show[_1] {
        def show = "One"
      }
    implicit val showTwo =
      new Show[_2] {
        def show = "Two"
      }
    implicit val showThree =
      new Show[_3] {
        def show = "Three"
      }

    implicit val showFoo =
      new Show[Foo] {
        def show = "'foo"
      }
    implicit val showBar =
      new Show[Bar] {
        def show = "'bar"
      }
  }
  ...
  object LiteralShow {
    implicit val showTrue =
      new LiteralShow[Witness.`true`.T] {
        def show = "true"
      }
    implicit val showFalse =
      new LiteralShow[Witness.`false`.T] {
        def show = "false"
      }

    implicit val showOne =
      new LiteralShow[Witness.`1`.T] {
        def show = "One"
      }
    implicit val showTwo =
      new LiteralShow[Witness.`2`.T] {
        def show = "Two"
      }
    implicit val showThree =
      new LiteralShow[Witness.`3`.T] {
        def show = "Three"
      }

    implicit val showFoo =
      new LiteralShow[Witness.`'foo`.T] {
        def show = "'foo"
      }
    implicit val showBar =
      new LiteralShow[Witness.`'bar`.T] {
        def show = "'bar"
      }
  }
  ...
  object LiteralsShow {
    implicit val showTrueFalse =
      new LiteralsShow[HList.`true, false`.T] {
        def show = "true, false"
      }
    ...
    implicit val showFooBar =
      new LiteralsShow[HList.`'foo, 'bar`.T] {
        def show = "'foo, 'bar"
      }
  }
