...
class NNLSSuite extends SparkFunSuite {
  ...
  test("NNLS: nonnegativity constraint active") {
    val n = 5
    val ata = Array(
      4.377, -3.531, -1.306, -0.139, 3.418, -3.531, 4.344, 0.934, 0.305, -2.140,
      -1.306, 0.934, 2.644, -0.203, -0.170, -0.139, 0.305, -0.203, 5.883, 1.428,
  ...
  test("NNLS: objective value test") {
    ...
    val ata =
      new BDM(
        ...
        5,
        Array(
          517399.13534, 242529.67289, -153644.98976, 130802.84503,
