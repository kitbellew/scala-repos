...
class PairDStreamFunctions[K, V](self: DStream[(K, V)])(implicit
  ...
  def groupByKey(): DStream[(K, Iterable[V])] =
    ssc.withScope { groupByKey(defaultPartitioner()) }
  ...
  def reduceByKey(reduceFunc: (V, V) => V): DStream[(K, V)] =
    ssc.withScope { reduceByKey(reduceFunc, defaultPartitioner()) }
  ...
  def reduceByKey(
    ...
    ssc.withScope { reduceByKey(reduceFunc, defaultPartitioner(numPartitions)) }
  ...
  def groupByKeyAndWindow(
    ...
    ssc.withScope {
      ...
      self.groupByKey(partitioner).window(windowDuration, slideDuration)
        .combineByKey[ArrayBuffer[V]](
          createCombiner,
          mergeValue,
          mergeCombiner,
          partitioner).asInstanceOf[DStream[(K, Iterable[V])]]
    }
  ...
  def reduceByKeyAndWindow(
    ...
    ssc.withScope {
      ...
      val cleanedFilterFunc =
        if (filterFunc != null) Some(ssc.sc.clean(filterFunc)) else None
      new ReducedWindowedDStream[K, V](
        self,
        cleanedReduceFunc,
        cleanedInvReduceFunc,
        cleanedFilterFunc,
        windowDuration,
        slideDuration,
        partitioner)
  ...
  def updateStateByKey[S: ClassTag](
    ...
    ssc.withScope { updateStateByKey(updateFunc, defaultPartitioner()) }
  ...
  def flatMapValues[U: ClassTag](
      flatMapValuesFunc: V => TraversableOnce[U]): DStream[(K, U)] =
    ssc.withScope {
      new FlatMapValuedDStream[K, V, U](
        self,
  ...
  def cogroup[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner): DStream[(K, (Iterable[V], Iterable[W]))] =
    ssc.withScope {
      self.transformWith(
        other,
  ...
  def join[W: ClassTag](
    ...
    ssc.withScope { join[W](other, defaultPartitioner(numPartitions)) }
  ...
  def join[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner): DStream[(K, (V, W))] =
    ssc.withScope {
      self.transformWith(
        other,
  ...
  def leftOuterJoin[W: ClassTag](
    ...
    ssc.withScope { leftOuterJoin[W](other, defaultPartitioner()) }
  ...
  def leftOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int): DStream[(K, (V, Option[W]))] =
    ssc.withScope { leftOuterJoin[W](other, defaultPartitioner(numPartitions)) }
  ...
  def leftOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner): DStream[(K, (V, Option[W]))] =
    ssc.withScope {
      self.transformWith(
        other,
        (rdd1: RDD[(K, V)], rdd2: RDD[(K, W)]) =>
  ...
  def rightOuterJoin[W: ClassTag](
    ...
    ssc.withScope { rightOuterJoin[W](other, defaultPartitioner()) }
  ...
  def rightOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int): DStream[(K, (Option[V], W))] =
    ssc.withScope {
  ...
  def rightOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner): DStream[(K, (Option[V], W))] =
    ssc.withScope {
      self.transformWith(
        other,
        (rdd1: RDD[(K, V)], rdd2: RDD[(K, W)]) =>
  ...
  def fullOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      numPartitions: Int): DStream[(K, (Option[V], Option[W]))] =
    ssc.withScope { fullOuterJoin[W](other, defaultPartitioner(numPartitions)) }
  ...
  def fullOuterJoin[W: ClassTag](
      other: DStream[(K, W)],
      partitioner: Partitioner): DStream[(K, (Option[V], Option[W]))] =
    ssc.withScope {
      self.transformWith(
        other,
        (rdd1: RDD[(K, V)], rdd2: RDD[(K, W)]) =>
  ...
  def saveAsHadoopFiles[F <: OutputFormat[K, V]](
      prefix: String,
      suffix: String)(implicit fm: ClassTag[F]): Unit =
    ssc.withScope {
      saveAsHadoopFiles(
        prefix,
        suffix,
  ...
  def saveAsHadoopFiles(
      ...
      conf: JobConf = new JobConf(ssc.sparkContext.hadoopConfiguration)): Unit =
    ssc.withScope {
  ...
  def saveAsNewAPIHadoopFiles(
      ...
      conf: Configuration = ssc.sparkContext.hadoopConfiguration): Unit =
    ssc.withScope {
      // Wrap conf in SerializableWritable so that ForeachDStream can be serialized for checkpoints
