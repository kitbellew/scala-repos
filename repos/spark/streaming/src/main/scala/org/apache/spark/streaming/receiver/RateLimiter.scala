...
private[receiver] abstract class RateLimiter(conf: SparkConf) extends Logging {
  ...
  private val maxRateLimit = conf
    .getLong("spark.streaming.receiver.maxRate", Long.MaxValue)
  private lazy val rateLimiter = GuavaRateLimiter
    .create(getInitialRateLimit().toDouble)
