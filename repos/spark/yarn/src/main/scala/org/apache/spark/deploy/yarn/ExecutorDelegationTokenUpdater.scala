...
private[spark] class ExecutorDelegationTokenUpdater(
  ...
  private val freshHadoopConf = SparkHadoopUtil
    .get
    .getConfBypassingFSCache(
      hadoopConf,
  ...
  def updateCredentialsIfRequired(): Unit = {
    try {
      ...
      val timeFromNowToRenewal = SparkHadoopUtil
        .get
        .getTimeFromNowToRenewal(
          sparkConf,
          0.8,
