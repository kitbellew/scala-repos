  ...
  private def matchAlterTableCommands(
    ...
    otherNodes match {
      ...
      case Token(
            ...
            Token(
              "TOK_TABLESKEWED",
              Token("TOK_TABCOLNAME", colNames) :: colValues :: rest) :: Nil) ::
          _ =>
        // Example format:
        //
        //   TOK_ALTERTABLE_SKEWED
      ...
      case Token(
            ...
            Token(
              ...
              Token("TOK_SKEWED_LOCATION_LIST", locationMaps) :: Nil) :: Nil) ::
          _ =>
        // Example format:
        //
        //   TOK_ALTERTABLE_SKEWED_LOCATION
      ...
      case Token("TOK_ALTERTABLE_EXCHANGEPARTITION", spec :: newTable :: Nil) ::
          _ =>
