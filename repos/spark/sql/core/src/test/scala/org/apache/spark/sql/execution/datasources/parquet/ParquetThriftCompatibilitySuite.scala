...
class ParquetThriftCompatibilitySuite
  ...
  private val parquetFilePath = Thread.currentThread().getContextClassLoader
    ...
    checkAnswer(
      ...
      (0 until 10).map { i =>
        ...
        val nullablePrimitiveValues =
          if (i % 3 == 0) { Seq.fill(nonNullablePrimitiveValues.length)(null) }
  ...
  test("SPARK-10136 list of primitive list") {
    withTempPath { dir =>
      ...
      //     1: list<list<i32>> f;
      //   }
      val schema = s"""message ListOfPrimitiveList {
