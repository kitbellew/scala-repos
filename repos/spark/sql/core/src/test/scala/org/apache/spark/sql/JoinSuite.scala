...
//  }
  ...
  test("left outer join") {
    ...
    checkAnswer(
      sql("""
        ...
        |GROUP BY l.N
      """.stripMargin),
      Row(1, 1) :: Row(2, 1) :: Row(3, 1) :: Row(4, 1) :: Row(5, 1) :: Row(6, 1) :: Nil
    )
  ...
  test("full outer join") {
    ...
    checkAnswer(
      ...
      Row(1, "A", null, null) :: Row(2, "B", null, null) :: Row(
        ...
        "C",
        null,
        null) :: Row(null, null, 3, "C") :: Row(4, "D", 4, "D") :: Row(
        null,
        null,
        5,
    ...
    checkAnswer(
      sql("""
          ...
          |GROUP BY r.N
        """.stripMargin),
      Row(1, 1) :: Row(2, 1) :: Row(3, 1) :: Row(4, 1) :: Row(5, 1) :: Row(6, 1) :: Row(
        null,
        4) :: Nil
    )
  ...
  test("cross join with broadcast") {
    ...
    withSQLConf(
      ...
      assert(
        statisticSizeInByte(sqlContext.table("testData")) < sqlContext.conf.autoBroadcastJoinThreshold)
