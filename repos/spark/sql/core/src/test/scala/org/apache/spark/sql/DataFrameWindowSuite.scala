...
class DataFrameWindowSuite extends QueryTest with SharedSQLContext {
  ...
  test("rank functions in unspecific window") {
    ...
    checkAnswer(
      df.select(
        $"key",
        max("key")
          .over(Window.partitionBy("value").orderBy("key")),
        min("key")
          .over(Window.partitionBy("value").orderBy("key")),
        mean("key")
          .over(Window.partitionBy("value").orderBy("key")),
      ...
      Row(1, 1, 1, 1.0d, 1, 1, 1, 1, 1, 1, 1.0d,
        0.0d) :: Row(1, 1, 1, 1.0d, 1, 1, 1, 1, 1, 1, 1.0d / 3.0d, 0.0d) :: Row(
        2,
        2,
        1,
        5.0d / 3.0d,
        ...
        2,
        1.0d,
        0.5d) :: Row(2, 2, 1, 5.0d / 3.0d, 3, 5, 2, 3, 2, 2, 1.0d, 0.5d) :: Nil
    )
  }
  ...
  test("reverse sliding range frame") {
    ...
    checkAnswer(
      ...
      Row(1, 5833) :: Row(2, 2000) :: Row(3, 5500) :: Row(4, 5833) :: Row(
        5,
        5833) :: Row(6, 2833) :: Row(7, 3000) :: Row(8, 3000) :: Row(9, 5500) :: Row(
        10,
        6000) :: Nil
    )
  }
  ...
  test("reverse unbounded range frame") {
    ...
    checkAnswer(
      ...
      Row(1, 13, null) :: Row(2, 13, 2) :: Row(4, 7, 9) :: Row(3, 11, 6) :: Row(
        2,
        13,
        2) :: Row(1, 13, null) :: Nil
    )
  ...
  test("statistical functions") {
    ...
    checkAnswer(
      ...
      Seq.fill(4)(Row("a", 1.0d / 4.0d, 1.0d / 3.0d, 2)) ++ Seq.fill(3)(
        Row("b", 2.0d / 3.0d, 1.0d, 3))
    )
  }
