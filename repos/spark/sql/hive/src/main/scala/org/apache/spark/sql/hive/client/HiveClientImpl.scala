...
private[hive] class HiveClientImpl(
  ...
  override def currentDatabase: String =
    withHiveState { state.getCurrentDatabase }
  ...
  override def listDatabases(pattern: String): Seq[String] =
    withHiveState { client.getDatabasesByPattern(pattern).asScala.toSeq }
  ...
  override def createView(view: CatalogTable): Unit =
    withHiveState { client.createTable(toHiveViewTable(view)) }

  override def alertView(view: CatalogTable): Unit =
    withHiveState {
  ...
  override def getAllPartitions(
      table: CatalogTable): Seq[CatalogTablePartition] =
    withHiveState {
      val hiveTable = toHiveTable(table)
  ...
  override def listTables(dbName: String): Seq[String] =
    withHiveState { client.getAllTables(dbName).asScala }
  ...
  override def dropFunction(db: String, name: String): Unit =
    withHiveState { client.dropFunction(db, name) }
  ...
  override def getFunctionOption(
    ...
    withHiveState { Option(client.getFunction(db, name)).map(fromHiveFunction) }
