...
class DateTimeUtilsSuite extends SparkFunSuite {
  ...
  test("string to date") {
    ...
    assert(
      stringToDate(UTF8String.fromString("2015-01-28")).get ===
        millisToDays(c.getTimeInMillis))
    c.set(2015, 0, 1, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToDate(UTF8String.fromString("2015")).get ===
        millisToDays(c.getTimeInMillis))
    c.set(1, 0, 1, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToDate(UTF8String.fromString("0001")).get ===
        millisToDays(c.getTimeInMillis))
    c = Calendar.getInstance()
    c.set(2015, 2, 1, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToDate(UTF8String.fromString("2015-03")).get ===
        millisToDays(c.getTimeInMillis))
    c = Calendar.getInstance()
    c.set(2015, 2, 18, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToDate(UTF8String.fromString("2015-03-18")).get ===
        millisToDays(c.getTimeInMillis))
    assert(
      stringToDate(UTF8String.fromString("2015-03-18 ")).get ===
        millisToDays(c.getTimeInMillis))
    assert(
      stringToDate(UTF8String.fromString("2015-03-18 123142")).get ===
        millisToDays(c.getTimeInMillis))
    assert(
      stringToDate(UTF8String.fromString("2015-03-18T123123")).get ===
        millisToDays(c.getTimeInMillis))
    assert(
      stringToDate(UTF8String.fromString("2015-03-18T")).get ===
        millisToDays(c.getTimeInMillis))
  ...
  test("string to timestamp") {
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("1969-12-31 16:00:00")).get ===
        c.getTimeInMillis * 1000)
    c.set(1, 0, 1, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("0001")).get ===
        c.getTimeInMillis * 1000)
    c = Calendar.getInstance()
    c.set(2015, 2, 1, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03")).get ===
        c.getTimeInMillis * 1000)
    c = Calendar.getInstance()
    c.set(2015, 2, 18, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18")).get ===
        c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18 ")).get ===
        c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T")).get ===
        c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18 12:03:17")).get ===
        c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17")).get ===
        c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17-13:53"))
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17Z")).get ===
        c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18 12:03:17Z")).get ===
        c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17+07:30"))
        .get === c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17+07:03"))
        .get === c.getTimeInMillis * 1000)
    ...
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18 12:03:17.123"))
        .get === c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17.123"))
        .get === c.getTimeInMillis * 1000)
    ...
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17.456Z"))
        .get === c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18 12:03:17.456Z"))
        .get === c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 123)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17.123-1:0"))
        .get === c.getTimeInMillis * 1000)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17.123-01:00"))
        .get === c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 123)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03:17.123+07:30"))
        .get === c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 0)
    assert(
      stringToTimestamp(UTF8String.fromString("18:12:15")).get ===
        c.getTimeInMillis * 1000)
    ...
    c.set(Calendar.MILLISECOND, 123)
    assert(
      stringToTimestamp(UTF8String.fromString("T18:12:15.12312+7:30")).get ===
        c.getTimeInMillis * 1000 + 120)
    ...
    c.set(Calendar.MILLISECOND, 123)
    assert(
      stringToTimestamp(UTF8String.fromString("18:12:15.12312+7:30")).get ===
        c.getTimeInMillis * 1000 + 120)
    ...
    assert(
      stringToTimestamp(UTF8String.fromString("2011-05-06 07:08:09.1000"))
        .get === c.getTimeInMillis * 1000)
    ...
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03.17-20:0"))
        .isEmpty)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03.17-0:70"))
        .isEmpty)
    assert(
      stringToTimestamp(UTF8String.fromString("2015-03-18T12:03.17-1:0:0"))
        .isEmpty)
