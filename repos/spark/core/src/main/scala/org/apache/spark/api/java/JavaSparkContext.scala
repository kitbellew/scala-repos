...
class JavaSparkContext(val sc: SparkContext)
  ...
  /** Distribute a local Scala collection to form an RDD. */
  def parallelizePairs[K, V](
      list: java.util.List[Tuple2[K, V]]): JavaPairRDD[K, V] =
  ...
  /** Distribute a local Scala collection to form an RDD. */
  def parallelizeDoubles(
      list: java.util.List[java.lang.Double]): JavaDoubleRDD =
  ...
  def binaryFiles(
      path: String,
      minPartitions: Int): JavaPairRDD[String, PortableDataStream] =
  ...
  def intAccumulator(initialValue: Int): Accumulator[java.lang.Integer] =
    sc
      .accumulator(initialValue)(IntAccumulatorParam)
  ...
  def intAccumulator(
    ...
    sc
      .accumulator(initialValue, name)(IntAccumulatorParam)
      .asInstanceOf[Accumulator[java.lang.Integer]]
  ...
  def doubleAccumulator(initialValue: Double): Accumulator[java.lang.Double] =
    sc
      .accumulator(initialValue)(DoubleAccumulatorParam)
  ...
  def doubleAccumulator(
    ...
    sc
      .accumulator(initialValue, name)(DoubleAccumulatorParam)
      .asInstanceOf[Accumulator[java.lang.Double]]
  ...
  /**
    ...
    * to using the `add` method. Only the master can access the accumulator's `value`.
    */
  def accumulator(initialValue: Int): Accumulator[java.lang.Integer] =
  ...
  def getSparkHome(): Optional[String] =
    JavaUtils.optionToOptional(sc.getSparkHome())
...
object JavaSparkContext {
  ...
  /**
    ...
    */
  def jarOfClass(cls: Class[_]): Array[String] =
    SparkContext.jarOfClass(cls).toArray
  ...
  /**
    ...
    * your driver program.
    */
  def jarOfObject(obj: AnyRef): Array[String] =
    SparkContext.jarOfObject(obj).toArray
