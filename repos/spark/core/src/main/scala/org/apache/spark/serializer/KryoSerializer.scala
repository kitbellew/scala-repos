...
class KryoSerializer(conf: SparkConf)
  ...
  if (bufferSizeKb >= ByteUnit.GiB.toKiB(2)) {
    throw new IllegalArgumentException(
      "spark.kryoserializer.buffer must be less than " +
  ...
  def newKryo(): Kryo = {
    ...
    kryo.register(classOf[Array[Tuple13[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple14[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple15[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple16[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple17[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple18[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple19[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple20[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple21[
      Any,
      Any,
      Any,
      Any,
      ...
      Any,
      Any]]])
    kryo.register(classOf[Array[Tuple22[
      Any,
      Any,
      Any,
      Any,
...
private[spark] class KryoSerializationStream(
  ...
  override def flush() {
    if (output == null) { throw new IOException("Stream is closed") }
    output.flush()
  }
...
private[spark] class KryoDeserializationStream(
  ...
  override def readObject[T: ClassTag](): T = {
    try { kryo.readClassAndObject(input).asInstanceOf[T] }
    catch {
...
private[spark] class KryoSerializerInstance(ks: KryoSerializer)
  ...
  private[serializer] def releaseKryo(kryo: Kryo): Unit = {
    if (cachedKryo == null) { cachedKryo = kryo }
  }
  ...
  override def serialize[T: ClassTag](t: T): ByteBuffer = {
    output.clear()
    val kryo = borrowKryo()
    try { kryo.writeClassAndObject(output, t) }
    catch {
      case e: KryoException if e.getMessage.startsWith("Buffer overflow") =>
        throw new SparkException(
          s"Kryo serialization failed: ${e.getMessage}. To avoid this, " +
  ...
  def getAutoReset(): Boolean = {
    ...
    val kryo = borrowKryo()
    try { field.get(kryo).asInstanceOf[Boolean] }
    finally { releaseKryo(kryo) }
  }
}
