  ...
  "Basic types helpers" should {
    ...
    "have a toBoolean method converting any object to a reasonable Boolean value" in {
      ...
      "object value" || "boolean value" |
        (0: Any) !! false | 1 !! true | true !! true | false !! false |
        "" !! false | "string" !! false | "t" !! true | "total" !! false |
        "T" !! true | "This" !! false | "0" !! false | "on" !! true |
        None !! false | Some("t") !! true | Empty !! false | Full("t") !! true |
        failure !! false | List("t", "f") !! true |> {
    ...
    "have a AsBoolean extractor converting any object to a reasonable Boolean value" in {
      "object value" || "boolean value" |> "t" !! Some(true) | "" !! None |
        "string" !! None | "total" !! None | "T" !! Some(true) |
    ...
    "have a toInt method converting any object to a reasonable Int value" in {
      ...
      toInt(null) must_== 0
      "object value" || "int value" |> 1 !! 1 | 1L !! 1 | List(1, 2) !! 1 |
        Some(1) !! 1 | Full(1) !! 1 | None !! 0 | Empty !! 0 | failure !! 0 |
        "3" !! 3 | "n" !! 0 | date(3000) !! 3 | { (o: Any, result: Int) =>
    ...
    "have a toLong method converting any object to a reasonable Long value" in {
      ...
      "object value" || "long value" |> 1 !! 1L | 1L !! 1L | List(1, 2) !! 1L |
        Some(1) !! 1L | Full(1) !! 1L | None !! 0L | Empty !! 0L |
        failure !! 0L | "3" !! 3L | "n" !! 0L | date(3000) !! 3000L | {
          (o: Any, result: Long) =>
