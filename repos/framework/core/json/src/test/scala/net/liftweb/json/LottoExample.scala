...
object LottoExample extends Specification {
  ...
  "Parse Lotto" in {
    ...
    (compactRender(
      json) mustEqual """{"lotto":{"id":5,"winning-numbers":[2,45,34,23,7,5,3],"winners":[{"winner-id":23,"numbers":[2,45,34,23,3,5]},{"winner-id":54,"numbers":[52,3,12,11,18,22]}]}}""") and
      ((json \ "lotto" \ "winners")(0).extract[Winner] mustEqual Winner(
        23,
        List(2, 45, 34, 23, 3, 5))) and
