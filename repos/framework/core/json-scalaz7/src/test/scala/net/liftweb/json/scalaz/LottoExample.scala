...
object LottoExample extends Specification {
  ...
  val json =
    parse("""{"id":5,"winning-numbers":[2,45,34,23,7,5],"winners":[{"winner-id":23,"numbers":[2,45,34,23,3,5]},{"winner-id":54,"numbers":[52,3,12,11,18,22]}]}""")
  ...
  implicit def lottoJSON: JSONR[Lotto] = {
    val winningNumbersResult = (jValue: JValue) =>
      (for {
        winningNumbers <-
          field[List[Int]]("winning-numbers")(jValue).disjunction
