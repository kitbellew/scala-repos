...
object Dependencies {
  ...
  lazy val commons_fileupload = "commons-fileupload" % "commons-fileupload" %
    "1.3.1"
  lazy val commons_httpclient = "commons-httpclient" % "commons-httpclient" %
    "3.1"
  ...
  lazy val scalaz7_core = "org.scalaz" % "scalaz-core" % "7.2.0" cross
    CVMappingAll
  ...
  lazy val slf4j_log4j12 = "org.slf4j" % "slf4j-log4j12" % slf4jVersion %
    "provided"
  lazy val persistence_api = "javax.persistence" % "persistence-api" % "1.0.2" %
    "provided"
  ...
  lazy val derby = "org.apache.derby" % "derby" % "10.7.1.1" %
    "test" //% "optional"
  lazy val h2database = "com.h2database" % "h2" % "1.2.147" %
    "test" //% "optional"
  ...
  lazy val apacheds = "org.apache.directory.server" % "apacheds-server-integ" %
    "1.5.5" % "test" // TODO: 1.5.7
  lazy val jetty6 = "org.mortbay.jetty" % "jetty" % "6.1.26" % "test"
  lazy val jwebunit = "net.sourceforge.jwebunit" % "jwebunit-htmlunit-plugin" %
    "2.5" % "test"
