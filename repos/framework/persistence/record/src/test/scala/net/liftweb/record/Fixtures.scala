...
class FilterTestRecord private () extends Record[FilterTestRecord] {
  ...
  object stringFieldWithFiltering extends StringField(this, 100) {
    ...
    override protected def setFilterBox =
      setFilterBoxHarness :: super.setFilterBox
  }
}
...
class FieldTypeTestRecord private () extends Record[FieldTypeTestRecord] {
  ...
  object legacyOptionalDateTimeField extends DateTimeField(this) {
    override def optional_? = true
  }
  ...
  def fieldsToCompare = {
    fields.filterNot(_.name == "mandatoryBinaryField") // binarys don't compare
      .filterNot(
...
object CustomFormatDateTimeRecord
    extends CustomFormatDateTimeRecord
    with MetaRecord[CustomFormatDateTimeRecord]

class CustomTypeIntFieldRecord private ()
    extends Record[CustomTypeIntFieldRecord] {
