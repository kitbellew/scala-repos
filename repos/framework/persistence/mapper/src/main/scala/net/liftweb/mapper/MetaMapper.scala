    ...
    synchronized {
      val clz =
        inst match {
          case null => null
          case _ =>
            inst.getClass.asInstanceOf[Class[(C forSome {
              type C
            })]]
        }
      val look =
...
/**
  ...
  * be generated
  */
final case class PreCache[
    TheType <: Mapper[TheType],
    FieldType,
    OtherType <: KeyedMapper[FieldType, OtherType]](
...
object NotIn {
  def fk[
      InnerMapper <: Mapper[InnerMapper],
      JoinTypeA,
