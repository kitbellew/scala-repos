...
package mongodocumentspecs {
  ...
  object BoxTestDoc extends MongoDocumentMeta[BoxTestDoc] {
    override def formats =
      super.formats + new JsonBoxSerializer + new ObjectIdSerializer
  }
  ...
  case class DateTimeTestDoc(_id: ObjectId, dt: DateTime)
      extends MongoDocument[DateTimeTestDoc] {
    def meta = DateTimeTestDoc
  }
  object DateTimeTestDoc extends MongoDocumentMeta[DateTimeTestDoc] {
    override def formats =
      super.formats + new ObjectIdSerializer + new DateTimeSerializer
  }

  case class LocalDateTestDoc(_id: ObjectId, ld: LocalDate)
      extends MongoDocument[LocalDateTestDoc] {
    def meta = LocalDateTestDoc
  }
  object LocalDateTestDoc extends MongoDocumentMeta[LocalDateTestDoc] {
    override def formats =
      super.formats + new ObjectIdSerializer + LocalDateSerializer()
  }
}
