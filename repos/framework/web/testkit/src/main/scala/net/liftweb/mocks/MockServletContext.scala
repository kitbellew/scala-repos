...
class MockServletContext(var target: String) extends ServletContext {
  ...
  def addFilter(
      x$1: String,
      x$2: javax.servlet.Filter): FilterRegistration.Dynamic = null
  ...
  def addServlet(
      servletName: String,
      servlet: javax.servlet.Servlet): ServletRegistration.Dynamic = null
  def addServlet(
      servletName: String,
      servletClass: String): ServletRegistration.Dynamic = null
