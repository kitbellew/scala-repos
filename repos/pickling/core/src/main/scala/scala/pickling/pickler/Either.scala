...
trait EitherPicklers {
  ...
  implicit def pickleLeft[L, R](implicit
      lp: Pickler[L],
  ...
  implicit def pickleRight[L, R](implicit
      rp: Pickler[R],
  ...
  implicit def pickleEither[L, R](implicit
      rp: Pickler[Right[L, R]],
      lp: Pickler[Left[L, R]],
  ...
  implicit def unpickleLeft[L, R](implicit
      lp: Unpickler[L],
  ...
  implicit def unpickleRight[L, R](implicit
      rp: Unpickler[R],
  ...
  implicit def unpickleEither[L, R](implicit
      rp: Unpickler[Right[L, R]],
