...
abstract class BinaryInput {
  ...
  def getCharArray(): Array[Char] =
    getArrayByChunk[Char](UnsafeMemory.charArrayOffset, 2)
  def getShortArray(): Array[Short] =
    getArrayByChunk[Short](UnsafeMemory.shortArrayOffset, 2)
  def getIntArray(): Array[Int] =
    getArrayByChunk[Int](UnsafeMemory.intArrayOffset, 4)
  def getFloatArray(): Array[Float] =
    getArrayByChunk[Float](UnsafeMemory.floatArrayOffset, 4)
  def getLongArray(): Array[Long] =
    getArrayByChunk[Long](UnsafeMemory.longArrayOffset, 8)
  def getDoubleArray(): Array[Double] =
    getArrayByChunk[Double](UnsafeMemory.doubleArrayOffset, 8)
