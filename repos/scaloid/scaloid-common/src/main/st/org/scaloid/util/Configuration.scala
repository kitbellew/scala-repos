...
object Configuration {
  @inline
  def conf(implicit context: Context) = context.getResources.getConfiguration

  @inline
  def orientation(implicit context: Context): Int = conf.orientation

  @inline
  def portrait(implicit context: Context): Boolean =
    orientation == android.content.res.Configuration.ORIENTATION_PORTRAIT

  @inline
  def landscape(implicit context: Context): Boolean =
    orientation == android.content.res.Configuration.ORIENTATION_LANDSCAPE

  @deprecated("", "") @inline
  def square(implicit context: Context): Boolean =
    orientation == android.content.res.Configuration.ORIENTATION_SQUARE

  @inline
  def long(implicit context: Context): Boolean =
    (conf.screenLayout & android.content.res.Configuration
      .SCREENLAYOUT_LONG_YES) != 0

  @inline
  def locale(implicit context: Context): Locale = conf.locale

  @inline
  def displayMetrics(implicit context: Context) =
    context.getResources.getDisplayMetrics

  @inline
  def width(implicit context: Context): Int = displayMetrics.widthPixels

  @inline
  def height(implicit context: Context): Int = displayMetrics.heightPixels

  @inline
  def dpi(implicit context: Context): Int = displayMetrics.densityDpi
