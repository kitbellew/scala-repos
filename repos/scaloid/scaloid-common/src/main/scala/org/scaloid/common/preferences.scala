...
trait TraitPreference[This <: android.preference.Preference] {
  ...
  /**
    ...
    */
  @inline def onPreferenceChangeListener(
  ...
  /**
    ...
    */
  @inline def onPreferenceClickListener(
  ...
  @inline def onPreferenceClick(
      f: android.preference.Preference => Boolean): This = {
...
trait TraitDialogPreference[This <: android.preference.DialogPreference]
  ...
  /**
    ...
    */
  @inline def dialogIcon(p: android.graphics.drawable.Drawable) = dialogIcon_=(
    p)
