...
object Configuration {
  ...
  @inline def portrait(implicit context: Context): Boolean =
    orientation == android.content.res.Configuration.ORIENTATION_PORTRAIT

  @inline def landscape(implicit context: Context): Boolean =
    orientation == android.content.res.Configuration.ORIENTATION_LANDSCAPE

  @deprecated("", "") @inline def square(implicit context: Context): Boolean =
  ...
  @inline def displayMetrics(implicit context: Context) =
    context.getResources.getDisplayMetrics

  @inline def width(implicit context: Context): Int = displayMetrics.widthPixels

  @inline def height(implicit context: Context): Int =
