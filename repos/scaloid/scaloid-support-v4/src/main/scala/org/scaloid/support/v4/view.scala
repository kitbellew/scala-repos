...
/**
  ...
  */
class RichViewPager[This <: android.support.v4.view.ViewPager](val basis: This)
    extends TraitViewPager[This]
...
/**
  ...
  */
class RichPagerAdapter[This <: android.support.v4.view.PagerAdapter](
    val basis: This)
    extends TraitPagerAdapter[This]
