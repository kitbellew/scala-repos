...
trait TraitFragment[This <: android.support.v4.app.Fragment] {
  ...
  /**
    ...
    */
  @inline
  def arguments_=(p: android.os.Bundle) = {
  ...
  /**
    ...
    */
  @inline
  def userVisibleHint_=(p: Boolean) = {
...
trait TraitListFragment[This <: android.support.v4.app.ListFragment]
  ...
  /**
    ...
    */
  @inline
  def emptyText_=(p: java.lang.CharSequence) = {
