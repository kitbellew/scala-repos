...
trait TraitFragment[This <: android.support.v4.app.Fragment] {
  ...
  @inline def hasOptionsMenu(implicit no: NoGetterForThisProperty): Nothing =
  ...
  @inline def initialSavedState(implicit no: NoGetterForThisProperty): Nothing =
    throw new Error(
  ...
  /**
    ...
    */
  @inline def initialSavedState(p: android.support.v4.app.Fragment.SavedState) =
  ...
  @inline def menuVisibility(implicit no: NoGetterForThisProperty): Nothing =
...
trait TraitFragmentActivity[This <: android.support.v4.app.FragmentActivity]
  ...
  /**
    ...
    */
  @inline def lastCustomNonConfigurationInstance =
...
trait TraitFragmentTransaction[
  ...
  /**
    ...
    */
  @inline def breadCrumbShortTitle(p: java.lang.CharSequence) =
