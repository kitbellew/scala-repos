...
trait CartesianSyntax1 {
  implicit def cartesianSyntaxU[FA](fa: FA)(implicit
      U: Unapply[Cartesian, FA]): CartesianOps[U.M, U.A] =
...
trait CartesianSyntax extends CartesianSyntax1 {
  implicit def cartesianSyntax[F[_], A](fa: F[A])(implicit
      F: Cartesian[F]): CartesianOps[F, A] =
