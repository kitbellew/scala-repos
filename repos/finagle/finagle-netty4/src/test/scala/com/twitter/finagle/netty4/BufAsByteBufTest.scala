...
class BufAsByteBufTest extends FunSuite with BeforeAndAfter {
  ...
  test("byte array transfer") {
    ...
    0.until(Capacity - BlockSize + 1, BlockSize)
      .foreach { i =>
