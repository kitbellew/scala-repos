...
private[serverset2] object IntObj {
  def unapply(o: Object): Option[Int] =
    o match {
...
private[serverset2] object DoubleObj {
  def unapply(o: Object): Option[Double] =
    o match {
...
private[serverset2] object StringObj {
  def unapply(o: Object): Option[String] =
    o match {
...
private[serverset2] object DictObj {
  def unapply(o: Object): Option[Object => Option[Object]] =
    o match {
...
private[serverset2] object JsonDict {
  ...
  def apply(json: String): (Object => Option[Object]) = {
    val o =
      ...
      catch { case NonFatal(_) => return Function.const(None) }
