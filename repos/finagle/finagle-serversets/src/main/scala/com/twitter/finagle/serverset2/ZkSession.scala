...
private[serverset2] class ZkSession(
  ...
  private[this] val unexpectedExceptions =
    new CategorizingExceptionStatsHandler(_ => Some("unexpected_exceptions"))
  ...
  private[serverset2] def watchedOperation[T](
    ...
    Activity(
      Var.async[Activity.State[T]](Activity.Pending) { u =>
  ...
  /**
    ...
    */
  def collectImmutableDataOf(
      paths: Seq[String]): Future[Seq[(String, Option[Buf])]] = {
