...
//#index
  ...
  try {
    ...
    };
    {
      ...
      val q2 = q.map {
        case (supID, css) => (supID, css.length, css.map(_._1.price).avg)
      }
      // compiles to SQL:
    ...
    };
    {
      ...
      val insertActions = DBIO.seq(
        ...
        coffees ++=
          Seq(("French_Roast", 49, 8.99, 0, 0), ("Espresso", 150, 9.99, 0, 0)),
      ...
      val actions = DBIO.seq(
        ...
        users2 forceInsertQuery
          (users.map { u => (u.id, u.first ++ " " ++ u.last) }),
    ...
    };
    {
      ...
      assert(
        Await.result(
          ...
          Duration.Inf) ==
          Vector(Pair(3, Pair(42, "bb")), Pair(2, Pair(42, "cc"))))
      ...
      assert(
        Await.result(
          ...
          Duration.Inf) ==
          Vector(C(Pair(9, "z"), B(3, "bb")), C(Pair(8, "y"), B(2, "cc"))))
