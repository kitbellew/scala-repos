...
trait OptionExtensionMethods[B1]
    extends Any
    with ExtensionMethods[B1, Option[B1]] {
...
final class OptionColumnExtensionMethods[B1](val c: Rep[Option[B1]])
  ...
  def get: Rep[B1] =
    Rep.forNode[B1](
      ...
      c.asInstanceOf[Rep.TypedRep[_]].tpe.asInstanceOf[
        OptionType].elementType.asInstanceOf[TypedType[B1]])
}
...
final class BooleanColumnExtensionMethods[P1](val c: Rep[P1])
    extends AnyVal
    with ExtensionMethods[Boolean, P1] {
...
final class AnyOptionExtensionMethods[O <: Rep[_], P](val r: O) extends AnyVal {
  ...
  def filter[T](p: P => T)(implicit wt: CanBeQueryCondition[T]): O = {
    ...
    r.encodeRef(
      OptionFold(r.toNode, LiteralNode.nullOption, cond, gen)).asInstanceOf[O]
  }
  ...
  def getOrElse[M, P2 <: P](default: M)(implicit
    ...
    fold[P, P](shape.pack(default): P)(identity)(
      shape.packedShape.asInstanceOf[Shape[FlatShapeLevel, P, _, P]])

  /** Check if this Option is empty. */
  def isEmpty: Rep[Boolean] =
    fold(LiteralColumn(true))(_ => LiteralColumn(false))

  /** Check if this Option is non-empty. */
  def isDefined: Rep[Boolean] =
    fold(LiteralColumn(false))(_ => LiteralColumn(true))
...
trait ExtensionMethodConversions {
  ...
  implicit def stringOptionColumnExtensionMethods(
      c: Rep[Option[String]]): StringColumnExtensionMethods[Option[String]] =
    new StringColumnExtensionMethods[Option[String]](c)
  implicit def booleanColumnExtensionMethods(
      c: Rep[Boolean]): BooleanColumnExtensionMethods[Boolean] =
    new BooleanColumnExtensionMethods[Boolean](c)
  implicit def booleanOptionColumnExtensionMethods(
      c: Rep[Option[Boolean]]): BooleanColumnExtensionMethods[Option[Boolean]] =
    new BooleanColumnExtensionMethods[Option[Boolean]](c)
