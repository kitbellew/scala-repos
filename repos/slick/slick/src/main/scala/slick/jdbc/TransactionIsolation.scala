...
object TransactionIsolation {
  ...
  case object ReadUncommitted
      extends TransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED)
  ...
  case object ReadCommitted
      extends TransactionIsolation(Connection.TRANSACTION_READ_COMMITTED)
  ...
  case object RepeatableRead
      extends TransactionIsolation(Connection.TRANSACTION_REPEATABLE_READ)
