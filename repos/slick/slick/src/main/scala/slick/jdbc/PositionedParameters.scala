...
class PositionedParameters(val ps: PreparedStatement) {
  ...
  def setBooleanOption(value: Option[Boolean]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.BOOLEAN)
    else
      ps.setBoolean(npos, value.get)
    pos = npos
  }
  ...
  def setBlobOption(value: Option[Blob]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.BLOB)
    else
      ps.setBlob(npos, value.get)
    pos = npos
  }
  ...
  def setByteOption(value: Option[Byte]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.TINYINT)
    else
      ps.setByte(npos, value.get)
    pos = npos
  }
  ...
  def setClobOption(value: Option[Clob]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.CLOB)
    else
      ps.setClob(npos, value.get)
    pos = npos
  }
  ...
  def setDateOption(value: Option[Date]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.DATE)
    else
      ps.setDate(npos, value.get)
    pos = npos
  }
  ...
  def setDoubleOption(value: Option[Double]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.DOUBLE)
    else
      ps.setDouble(npos, value.get)
    pos = npos
  }
  ...
  def setFloatOption(value: Option[Float]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.FLOAT)
    else
      ps.setFloat(npos, value.get)
    pos = npos
  }
  ...
  def setIntOption(value: Option[Int]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.INTEGER)
    else
      ps.setInt(npos, value.get)
    pos = npos
  }
  ...
  def setShortOption(value: Option[Short]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.SMALLINT)
    else
      ps.setShort(npos, value.get)
    pos = npos
  }
  ...
  def setStringOption(value: Option[String]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.VARCHAR)
    else
      ps.setString(npos, value.get)
    pos = npos
  }
  ...
  def setTimeOption(value: Option[Time]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.TIME)
    else
      ps.setTime(npos, value.get)
    pos = npos
  }
  ...
  def setTimestampOption(value: Option[Timestamp]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.TIMESTAMP)
    else
      ps.setTimestamp(npos, value.get)
    pos = npos
  }
  ...
  def setBigDecimalOption(value: Option[BigDecimal]) {
    val npos = pos + 1
    if (value eq None)
      ps.setNull(npos, Types.DECIMAL)
    else
      ps.setBigDecimal(npos, value.get.bigDecimal)
    pos = npos
  }
  ...
  def setObjectOption(value: Option[AnyRef], sqlType: Int) {
    ...
    if (value eq None)
      ...
      ps.setObject(npos, value.get, sqlType)
    pos = npos
  }
}
