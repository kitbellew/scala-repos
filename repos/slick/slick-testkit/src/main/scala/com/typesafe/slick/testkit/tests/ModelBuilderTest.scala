...
class ModelBuilderTest extends AsyncTest[JdbcTestDB] {
  ...
  class Posts(tag: Tag)
    ...
    def someBool = column[Boolean](
      "some_bool",
      O.Default(true)
    ) // tests boolean default values parsing
    def someString = column[String](
      "some_string",
  ...
  class DefaultTest(tag: Tag)
      extends Table[
        (
            ...
            Option[String],
            Option[String],
            Option[String])](tag, "default_test") {
    def someBool = column[Boolean]("some_bool")
    def someBoolDefaultTrue =
      column[Boolean]("some_bool_default_true", O.Default(true))
    def someBoolDefaultFalse =
      column[Boolean]("some_bool_default_false", O.Default(false))
    def someBoolOption = column[Option[Boolean]]("some_bool_option")
    def someBoolOptionDefaultSome = column[Option[Boolean]](
    ...
    def someStringDefaultNonEmpty = column[String](
  ...
  class NoDefaultTest(tag: Tag)
    ...
    def stringOptionDefaultNone =
      column[Option[String]]("stringOptionDefaultNone", O.Default(None))
  ...
  class TypeTest(tag: Tag)
    ...
    def String =
      column[String]("String", O.Default("someDefaultString"), O.Length(254))
    ...
    def Option_Boolean =
      column[Option[Boolean]]("Option_Boolean", O.Default(Some(true)))
    ...
    def Option_java_sql_Time =
      column[Option[java.sql.Time]]("Option_java_sql_Time")
    def Option_java_sql_Timestamp =
      column[Option[java.sql.Timestamp]]("Option_java_sql_Timestamp")
    def Option_java_sql_Blob =
      column[Option[java.sql.Blob]]("Option_java_sql_Blob")
  ...
  def test = ifCap(jcap.createModel) {
    ...
    for {
      ...
      _ <- createModel(
        ...
        ignoreInvalidDefaults = false).map(_.assertConsistency)
