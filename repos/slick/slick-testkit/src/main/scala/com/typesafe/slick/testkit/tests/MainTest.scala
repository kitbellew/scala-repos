...
class MainTest extends AsyncTest[JdbcTestDB] { mainTest =>
  ...
  class Users(tag: Tag)
      extends Table[(Int, String, Option[String])](tag, "users") {
  ...
  def test = {
    ...
    materialize(
      p1.mapResult { case (id, f, l) => User(id, f, l.orNull) }).flatMap {
      allUsers =>
      ...
      val b1 = orders.filter(o => o.shipped && o.shipped).map(o =>
        o.shipped && o.shipped)
      val b2 = orders.filter(o => o.shipped && o.rebate).map(o =>
        o.shipped && o.rebate)
      val b3 = orders.filter(o => o.rebate && o.shipped).map(o =>
        o.rebate && o.shipped)
      val b4 =
        orders.filter(o => o.rebate && o.rebate).map(o => o.rebate && o.rebate)
