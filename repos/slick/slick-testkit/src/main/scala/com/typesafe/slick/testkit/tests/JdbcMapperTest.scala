...
class JdbcMapperTest extends AsyncTest[JdbcTestDB] {
  ...
  def testMappedEntity = {
    ...
    seq(
      ...
      users ++=
        Seq(User(None, "Marge", "Bouvier"), User(None, "Carl", "Carlson")),
      users.map(_.asFoo) += Foo(User(None, "Lenny", "Leonard")),
      users.filter(_.last inSet Set("Bouvier", "Ferdinand")).size.result
        .map(_ shouldBe 1),
  ...
  def testWideMappedEntity = {
    ...
    class T(tag: Tag) extends Table[Whole](tag, "t_wide") {
      ...
      def m1 =
        (
          ...
          (p4i1, p4i2, p4i3, p4i4, p4i5, p4i6).mapTo[Part]).mapTo[Whole]
      ...
      def m2 =
        (
          ...
          (p4i1, p4i2, p4i3, p4i4, p4i5, p4i6)).shaped <>
          (
            {
              case (id, p1, p2, p3, p4) =>
      ...
      def m3 =
        (id :: p1i1 :: p1i2 :: p1i3 :: p1i4 :: p1i5 :: p1i6 :: p2i1 :: p2i2 ::
          p2i3 :: p2i4 :: p2i5 :: p2i6 :: p3i1 :: p3i2 :: p3i3 :: p3i4 ::
          p3i5 :: p3i6 :: p4i1 :: p4i2 :: p4i3 :: p4i4 :: p4i5 :: p4i6 :: HNil)
          .mapTo[BigCase]
      def * = m1
    }
    val ts = TableQuery[T]
    ...
    seq(
      ...
      ts.map(_.m3).result.head.map(
        _ shouldBe BigCase(
          0, 11, 12, 13, 14, 15, 16, 21, 22, 23, 24, 25, 26, 31, 32, 33, 34, 35,
  ...
  def testNestedMappedEntity = {
    ...
    val data = Seq(Whole(Part1(1, "2"), Part2("3", 4)))
  ...
  def testProductClassShape = {
    ...
    implicit object cShape
        extends ProductClassShape(
          ...
          seq =>
            new LiftedC(
              seq(0).asInstanceOf[Rep[Int]],
              seq(1).asInstanceOf[Rep[Option[String]]]),
          seq =>
            new C(
              seq(0).asInstanceOf[Int],
  ...
  def testHList = {
    ...
    seq(
      ...
      bs.map(_.mapped).result.map(
        _.toSet shouldBe
          Set(Data(1, true, "a"), Data(2, false, "c"), Data(3, false, "b")))
    )
  }
