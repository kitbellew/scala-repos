...
class DelegateConnection(conn: Connection) extends Connection {
  ...
  def createStatement(
      ...
      resultSetHoldability: Int): Statement = conn.createStatement(
    resultSetType,
  ...
  def prepareCall(
      ...
      resultSetType: Int,
      resultSetConcurrency: Int,
      resultSetHoldability: Int): CallableStatement = conn.prepareCall(
    sql,
    resultSetType,
    resultSetConcurrency,
    resultSetHoldability)
  ...
  def prepareStatement(
      ...
      resultSetType: Int,
      resultSetConcurrency: Int,
      resultSetHoldability: Int): PreparedStatement = conn.prepareStatement(
    sql,
    resultSetType,
    resultSetConcurrency,
    resultSetHoldability)
