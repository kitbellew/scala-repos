...
object GeneratedCodeTest {
  def testCG1 = {
    ...
    DBIO.seq(
      ...
      MTable.getTables(Some(""), Some(""), None, None)
        .map {
          tables =>
            ...
            assertTrue(
              ...
              tableName(aFk.sourceTable) == A.baseTableRow
                .tableName && tableName(aFk.targetTable) == B.baseTableRow
                .tableName)
            ...
            assertTrue(
              ...
              tableName(cFk.sourceTable) == C.baseTableRow
                .tableName && tableName(cFk.targetTable) == D.baseTableRow
                .tableName)
            ...
            def optionsOfColumn(c: slick.lifted.Rep[_]) =
              c.toNode.asInstanceOf[Select].field
                .asInstanceOf[slick.ast.FieldSymbol].options.toList
            ...
            assertTrue(
              ...
              k1Options
                .exists(option => (option equals E.baseTableRow.O.AutoInc)))
            assertTrue(
              "k2 should not be AutoInc",
              k2Options
                .forall(option => !(option equals E.baseTableRow.O.AutoInc)))
            assertTrue(
  ...
  def testCG8 = {
    ...
    DBIO.seq(
      ...
      SimpleAs.result
        .map(assertEquals(List(SimpleA(CustomTyping.True, "1")), _))
    )
  }
  ...
  def convertColumnsToString(columns: Seq[Node]) =
    columns.map(_.asInstanceOf[Select].field.name)
}
