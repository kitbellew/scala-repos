...
/**
  ...
  */
final case class MessageInvocation(
...
trait MessageDispatcher {
  ...
  /**
    ...
    */
  private[akka] def timeoutMs: Long =
    Dispatchers.DEFAULT_SHUTDOWN_TIMEOUT.toMillis
