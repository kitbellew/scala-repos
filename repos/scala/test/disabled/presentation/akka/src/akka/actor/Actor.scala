...
object Actor extends ListenerManagement {
  ...
  /** Creates an ActorRef out of the Actor. Allows you to pass in a factory function
    ...
    *  </pre>
    */
  def actorOf(factory: => Actor): ActorRef =
    new LocalActorRef(() => factory, None)
  ...
  /** Creates an ActorRef out of the Actor. Allows you to pass in a factory (Creator<Actor>)
    ...
    *  JAVA API
    */
  def actorOf(creator: Creator[Actor]): ActorRef =
    new LocalActorRef(() => creator.create, None)
  ...
  /** Implicitly converts the given Option[Any] to a AnyOptionAsTypedOption which offers the method <code>as[T]</code>
    ...
    */
  implicit def toAnyOptionAsTypedOption(anyOption: Option[Any]) =
    new AnyOptionAsTypedOption(anyOption)
