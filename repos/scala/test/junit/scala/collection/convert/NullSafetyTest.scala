...
object NullSafetyTest {
  ...
  class ToScala {
    ...
    @Test
    def testEnumerationWrapping(): Unit = {
    ...
    @Test
    def testCollectionWrapping(): Unit = {
    ...
    @Test
    def testConcurrentMapWrapping(): Unit = {
    ...
    @Test
    def testDictionaryWrapping(): Unit = {
    ...
    @Test
    def testIteratorDecoration(): Unit = {
      val nullJIterator: ju.Iterator[AnyRef] = null
    ...
    @Test
    def testEnumerationDecoration(): Unit = {
      val nullJEnumeration: ju.Enumeration[AnyRef] = null
    ...
    @Test
    def testIterableDecoration(): Unit = {
      val nullJIterable: jl.Iterable[AnyRef] = null
    ...
    @Test
    def testCollectionDecoration(): Unit = {
      val nullJCollection: ju.Collection[AnyRef] = null
    ...
    @Test
    def testConcurrentMapDecoration(): Unit = {
      val nullJConMap: juc.ConcurrentMap[AnyRef, AnyRef] = null
    ...
    @Test
    def testDictionaryDecoration(): Unit = {
      val nullJDict: ju.Dictionary[AnyRef, AnyRef] = null
    ...
    @Test
    def testPropertiesDecoration(): Unit = {
