...
class IteratorTest {
  ...
  @Test
  def groupedIteratorIsLazyWhenPadded(): Unit = {
    var counter = 0
    def it =
      new Iterator[Int] {
        var i = 0; def hasNext = { counter = i; true }; def next = { i += 1; i }
  ...
  @Test
  def concatIsStackFriendly(): Unit = {
  ...
  @Test
  def take(): Unit = { assertEquals(10, (Iterator from 0 take 10).size) }
  @Test
  def foreach(): Unit = {
  ...
  // SI-8552
  @Test
  def indexOfShouldWorkForTwoParams(): Unit = {
  ...
  // SI-9332
  @Test
  def spanExhaustsLeadingIterator(): Unit = {
  ...
  // SI-9623
  @Test
  def noExcessiveHasNextInJoinIterator: Unit = {
    var counter = 0
