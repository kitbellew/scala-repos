...
object Test1_scala {
  ...
  try {
    ...
    println(
      "x9 equals x10: " +
        (x9 equals x10) + ", x10 equals x9: " +
        (x10 equals x9))
    println("x9 eq y10: " + (x9 eq y10) + ", y10 eq x9: " + (y10 eq x9))
    println(
      "x9 equals y10: " +
        (x9 equals y10) + ", y10 equals x9: " +
        (y10 equals x9))
    println()
    ...
    println(
      "xs0 equals _xs0: " +
        (xs0 equals _xs0) + ", _xs0 equals xs0: " +
        (_xs0 equals xs0))
    println()
...
object Test2_immutable {
  ...
  try {
    ...
    // ListMap
    val lm1 = new ListMap[String, Int] +
      ("buffers" -> 20, "layers" -> 2, "title" -> 3)
...
object Test10_util {
...

  {
    ...
    rep(5) {
      assert(random.nextInt == random2.nextInt)
    }
  }
}
