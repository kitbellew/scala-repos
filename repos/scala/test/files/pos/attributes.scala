...
@serializable
class C1;
@serializable @volatile
class C2;
@serializable @volatile
class C3;
@serializable @volatile @serializable
class C4;
...
@serializable @volatile
object O2 extends C2;
@serializable @volatile
object O3 extends C3;
@serializable @volatile @serializable
object O4 extends C4;
...
object O5 {
  ...
  @SerialVersionUID(n)
  class C2;
  @SerialVersionUID(0) @SerialVersionUID(n)
  class C3;
  @SerialVersionUID(0) @SerialVersionUID(n)
  class C4;
}
...
object O6 {
  ...
  private def foo2 = x2;
  @serializable @volatile
  protected def foo3 = x3;
  @serializable @volatile @serializable
  protected def foo4 = x4;
}
