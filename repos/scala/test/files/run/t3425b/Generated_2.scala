...
object Test {
  ...
  def f24 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (Any { val y: P })); x.y.reflected -> whatis(x).toString
  }
  def f25 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (Any { val y: Q })); x.y.reflected -> whatis(x).toString
  }
  def f26 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
  ...
  def f27 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (A { val y: P })); x.y.reflected -> whatis(x).toString
  }
  def f28 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (A { val y: Q })); x.y.reflected -> whatis(x).toString
  }
  def f29 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
  ...
  def f30 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (B { val y: P })); x.y.reflected -> whatis(x).toString
  }
  def f31 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (B { val y: Q })); x.y.reflected -> whatis(x).toString
  }
  def f32 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
  ...
  def f33 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (C { val y: P })); x.y.reflected -> whatis(x).toString
  }
  def f34 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
    }) with (C { val y: Q })); x.y.reflected -> whatis(x).toString
  }
  def f35 = {
    val x = ((new ABC): (Any {
      val y: R forSome { type R <: P with Q }
