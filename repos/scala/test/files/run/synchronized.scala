...
class C1 {
  ...
  val fv: () => Boolean = () =>
    synchronized {
      checkLocks(this)(this.getClass, fv, fv.getClass)
    }
  def ff = {
    lazy val ffv: AnyRef => Boolean =
      lock =>
        synchronized {
          checkLocks(lock)(ffv, ffv.getClass, lock.getClass)
        }
    ffv(this)
  }
  def fl = {
  ...
  @inline
  final def gi = checkLocks()(this, this.getClass)
  val gv: () => Boolean = () =>
    checkLocks()(this, this.getClass, gv, gv.getClass)
  def gf = {
    lazy val gfv: AnyRef => Boolean =
      lock => checkLocks()(C1.this, gfv, gfv.getClass, lock, lock.getClass)
    gfv(this)
  }
  def gl = {
...
object O1 {
  ...
  def gf = {
    lazy val gfv: AnyRef => Boolean =
      lock => checkLocks()(gfv, gfv.getClass, lock, lock.getClass)
    gfv(this)
  }
  def gl = {
    lazy val glv = checkLocks()(this, this.getClass)
  ...
  class C {
    ...
    @inline
    final def gi = checkLocks()(this, this.getClass, O1, O1.getClass)
    val gv: () => Boolean = () =>
