...
object Test extends App {
  ...
  println(sortedmap.filterKeys(_ % 2 == 0).map(t =>
    (t._1, t._2.toString.length)): SortedMap[Int, Int])
  println(sortedmap.mapValues(_ + "!").map(t =>
    (t._1, t._2.toString.length)): SortedMap[Int, Int])
  println(
  ...
  println(immsortedmap.filterKeys(_ % 2 == 0).map(t =>
    (t._1, t._2.toString.length)): immutable.SortedMap[Int, Int])
  println(immsortedmap.mapValues(_ + "!").map(t =>
    (t._1, t._2.toString.length)): immutable.SortedMap[Int, Int])
  println(immsortedmap.filterKeys(_ % 2 == 0).filter(t =>
    t._1 < 2): immutable.SortedMap[Int, Boolean])
  println(immsortedmap.mapValues(_ + "!").filter(t =>
    t._1 < 2): immutable.SortedMap[Int, String])
