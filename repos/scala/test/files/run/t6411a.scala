...
object Test extends App {
  def test(methName: String, arg: Any) = {
    ...
    println(s"as seen by Scala reflection: ${msym.asInstanceOf[
      scala.reflect.internal.Symbols#Symbol].defString}")
    println(s"as seen by Java reflection: ${mmirror.asInstanceOf[{
