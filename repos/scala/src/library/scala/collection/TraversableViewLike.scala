...
trait TraversableViewLike[+A, +Coll, +This <: TraversableView[
  ...
  trait Transformed[+B] extends TraversableView[B, Coll] {
    ...
    final override protected[this] def viewIdString =
      self.viewIdString + viewIdentifier
