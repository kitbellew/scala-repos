...
abstract class WrappedArray[T]
  ...
  override protected[this] def toCollection(
      repr: WrappedArray[T]): WrappedArray[T] = repr
  ...
  def elemManifest: ClassManifest[T] =
    ClassManifest.fromClass[T](arrayElementClass(elemTag).asInstanceOf[Class[T]])
...
object WrappedArray {
  ...
  def empty[T <: AnyRef]: WrappedArray[T] =
    EmptyWrappedArray.asInstanceOf[WrappedArray[T]]
