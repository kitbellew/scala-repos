...
//                    with GenMap[A, B]
  ...
  def withDefault[B1 >: B](d: A => B1): immutable.Map[A, B1] =
    new Map.WithDefault[A, B1](this, d)
  ...
  /** The same map with a given default value.
    ...
    *  @return      a wrapper of the map with a default value
    */
  def withDefaultValue[B1 >: B](d: B1): immutable.Map[A, B1] =
    new Map.WithDefault[A, B1](this, x => d)
...
object Map extends ImmutableMapFactory[Map] {
  ...
  class WithDefault[A, +B](underlying: Map[A, B], d: A => B)
    ...
    override def withDefault[B1 >: B](d: A => B1): immutable.Map[A, B1] =
  ...
  private object EmptyMap
    ...
    override def updated[B1](key: Any, value: B1): Map[Any, B1] =
      new Map1(key, value)
  ...
  class Map4[A, +B](
    ...
    override def updated[B1 >: B](key: A, value: B1): Map[A, B1] =
      if (key == key1)
        ...
        new HashMap + ((key1, value1), (key2, value2), (key3, value3), (
          key4,
          value4), (key, value))
    def +[B1 >: B](kv: (A, B1)): Map[A, B1] = updated(kv._1, kv._2)
    def -(key: A): Map[A, B] =
