...
object BitSet extends BitSetFactory[BitSet] {
  ...
  class BitSet1(val elems: Long) extends BitSet {
    ...
    protected def updateWord(idx: Int, w: Long): BitSet =
      if (idx == 0)
        ...
        fromBitMaskNoCopy(updateArray(Array(elems), idx, w))
    override def head: Int =
      if (elems == 0L)
        throw new NoSuchElementException("Empty BitSet")
      else
        java.lang.Long.numberOfTrailingZeros(elems)
    override def tail: BitSet =
      if (elems == 0L)
        throw new NoSuchElementException("Empty BitSet")
      else
        new BitSet1(elems - java.lang.Long.lowestOneBit(elems))
  }
  ...
  class BitSet2(val elems0: Long, elems1: Long) extends BitSet {
    ...
    protected def updateWord(idx: Int, w: Long): BitSet =
      if (idx == 0)
        new BitSet2(w, elems1)
      else if (idx == 1)
        new BitSet2(elems0, w)
      else
        fromBitMaskNoCopy(updateArray(Array(elems0, elems1), idx, w))
    override def head: Int =
      if (elems0 == 0L) {
        if (elems1 == 0)
          throw new NoSuchElementException("Empty BitSet")
        ...
        java.lang.Long.numberOfTrailingZeros(elems0)
    override def tail: BitSet =
      if (elems0 == 0L) {
        if (elems1 == 0L)
          throw new NoSuchElementException("Empty BitSet")
        ...
        new BitSet2(elems0 - java.lang.Long.lowestOneBit(elems0), elems1)
  }
