...
class ParArray[T] private[mutable] (val arrayseq: ArraySeq[T])
  ...
  class ParArrayIterator(
    ...
    override def aggregate[S](
        z: => S)(seqop: (S, T) => S, combop: (S, S) => S): S =
      foldLeft[S](z)(seqop)
    ...
    private def prefixLength_quick(
        pred: T => Boolean,
        a: Array[Any],
        ntil: Int,
        startpos: Int): Int = {
    ...
    private def lastIndexWhere_quick(
        pred: T => Boolean,
        a: Array[Any],
        from: Int,
        ntil: Int): Int = {
    ...
    private def map2combiner_quick[S, That](
        f: T => S,
        a: Array[Any],
        cb: Builder[S, That],
        ntil: Int,
    ...
    override def collect2combiner[S, That](
    ...
    private def collect2combiner_quick[S, That](
        pf: PartialFunction[T, S],
        a: Array[Any],
        cb: Builder[S, That],
        ntil: Int,
    ...
    override def flatmap2combiner[S, That](
    ...
    override def filter2combiner[U >: T, This](
        pred: T => Boolean,
        cb: Combiner[U, This]) = {
    ...
    private def filter2combiner_quick[U >: T, This](
        pred: T => Boolean,
        cb: Builder[U, This],
        a: Array[Any],
        ntil: Int,
    ...
    override def filterNot2combiner[U >: T, This](
        pred: T => Boolean,
        cb: Combiner[U, This]) = {
    ...
    private def filterNot2combiner_quick[U >: T, This](
        pred: T => Boolean,
        cb: Builder[U, This],
        a: Array[Any],
        ntil: Int,
    ...
    private def copy2builder_quick[U >: T, Coll](
        b: Builder[U, Coll],
        a: Array[Any],
        ntil: Int,
        from: Int) {
    ...
    override def partition2combiners[U >: T, This](
        pred: T => Boolean,
    ...
    private def partition2combiners_quick[U >: T, This](
        p: T => Boolean,
        btrue: Builder[U, This],
        bfalse: Builder[U, This],
        a: Array[Any],
        ntil: Int,
        from: Int) {
      var j = from
    ...
    private def reverse2combiner_quick(
        targ: Array[Any],
        a: Array[Any],
        targfrom: Int,
        srcfrom: Int,
    ...
    override def scanToArray[U >: T, A >: U](
        z: U,
        op: (U, U) => U,
        destarr: Array[A],
        from: Int) {
    ...
    protected def scanToArray_quick[U](
        srcarr: Array[Any],
        destarr: Array[Any],
        op: (U, U) => U,
        z: U,
  ...
  override def map[S, That](f: T => S)(implicit
      bf: CanBuildFrom[ParArray[T], S, That]) = if (buildsArray(bf(repr))) {
    // reserve an array
