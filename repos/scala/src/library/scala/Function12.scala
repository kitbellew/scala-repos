...
trait Function12[
    ...
    (x1: T1) =>
      (
          (
              ...
              x12: T12) =>
            self
              .apply(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12)).curried
  }
  ...
  @annotation.unspecialized
  def tupled
      : Tuple12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12] => R = {
    case Tuple12(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12) =>
