...
object Console extends DeprecatedConsole with AnsiColor {
  ...
  private val inVar = new DynamicVariable[BufferedReader](new BufferedReader(
...
private[scala] abstract class DeprecatedConsole {
  ...
  @deprecated("Use the method in scala.io.StdIn", "2.11.0") def readInt(): Int =
    StdIn.readInt()
  ...
  @deprecated("Use the method in scala.io.StdIn", "2.11.0") def readf(
      format: String): List[Any] = StdIn.readf(format)
  @deprecated("Use the method in scala.io.StdIn", "2.11.0") def readf1(
      format: String): Any = StdIn.readf1(format)
  @deprecated("Use the method in scala.io.StdIn", "2.11.0") def readf2(
      format: String): (Any, Any) = StdIn.readf2(format)
  @deprecated("Use the method in scala.io.StdIn", "2.11.0") def readf3(
      format: String): (Any, Any, Any) = StdIn.readf3(format)

  /** Sets the default output stream.
    *
    *  @param out the new output stream.
    */
  @deprecated("Use withOut", "2.11.0") def setOut(out: PrintStream): Unit =
    setOutDirect(out)
  ...
  /** Sets the default output stream.
    ...
    *  @param out the new output stream.
    */
  @deprecated("Use withOut", "2.11.0") def setOut(out: OutputStream): Unit =
    setOutDirect(new PrintStream(out))

  /** Sets the default error stream.
    *
    *  @param err the new error stream.
    */
  @deprecated("Use withErr", "2.11.0") def setErr(err: PrintStream): Unit =
    setErrDirect(err)
  ...
  /** Sets the default error stream.
    ...
    *  @param err the new error stream.
    */
  @deprecated("Use withErr", "2.11.0") def setErr(err: OutputStream): Unit =
    setErrDirect(new PrintStream(err))

  /** Sets the default input stream.
    *
    *  @param reader specifies the new input stream.
    */
  @deprecated("Use withIn", "2.11.0") def setIn(reader: Reader): Unit =
    setInDirect(new BufferedReader(reader))

  /** Sets the default input stream.
    *
    *  @param in the new input stream.
    */
  @deprecated("Use withIn", "2.11.0") def setIn(in: InputStream): Unit =
