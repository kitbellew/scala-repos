...
class Flags extends ModifierFlags {
  ...
  // 25:  DEFAULTPARAM/M       TRAIT/M
  // 35:     EXISTENTIAL       MIXEDIN
  val OverloadedFlagsMask =
    0L | BYNAMEPARAM | CONTRAVARIANT | DEFAULTPARAM | EXISTENTIAL
  ...
  final val ModuleToClassFlags =
    AccessFlags | TopLevelCreationFlags | CASE | SYNTHETIC

  /** These flags are not pickled */
  final val FlagsNotPickled =
    IS_ERROR | OVERLOADED | LIFTED | TRANS_FLAG | LOCKED | TRIEDCOOKING
  ...
  /** If we have a top-level class or module
    ...
    */
  final val TopLevelPickledFlags =
    PickledFlags & ~(MODULE | METHOD | PACKAGE | PARAM | EXISTENTIAL)
