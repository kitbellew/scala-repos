...
trait StandardLiftables { self: Universe =>
  ...
  trait StandardLiftableInstances {
    ...
    implicit def liftTuple15[
        ...
        liftT15: Liftable[T15]): Liftable[Tuple15[
      T1,
      T2,
      T3,
      T4,
  ...
  trait StandardUnliftableInstances {
    ...
    implicit def unliftTuple7[T1, T2, T3, T4, T5, T6, T7](implicit
        ...
        : Unliftable[Tuple7[T1, T2, T3, T4, T5, T6, T7]] =
      Unliftable {
        case SyntacticTuple(
              UnliftT1(v1) :: UnliftT2(v2) :: UnliftT3(v3) :: UnliftT4(
    ...
    implicit def unliftTuple15[
        ...
        UnliftT15: Unliftable[T15]): Unliftable[Tuple15[
      T1,
      T2,
      T3,
      T4,
