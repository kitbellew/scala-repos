...
//    rewriteFinalTraitMethodInvocations()
  ...
  def memberIsAccessible(
    ...
    def memberIsAccessibleImpl = {
      ...
      key match {
        ...
        case ACC_PROTECTED => // B2
          ...
          tryEither {
            val condB2 =
              from.isSubtypeOf(memberDeclClass).orThrow && {
    ...
    classIsAccessible(memberDeclClass, from) match {
      // B0
          ...
          if (mi.owner.charAt(0) == '[')
            ...
            def canInlineCall(
              ...
              opcode match {
                ...
                case _ =>
                  // INVOKEVIRTUAL, INVOKESTATIC, INVOKEINTERFACE and INVOKESPECIAL of constructors
                  memberIsAccessible(
                    methodFlags,
                    methodDeclClass,
                    methodRefClass,
