      ...
      if (analyzer.nonEmpty) {
        ...
        methodNode.instructions.iterator.asScala foreach {
          case call: MethodInsnNode
            ...
            val callee: Either[OptimizerWarning, Callee] =
              for {
                (method, declarationClass) <-
                  byteCodeRepository
                    .methodNode(call.owner, call.name, call.desc): Either[
                    OptimizerWarning,
            ...
            methodCallsites += call ->
              Callsite(
                ...
                callsitePosition = callsitePositions
                  .getOrElse(call, NoPosition),
          ...
          case LambdaMetaFactoryCall(
            ...
            methodClosureInstantiations += indy ->
            ...
            case Array(
              ...
              val isIndyLambda =
                ...
                &&
                  (isStatic ||
                    implMethod
                      .getOwner == indyParamTypes(0).getInternalName) // (2)
                  &&
                  samMethodType
                    .getArgumentTypes
