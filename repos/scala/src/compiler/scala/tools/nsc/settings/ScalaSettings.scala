...
trait ScalaSettings
  ...
  val YclasspathImpl = ChoiceSetting(
    ...
    List(ClassPathRepresentationType.Recursive, ClassPathRepresentationType.Flat),
  ...
  def YoptWarningNoInlineMissingScalaInlineInfoAttr =
    YoptWarnings.contains(YoptWarningsChoices.noInlineMissingScalaInlineInfoAttr)
