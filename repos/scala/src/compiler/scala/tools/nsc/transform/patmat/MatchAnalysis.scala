          ...
          tm match {
            case ttm @ TypeTestTreeMaker(prevBinder, testedBinder, pt, _) =>
              object condStrategy
                ...
                def typeTest(b: Symbol, pt: Type) = {
                  // a type test implies the tested path is non-null (null.isInstanceOf[T] is false for all T)
  ...
  trait MatchAnalyzer extends MatchApproximator {
    ...
    def unreachableCase(
      ...
      try {
        ...
        val eqAxioms =
          simplify(And(eqAxiomsOk, eqAxiomsFail)) // I'm pretty sure eqAxiomsOk == eqAxiomsFail, but not 100% sure.
            ...
            val res = prunedEqualTo match {
              ...
              case Nil if nonTrivialNonEqualTo.nonEmpty =>
                ...
                if (beBrief) Some(WildcardExample)
                  ...
                  val eqTo =
                    equalTo.headOption getOrElse TypeConst(
