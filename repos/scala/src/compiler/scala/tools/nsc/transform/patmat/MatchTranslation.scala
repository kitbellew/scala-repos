...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    abstract class ExtractorCall(val aligner: PatternAligned) {
      ...
      protected def seqTree(binder: Symbol) =
      ...
      protected def subPatRefsSeq(binder: Symbol): List[Tree] = {
        ...
        (
          productElemsToN(binder, firstIndexingBinder) ++
            genTake(binder, expectedLength) ++ lastTrees
        ).toList
      }
    ...
    class ExtractorCallProd(
        aligner: PatternAligned,
        val fun: Tree,
        val args: List[Tree])
        extends ExtractorCall(aligner) {
    ...
    class ExtractorCallRegular(
        aligner: PatternAligned,
        extractorCallIncludingDummy: Tree,
        val args: List[Tree])
        extends ExtractorCall(aligner) {
