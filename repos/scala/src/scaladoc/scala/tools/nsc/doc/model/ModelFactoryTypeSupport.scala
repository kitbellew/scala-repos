  ...
  def makeType(aType: Type, inTpl: TemplateImpl): TypeEntity = {
    def createTypeEntity =
      new TypeEntity {
        ...
        private def appendType0(tpe: Type): Unit =
          tpe match {
            /* Type refs */
            ...
            case et @ ExistentialType(quantified, underlying) =>
              ...
              underlying match {
                case TypeRef(pre, sym, args)
                    if et.isRepresentableWithWildcards =>
            ...
            case tpen @ ThisType(sym) =>
              ...
              if (!tpen.underlying.typeSymbol.skipPackageObject
                    .isOmittablePrefix) nameBuffer append ".type"
