...
class DefaultSexpProtocolSpec extends FormatSpec {
  ...
  "DefaultSexpProtocol" should
    "support String as SexpString, not via IsTraversableLike" in {
  ...
  "DefaultSexpProtocol with OptionAltFormat" should
    "predictably fail to round-trip Option[List[T]]" in {
