...
/**
  * Responds with a `VoidResponse`.
  */
case class TypecheckFilesReq(files: List[Either[File, SourceFileInfo]])
    extends RpcAnalyserRequest
...
/**
  ...
  */
case class PublicSymbolSearchReq(keywords: List[String], maxResults: Int)
...
/**
  ...
  */
case class SymbolAtPointReq(file: Either[File, SourceFileInfo], point: Int)
    extends RpcAnalyserRequest
...
/**
  ...
  */
case class RefactorReq(procId: Int, params: RefactorDesc, interactive: Boolean)
    extends RpcAnalyserRequest

/**
  * Responds with a `RefactorFailure` or a `RefactorEffect`.
  */
case class ExecRefactorReq(procId: Int, tpe: RefactorType)
    extends RpcAnalyserRequest
...
/**
  ...
  */
case class ExpandSelectionReq(file: File, start: Int, end: Int)
    extends RpcAnalyserRequest
...
/**
  * Responds with `DebugVmStatus`.
  */
case class DebugAttachReq(hostname: String, port: String)
...
/**
  ...
  */
case class DebugLocateNameReq(threadId: DebugThreadId, name: String)
    extends RpcDebuggerRequest
...
/**
  ...
  */
case class DebugToStringReq(threadId: DebugThreadId, loc: DebugLocation)
    extends RpcDebuggerRequest
...
/**
  ...
  */
case class DebugBacktraceReq(threadId: DebugThreadId, index: Int, count: Int)
    extends RpcDebuggerRequest
