...
private object Perturbers {
  def perturb(t0: TestStruct, t1: TestStruct, i: Int): TestStruct = {
    i match {
      case 1 =>
        t0.copy(aString = t1.aString)
      case 2 =>
        t0.copy(aI32 = t1.aI32)
      case 3 =>
        t0.copy(aSecondString = t1.aSecondString)
      case 4 =>
        t0
      case x =>
        sys.error("Can't perturb TestStruct field: " + x)
    }
  }
  def perturb(t0: TestTypes, t1: TestTypes, i: Int): TestTypes = {
    i match {
      case 1 =>
        t0.copy(aBool = t1.aBool)
      case 2 =>
        t0.copy(aByte = t1.aByte)
      case 3 =>
        t0.copy(aI16 = t1.aI16)
      case 4 =>
        t0.copy(aI32 = t1.aI32)
      case 5 =>
        t0.copy(aI64 = t1.aI64)
      case 6 =>
        t0.copy(aDouble = t1.aDouble)
      case 7 =>
        t0.copy(aString = t1.aString)
      case 8 =>
        t0.copy(aEnum = t1.aEnum)
      case 9 =>
        t0.copy(aBinary = t1.aBinary)
      case 10 =>
        t0
      case x =>
        sys.error("Can't perturb TestTypes field: " + x)
    }
  }
  def perturb(t0: TestLists, t1: TestLists, i: Int): TestLists = {
    i match {
      case 1 =>
        t0.copy(aBoolList = t1.aBoolList)
      case 2 =>
        t0.copy(aByteList = t1.aByteList)
      case 3 =>
        t0.copy(aI16List = t1.aI16List)
      case 4 =>
        t0.copy(aI32List = t1.aI32List)
      case 5 =>
        t0.copy(aI64List = t1.aI64List)
      case 6 =>
        t0.copy(aDoubleList = t1.aDoubleList)
      case 7 =>
        t0.copy(aStringList = t1.aStringList)
      case 8 =>
        t0.copy(aStructList = t1.aStructList)
      case 9 =>
        t0.copy(aListList = t1.aListList)
      case 10 =>
        t0.copy(aSetList = t1.aSetList)
      case 11 =>
        t0.copy(aMapList = t1.aMapList)
      case 12 =>
        t0
      case x =>
        sys.error("Can't perturb TestLists field: " + x)
    }
  }
  def perturb(t0: TestSets, t1: TestSets, i: Int): TestSets = {
    i match {
      case 1 =>
        t0.copy(aBoolSet = t1.aBoolSet)
      case 2 =>
        t0.copy(aByteSet = t1.aByteSet)
      case 3 =>
        t0.copy(aI16Set = t1.aI16Set)
      case 4 =>
        t0.copy(aI32Set = t1.aI32Set)
      case 5 =>
        t0.copy(aI64Set = t1.aI64Set)
      case 6 =>
        t0.copy(aDoubleSet = t1.aDoubleSet)
      case 7 =>
        t0.copy(aStringSet = t1.aStringSet)
      case 8 =>
        t0.copy(aStructSet = t1.aStructSet)
      case 9 =>
        t0.copy(aListSet = t1.aListSet)
      case 10 =>
        t0.copy(aSetSet = t1.aSetSet)
      case 11 =>
        t0.copy(aMapSet = t1.aMapSet)
      case 12 =>
        t0
      case x =>
        sys.error("Can't perturb TestSets field: " + x)
    }
  }
  def perturb(t0: TestMaps, t1: TestMaps, i: Int): TestMaps = {
    i match {
      case 1 =>
        t0.copy(aBoolMap = t1.aBoolMap)
      case 2 =>
        t0.copy(aByteMap = t1.aByteMap)
      case 3 =>
        t0.copy(aI16Map = t1.aI16Map)
      case 4 =>
        t0.copy(aI32Map = t1.aI32Map)
      case 5 =>
        t0.copy(aI64Map = t1.aI64Map)
      case 6 =>
        t0.copy(aDoubleMap = t1.aDoubleMap)
      case 7 =>
        t0.copy(aStringMap = t1.aStringMap)
      case 8 =>
        t0.copy(aStructMap = t1.aStructMap)
      case 9 =>
        t0.copy(aListMap = t1.aListMap)
      case 10 =>
        t0.copy(aSetMap = t1.aSetMap)
      case 11 =>
        t0.copy(aMapMap = t1.aMapMap)
      case 12 =>
        t0
      case x =>
        sys.error("Can't perturb TestMaps field: " + x)
    }
  }
}
  ...
  def dataProvider[T: Arbitrary](i: Int): T = {
    ...
    def g(innerI: Int, loops: Int): T = {
      ...
      implicitly[Arbitrary[T]].arbitrary(p) match {
        case Some(s) =>
          s
        case None if loops < 5 =>
          g(innerI + 1, loops + 1)
        case None =>
          sys.error("Cannot appear to get Some for this generator.")
      }
    }
      ...
      for {
        ...
        aSetMap <- Gen
          ...
          .map(
            ...
            .asInstanceOf[collection.Map[collection.Set[String], collection.Set[
              String]]])
        aMapMap <- Gen
