...
object FunctionImplicits {
  ...
  implicit def function4ToTupledFunction1[T1, T2, T3, T4, R](
      f: Function4[T1, T2, T3, T4, R]): Function1[(T1, T2, T3, T4), R] =
    f.tupled

  implicit def function5ToTupledFunction1[T1, T2, T3, T4, T5, R](
      f: Function5[T1, T2, T3, T4, T5, R]): Function1[(T1, T2, T3, T4, T5), R] =
    f.tupled
  ...
  implicit def function10ToTupledFunction1[
      ...
      T9,
      T10,
      R](f: Function10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R])
  ...
  implicit def function11ToTupledFunction1[
      ...
      T10,
      T11,
      R](f: Function11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R])
  ...
  implicit def function14ToTupledFunction1[
      ...
      : Function1[(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14), R] =
    f.tupled
