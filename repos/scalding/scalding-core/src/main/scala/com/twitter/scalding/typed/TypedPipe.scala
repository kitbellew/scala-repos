...
object TypedPipe extends Serializable {
  ...
  /**
    ...
    */
  def fromSingleField[T](
      pipe: Pipe)(implicit fd: FlowDef, mode: Mode): TypedPipe[T] =
  ...
  /**
    ...
    */
  implicit def toHashJoinable[K, V](pipe: TypedPipe[(K, V)])(implicit
      ord: Ordering[K]): HashJoinable[K, V] =
  ...
  /**
    ...
    */
  implicit def typedPipeMonoid[T]: Monoid[TypedPipe[T]] =
    new Monoid[TypedPipe[T]] {
      def zero = empty
  ...
  private val identityOrdering: OrderedSerialization[Int] = {
    ...
    new OrderedSerialization[Int] {
      ...
      override def write(out: OutputStream, t: Int): Try[Unit] =
...
trait TypedPipe[+T] extends Serializable {
  ...
  /**
    ...
    */
  final def toPipe[U >: T](fieldNames: Fields)(implicit
      flowDef: FlowDef,
      mode: Mode,
  ...
  /**
    ...
    */
  private[typed] def asPipe[U >: T](fieldNames: Fields)(implicit
      flowDef: FlowDef,
      mode: Mode,
      setter: TupleSetter[U]): Pipe
  ...
  /**
    ...
    */
  def eitherValues[K, V, R](that: TypedPipe[(K, R)])(implicit
  ...
  def flatMapValues[K, V, U](f: V => TraversableOnce[U])(implicit
      ev: T <:< (K, V)): TypedPipe[(K, U)] =
    raiseTo[(K, V)].flatMap {
      case (k, v) =>
        f(v).map { v2 =>
  ...
  /**
    ...
    */
  def filterKeys[K](fn: K => Boolean)(implicit
      ev: T <:< (K, Any)): TypedPipe[T] =
    filter { ka =>
  ...
  /**
    ...
    */
  def group[K, V](implicit
      ev: <:<[T, (K, V)],
      ord: Ordering[K]): Grouped[K, V] =
  ...
  def groupWith[K, V](ord: Ordering[K])(implicit
      ev: <:<[T, (K, V)]): Grouped[K, V] = group(ev, ord)
  ...
  /**
    ...
    */
  def sumByLocalKeys[K, V](implicit
      ev: T <:< (K, V),
    ...
    TypedPipeFactory({ (fd, mode) =>
      ...
      val msr =
        new MapsideReduce(sg, 'key, 'value, None)(
          singleConverter[V],
          singleSetter[V])
      TypedPipe.from[(K, V)](
        pipe.eachTo(fields -> fields) { _ =>
          msr
        },
  ...
  def unpackToPipe[U >: T](fieldNames: Fields)(implicit
      fd: FlowDef,
      mode: Mode,
      up: TupleUnpacker[U]): Pipe = {
  ...
  /**
    ...
    */
  def write(dest: TypedSink[T])(implicit
      flowDef: FlowDef,
  ...
  /**
    ...
    */
  def writeThrough[U >: T](
      dest: TypedSink[T] with TypedSource[U]): Execution[TypedPipe[U]] =
  ...
  /**
    ...
    * }
    */
  def mapWithValue[U, V](value: ValuePipe[U])(
      f: (T, Option[U]) => V): TypedPipe[V] =
  ...
  /**
    ...
    * }
    */
  def filterWithValue[U](value: ValuePipe[U])(
      f: (T, Option[U]) => Boolean): TypedPipe[T] =
  ...
  def hashCogroup[K, V, W, R](smaller: HashJoinable[K, W])(
      ...
      ev: TypedPipe[T] <:< TypedPipe[(K, V)]): TypedPipe[(K, R)] =
  ...
  def hashJoin[K, V, W](smaller: HashJoinable[K, W])(implicit
      ev: TypedPipe[T] <:< TypedPipe[(K, V)]): TypedPipe[(K, (V, W))] =
...
final case object EmptyTypedPipe extends TypedPipe[Nothing] {
  ...
  override def asPipe[U >: Nothing](fieldNames: Fields)(implicit
      fd: FlowDef,
      mode: Mode,
      setter: TupleSetter[U]): Pipe =
  ...
  override def forceToDiskExecution: Execution[TypedPipe[Nothing]] =
    Execution.from(this)
    ...
    TypedPipeFactory({ (fd, mode) =>
      ...
      val msr =
        new TypedMapsideReduce[K, V](
          ...
          None)(tup2Setter)
      TypedPipe.from[(K, V)](
        inpipe.eachTo(fields -> destFields) { _ =>
          msr
        },
...
final case class MergedTypedPipe[T](left: TypedPipe[T], right: TypedPipe[T])
  ...
  private def flattenMerge(
      toFlatten: List[TypedPipe[T]],
      acc: List[TypedPipe[T]])(implicit
      fd: FlowDef,
...
case class WithDescriptionTypedPipe[T](
...
/**
  ...
  */
object Syntax {
  implicit def joinOnMappablePipe[T](
      p: TypedPipe[T]): MappablePipeJoinEnrichment[T] =
