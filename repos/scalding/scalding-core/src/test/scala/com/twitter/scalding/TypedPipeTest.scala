  ...
  "A TypedPipe" should {
    ...
    TUtil.printStack {
      JobTest(new TypedPipeJob(_))
        ...
        .sink[(String, Long)](TypedText.tsv[(String, Long)]("outputFile")) {
          outputBuffer =>
...
class TypedPipeJoinJob(args: Args) extends Job(args) {
  (
    Tsv("inputFile0").read.toTypedPipe[(Int, Int)](0, 1).group leftJoin
      TypedPipe.from[(Int, Int)](Tsv("inputFile1").read, (0, 1)).group
...
class TypedPipeJoinTest extends WordSpec with Matchers {
  ...
  "A TypedPipeJoin" should {
    JobTest(new com.twitter.scalding.TypedPipeJoinJob(_))
      ...
      .typedSink[(Int, (Int, Option[Int]))](
        TypedText.tsv[(Int, (Int, Option[Int]))]("outputFile")) {
        outputBuffer =>
          val outMap = outputBuffer.toMap
          "correctly join" in {
...
class TypedPipeDistinctTest extends WordSpec with Matchers {
  ...
  "A TypedPipeDistinctJob" should {
    JobTest(new TypedPipeDistinctJob(_))
      ...
      .sink[(Int, Int)](TypedText.tsv[(Int, Int)]("outputFile")) {
        outputBuffer =>
          val outMap = outputBuffer.toMap
  ...
  "A TypedWithOnCompleteJob" should {
    JobTest(new TypedWithOnCompleteJob(_))
      ...
      .counter("onCompleteMapper") { cnt =>
        "have onComplete called on mapper" in {
          assert(cnt == 1)
        }
      }
      .counter("onCompleteReducer") { cnt =>
        "have onComplete called on reducer" in {
          assert(cnt == 1)
        }
      }
...
class TJoinCountJob(args: Args) extends Job(args) {
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)).group join
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)).group
  ...
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)).group leftJoin
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)).group
  )
  //Flatten out to three values:
    .toTypedPipe
...
class TNiceJoinCountJob(args: Args) extends Job(args) {
  ...
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)) join
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))
  ).size.write(TypedText.tsv[(Int, Long)]("out"))
  ...
  //Also check simple leftJoins:
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)) leftJoin
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))
  )
  //Flatten out to three values:
    .toTypedPipe
...
class TNiceJoinByCountJob(args: Args) extends Job(args) {
  ...
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)) joinBy
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))
  )(_._1, _._1).size.write(TypedText.tsv[(Int, Long)]("out"))
  ...
  //Also check simple leftJoins:
  (
    TypedPipe.from[(Int, Int)](Tsv("in0", (0, 1)), (0, 1)) leftJoinBy
      TypedPipe.from[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))
  )(_._1, _._1)
  //Flatten out to three values:
    .toTypedPipe
...
class TypedJoinWCTest extends WordSpec with Matchers {
  ...
  "A TJoinWordCount" should {
    TUtil.printStack {
      ...
      val correct =
        outerjoin(count(in0), 0, count(in1), 0)
          .toList
          .map { tup =>
...
class TypedShardJob(args: Args) extends Job(args) {
  ...
  ).shard(10).write(TypedText.tsv[String]("output"))
}
...
class TypedFilterTest extends WordSpec with Matchers {
  ...
  "A TypedPipe" should {
    "filter and filterNot elements" in {
      ...
      val expectedOutput = input filter {
        _ > 50
      } filterNot isEven
...
class TypedPartitionTest extends WordSpec with Matchers {
  ...
  "A TypedPipe" should {
    "partition elements" in {
      val input = -1 to 100
      val (expected1, expected2) = input partition {
        _ > 50
      }
    ...
    JobTest(new TypedMultiJoinJob(_))
      ...
      .typedSink(TypedText.tsv[(Int, Int, Int, Int)]("output")) { outBuf =>
        "correctly do a multi-join" in {
          ...
          val correct = (d0.keySet ++ d1.keySet ++ d2.keySet)
            .toList
            .flatMap { k =>
              (
                for {
