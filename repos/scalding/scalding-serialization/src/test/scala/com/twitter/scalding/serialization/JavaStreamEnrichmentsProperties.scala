...
object JavaStreamEnrichmentsProperties
    extends Properties("JavaStreamEnrichmentsProperties") {
  ...
  property("Can (read/write)Short") =
    writeRead(Gen.chooseNum(Short.MinValue, Short.MaxValue), { (i: Short, os) =>
      os.writeShort(i)
    }, { _.readShort })
