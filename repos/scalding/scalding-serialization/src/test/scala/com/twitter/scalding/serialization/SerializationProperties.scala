...
object SerializationProperties extends Properties("SerializationProperties") {
  ...
  include(
    LawTester("(String, Int) Ordered", OrderedSerialization.allLaws[(String, Int)]))
  include(
    LawTester("(Int, String) Ordered", OrderedSerialization.allLaws[(Int, String)]))
  include(
    LawTester(
