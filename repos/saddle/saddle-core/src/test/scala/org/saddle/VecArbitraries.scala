...
object VecArbitraries {
  ...
  def vecDoubleWithNA: Gen[Vec[Double]] = for {
    n <- Gen.choose(0, 10)
    lst <- Gen.listOfN(
      n,
  ...
  def vecDoubleWithoutNA: Gen[Vec[Double]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1e3, 1e3))
  } yield Vec(lst: _*)

  def vecDoublePWithNA: Gen[Vec[Double]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
  ...
  def vecDoublePWithoutNA: Gen[Vec[Double]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1e3, 1e3))
  } yield Vec(lst.filter(_ > 0): _*)
  ...
  def vecFloatWithNA: Gen[Vec[Float]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
  ...
  def vecFloatWithoutNA: Gen[Vec[Float]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1e3f, 1e3f))
  } yield Vec(lst: _*)

  def vecFloatPWithNA: Gen[Vec[Float]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
  ...
  def vecFloatPWithoutNA: Gen[Vec[Float]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1e3f, 1e3f))
  } yield Vec(lst.filter(_ > 0): _*)
  ...
  def vecLongWithNA: Gen[Vec[Long]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
  ...
  def vecLongWithoutNA: Gen[Vec[Long]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1000L, 1000L))
  } yield Vec(lst: _*)

  def vecLongPWithNA: Gen[Vec[Long]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
      Gen.frequency((9, Gen.chooseNum(-1000L, 1000L)), (1, na.to[Long])))
  ...
  def vecLongPWithoutNA: Gen[Vec[Long]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1000L, 1000L))
  } yield Vec(lst.filter(_ > 0): _*)
  ...
  def vecIntWithNA: Gen[Vec[Int]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
  ...
  def vecIntWithoutNA: Gen[Vec[Int]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1000, 1000))
  } yield Vec(lst: _*)

  def vecIntPWithNA: Gen[Vec[Int]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(
      n,
      Gen.frequency((9, Gen.chooseNum(-1000, 1000)), (1, na.to[Int])))
  ...
  def vecIntPWithoutNA: Gen[Vec[Int]] = for {
    n <- Gen.choose(0, 20)
    lst <- Gen.listOfN(n, Gen.chooseNum(-1000, 1000))
  } yield Vec(lst.filter(_ > 0): _*)
