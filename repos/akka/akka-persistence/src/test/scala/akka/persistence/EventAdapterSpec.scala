...
object EventAdapterSpec {
  ...
  final val JournalModelClassName = classOf[EventAdapterSpec].getCanonicalName + "$" + classOf[
  ...
  final val DomainEventClassName = classOf[EventAdapterSpec].getCanonicalName + "$" + classOf[
