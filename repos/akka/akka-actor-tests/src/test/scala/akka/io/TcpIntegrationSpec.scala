...
class TcpIntegrationSpec extends AkkaSpec("""
  ...
  "The TCP transport implementation" should {
    ...
    "properly handle connection abort from client side" in
      new TestSetup {
        val (clientHandler, clientConnection, serverHandler, serverConnection) =
          establishNewClientConnection()
    ...
    "properly handle connection abort from server side" in
      new TestSetup {
        val (clientHandler, clientConnection, serverHandler, serverConnection) =
          establishNewClientConnection()
    ...
    "support waiting for writes with backpressure" in
      new TestSetup {
        val (clientHandler, clientConnection, serverHandler, serverConnection) =
          establishNewClientConnection()
