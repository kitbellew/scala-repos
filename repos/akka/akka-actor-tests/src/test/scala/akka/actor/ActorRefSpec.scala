        ...
        intercept[akka.actor.ActorInitializationException] {
          wrap(result ⇒
            actorOf(
              Props(
                promiseIntercept(
                  new FailingOuterActor(actorOf(Props(new InnerActor))))(
                  result))))
        }
        ...
        intercept[akka.actor.ActorInitializationException] {
          wrap(result ⇒
            actorOf(
              Props(
                promiseIntercept(
                  new FailingInheritingOuterActor(
                ...
                Props(
                  new Actor {
                    ...
                    override def preRestart(
                        reason: Throwable,
                        msg: Option[Any]) = latch.countDown()
