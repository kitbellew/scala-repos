...
object BidiFlow {
  ...
  private[this] val _identity
      : BidiFlow[Object, Object, Object, Object, NotUsed] = BidiFlow
    .fromFlows(Flow.of(classOf[Object]), Flow.of(classOf[Object]))
  ...
  def fromGraph[I1, O1, I2, O2, M](
    ...
    g match {
      case bidi: BidiFlow[I1, O1, I2, O2, M] ⇒
        bidi
      case other ⇒
        new BidiFlow(scaladsl.BidiFlow.fromGraph(other))
    }
...
final class BidiFlow[-I1, +O1, -I2, +O2, +Mat](
  ...
  def atop[OO1, II2, Mat2](
      bidi: BidiFlow[O1, OO1, II2, I2, Mat2]): BidiFlow[I1, OO1, II2, O2, Mat] =
