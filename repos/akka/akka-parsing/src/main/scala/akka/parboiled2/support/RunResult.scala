...
object RunResult {
  implicit def fromAux[T, Out0 <: RuleX](implicit
      aux: Aux[T, Out0]): RunResult[T] { type Out = Out0 } = `n/a`
  ...
  abstract class Aux1 extends Aux2 {
    implicit def forF1[Z, R, In0 <: HList, Out0 <: HList](implicit
        x: JA[Z :: HNil, R, In0, Out0]): Aux[Z ⇒ R, Rule[In0, Out0]] = `n/a`
  ...
  abstract class Aux2 {
    protected type JA[I <: HList, R, In0 <: HList, Out0 <: HList] =
      Join.Aux[I, HNil, HNil, R, HNil, In0, Out0]
