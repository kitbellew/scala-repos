...
sealed trait Multipart extends jm.Multipart {
  ...
  def toStrict(timeout: FiniteDuration)(implicit
      fm: Materializer): Future[Multipart.Strict]
  ...
  def toEntity(
      ...
      boundary: String = BodyPartRenderer.randomBoundary())(implicit
      log: LoggingAdapter = NoLogging): MessageEntity = {
    val chunks = parts.transform(() ⇒
      BodyPartRenderer
        .streamed(boundary, charset.nioCharset, partHeadersSizeHint = 128, log))
...
object Multipart {
  ...
  trait Strict extends Multipart with jm.Multipart.Strict {
    ...
    override def toEntity(charset: HttpCharset, boundary: String)(implicit
        log: LoggingAdapter = NoLogging): HttpEntity.Strict = {
  ...
  trait BodyPart extends jm.Multipart.BodyPart {
    ...
    def toStrict(timeout: FiniteDuration)(implicit
        fm: Materializer): Future[BodyPart.Strict]
  ...
  private def strictify[
      ...
      BPS <: Multipart.BodyPart.Strict](parts: Source[BP, Any])(
  ...
  sealed abstract class General extends Multipart with jm.Multipart.General {
    ...
    override def toStrict(timeoutMillis: Long, materializer: Materializer)
      ...
      super.toStrict(timeoutMillis, materializer)
        .asInstanceOf[Future[jm.Multipart.General.Strict]].toJava
  }
  object General {
    def apply(mediaType: MediaType.Multipart, parts: BodyPart.Strict*): Strict =
    ...
    sealed abstract class BodyPart
      ...
      override def toStrict(timeoutMillis: Long, materializer: Materializer)
        ...
        super.toStrict(timeoutMillis, materializer)
          .asInstanceOf[Future[jm.Multipart.General.BodyPart.Strict]].toJava
  ...
  sealed abstract class FormData extends Multipart with jm.Multipart.FormData {
    ...
    override def toStrict(timeoutMillis: Long, materializer: Materializer)
      ...
      super.toStrict(timeoutMillis, materializer)
        .asInstanceOf[Future[jm.Multipart.FormData.Strict]].toJava
  }
  object FormData {
    def apply(
        parts: Multipart.FormData.BodyPart.Strict*): Multipart.FormData.Strict =
    ...
    def fromFile(
      ...
      Multipart.FormData(Source.single(
    ...
    sealed abstract class BodyPart
        extends Multipart.BodyPart
        with jm.Multipart.FormData.BodyPart {
      ...
      override def toStrict(timeoutMillis: Long, materializer: Materializer)
        ...
        super.toStrict(timeoutMillis, materializer)
          .asInstanceOf[Future[jm.Multipart.FormData.BodyPart.Strict]].toJava
    }
    object BodyPart {
      def apply(
          _name: String,
  ...
  sealed abstract class ByteRanges
    ...
    override def toStrict(timeoutMillis: Long, materializer: Materializer)
      ...
      super.toStrict(timeoutMillis, materializer)
        .asInstanceOf[Future[jm.Multipart.ByteRanges.Strict]].toJava
  }
  object ByteRanges {
    ...
    sealed abstract class BodyPart
        extends Multipart.BodyPart
        with jm.Multipart.ByteRanges.BodyPart {
      ...
      override def toStrict(timeoutMillis: Long, materializer: Materializer)
        ...
        super.toStrict(timeoutMillis, materializer)
          .asInstanceOf[Future[jm.Multipart.ByteRanges.BodyPart.Strict]].toJava
    }
    object BodyPart {
      def apply(
