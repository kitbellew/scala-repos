...
abstract class RejectionHandler {
  ...
  def handleMethodRejection(
      ctx: RequestContext,
      supported: HttpMethod): RouteResult = passRejection()
  ...
  def handleMissingQueryParamRejection(
      ctx: RequestContext,
      parameterName: String): RouteResult = passRejection()
  ...
  def handleUnsupportedRequestEncodingRejection(
      ctx: RequestContext,
      supported: HttpEncoding): RouteResult = passRejection()
  ...
  def handleUnacceptedResponseContentTypeRejection(
      ctx: RequestContext,
      supported: jl.Iterable[String]): RouteResult = passRejection()
  ...
  def handleUnacceptedResponseEncodingRejection(
      ctx: RequestContext,
      supported: jl.Iterable[HttpEncoding]): RouteResult = passRejection()
  ...
  def handleUnsupportedWebSocketSubprotocolRejection(
      ctx: RequestContext,
      supportedProtocol: String): RouteResult = passRejection()
  ...
  def handleCustomRejection(
      ctx: RequestContext,
      rejection: CustomRejection): RouteResult = passRejection()
