...
class ProducerConfig private (val props: VerifiableProperties)
  ...
  val partitionerClass = props
    .getString("partitioner.class", "kafka.producer.DefaultPartitioner")
  ...
  /**
    ...
    */
  val compressionCodec = props
    .getCompressionCodec("compression.codec", NoCompressionCodec)
  ...
  /** This parameter allows you to set whether compression should be turned *
    ...
    */
  val compressedTopics = CoreUtils
    .parseCsvList(props.getString("compressed.topics", null))
  ...
  /**
    ...
    */
  val topicMetadataRefreshIntervalMs = props
    .getInt("topic.metadata.refresh.interval.ms", 600000)
