...
class ReplicationUtilsTest extends ZooKeeperTestHarness {
  ...
  def testUpdateLeaderAndIsr() {
    ...
    val (updateSucceeded1, newZkVersion1) = ReplicationUtils.updateLeaderAndIsr(
      zkUtils,
      "my-topic-test",
      partitionId,
      newLeaderAndIsr1,
    ...
    val (updateSucceeded2, newZkVersion2) = ReplicationUtils.updateLeaderAndIsr(
      zkUtils,
      "my-topic-test",
      partitionId,
      newLeaderAndIsr2,
    ...
    val (updateSucceeded3, newZkVersion3) = ReplicationUtils.updateLeaderAndIsr(
      zkUtils,
      "my-topic-test",
      partitionId,
      newLeaderAndIsr3,
