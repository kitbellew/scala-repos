...
object Producer {
  ...
  /**
    ...
    */
  def source[P <: Platform[P], T](s: P#Source[T]): Producer[P, T] =
    Source[P, T](s)
...
sealed trait Producer[P <: Platform[P], +T] {
  ...
  /**
    ...
    */
  def write[U >: T](sink: P#Sink[U]): TailProducer[P, T] =
    WrittenProducer(this, sink)
...
sealed trait TailProducer[P <: Platform[P], +T] extends Producer[P, T] {
  ...
  def also[R](that: TailProducer[P, R])(implicit
      ev: DummyImplicit): TailProducer[P, R] =
...
sealed trait KeyedProducer[P <: Platform[P], K, V] extends Producer[P, (K, V)] {
  ...
  /**
    ...
    */
  def leftJoin[RightV](
      service: P#Service[K, RightV]): KeyedProducer[P, K, (V, Option[RightV])] =
