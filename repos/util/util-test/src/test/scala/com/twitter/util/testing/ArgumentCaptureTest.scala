...
class ArgumentCaptureTest
  ...
  class MockSubject {
    ...
    def method4(arg1: String, arg2: String, arg3: String, arg4: String): Long =
      0L
    def method5(
        arg1: String,
        arg2: String,
  ...
  test("captureOne should handle 3-ary functions") {
    val theMockSubject = mock[MockSubject]
    when(
      theMockSubject.method3(any[String], any[String], any[String])).thenReturn(
      136L)
