...
object Tuple4 {
  ...
  @inline def unapply[T1, T2, T3, T4](
      t: Tuple4[T1, T2, T3, T4]): Option[(T1, T2, T3, T4)] =
    Some(t)
...
object Tuple5 {
  ...
  @inline def unapply[T1, T2, T3, T4, T5](
      t: Tuple5[T1, T2, T3, T4, T5]): Option[(T1, T2, T3, T4, T5)] =
    Some(t)
...
object Tuple7 {
  ...
  @inline def unapply[T1, T2, T3, T4, T5, T6, T7](
      t: Tuple7[T1, T2, T3, T4, T5, T6, T7]): Option[(T1, T2, T3, T4, T5, T6, T7)] =
    Some(t)
...
object Tuple13 {
  @inline def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13](
      ...
      _11: T11,
      _12: T12,
      _13: T13): Tuple13[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13] =
