...
class Promise[+A](
  ...
  def `then`[B](
      ...
      onRejected: js.UndefOr[js.Function1[scala.Any, B | Thenable[B]]] = js
        .undefined): Thenable[B] = js.native
...
object Promise extends js.Object {
  ...
  def all[A](promises: js.Array[_ <: Promise[A]]): Promise[js.Array[A]] =
    js.native
