...
class ArraysTest {
  ...
  @Test
  def fill_Boolean_with_start_and_end_index(): Unit = {
    val booleans = new Array[Boolean](6)
  ...
  @Test
  def fill_Byte_with_start_and_end_index(): Unit = {
    val bytes = new Array[Byte](6)
  ...
  @Test
  def fill_Short_with_start_and_end_index(): Unit = {
    val shorts = new Array[Short](6)
  ...
  @Test
  def fill_Int_with_start_and_end_index(): Unit = {
    val ints = new Array[Int](6)
  ...
  @Test
  def fill_Long_with_start_and_end_index(): Unit = {
    val longs = new Array[Long](6)
  ...
  @Test
  def fill_Float_with_start_and_end_index(): Unit = {
    val floats = new Array[Float](6)
  ...
  @Test
  def fill_Double_with_start_and_end_index(): Unit = {
    val doubles = new Array[Double](6)
  ...
  @Test
  def fill_AnyRef_with_start_and_end_index(): Unit = {
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Long(): Unit = {
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Int(): Unit = {
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Short(): Unit = {
  ...
  @Test
  def binarySearch_on_Short(): Unit = {
    val shorts: Array[Short] = Array(1, 2, 3, 5, 6, 7)
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Char(): Unit = {
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Double(): Unit = {
  ...
  @Test
  def binarySearch_on_Double(): Unit = {
    val doubles: Array[Double] = Array(0.1, 0.2, 0.3, 0.5, 0.6, 0.7)
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_Float(): Unit = {
  ...
  @Test
  def binarySearch_on_Float(): Unit = {
    val floats: Array[Float] = Array(0.1f, 0.2f, 0.3f, 0.5f, 0.6f, 0.7f)
  ...
  @Test
  def binarySearch_with_start_and_end_index_on_AnyRef(): Unit = {
  ...
  @Test
  def binarySearch_on_AnyRef(): Unit = {
    val strings: Array[AnyRef] = Array("aa", "abc", "cc", "zz", "zzzs", "zzzt")
  ...
  @Test
  def should_check_ranges_of_input_to_binarySearch(): Unit = {
  ...
  @Test
  def copyOf_AnyRef_with_change_of_type(): Unit = {
    class A
  ...
  @Test
  def copyOfRange_AnyRef_with_change_of_type(): Unit = {
    class A
    case class B(x: Int) extends A
