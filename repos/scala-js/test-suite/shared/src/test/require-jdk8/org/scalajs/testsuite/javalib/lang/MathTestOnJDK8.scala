...
class MathTestOnJDK8 {
  ...
  @Test def addExact(): Unit = {
    ...
    expectThrows(
      classOf[ArithmeticException],
      Math.addExact(1073741824, 1073741824))
  ...
  @Test def subtractExact(): Unit = {
    ...
    expectThrows(
      classOf[ArithmeticException],
      Math.subtractExact(0, Int.MinValue))
    expectThrows(
      classOf[ArithmeticException],
      Math.subtractExact(Int.MinValue, 1))
    expectThrows(
      classOf[ArithmeticException],
      Math.subtractExact(Int.MinValue, Int.MaxValue))
    expectThrows(
      classOf[ArithmeticException],
      Math.subtractExact(-2, Int.MaxValue))
    expectThrows(
      classOf[ArithmeticException],
      Math.subtractExact(Int.MaxValue, -1))
    expectThrows(
      classOf[ArithmeticException],
  ...
  @Test def multiplyExact(): Unit = {
    ...
    expectThrows(
      classOf[ArithmeticException],
      Math.multiplyExact(Int.MinValue, -1))
    expectThrows(
      classOf[ArithmeticException],
      Math.multiplyExact(-1, Int.MinValue))
    expectThrows(
      classOf[ArithmeticException],
    ...
    assertEquals(
      ...
      Math.multiplyExact(4611686018427387903L, 2))
    assertEquals(
      9223372036854775806L,
      Math.multiplyExact(2, 4611686018427387903L))
