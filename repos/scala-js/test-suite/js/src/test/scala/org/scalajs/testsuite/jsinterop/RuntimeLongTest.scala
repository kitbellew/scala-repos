...
class RuntimeLongTest {
  ...
  @Test
  def sanity_of_equality_tests(): Unit = {
  ...
  @Test
  def hashCode_as_specified_in_j_l_toFloat_strict(): Unit = {
  ...
  def shift_left_<<(): Unit = {
    ...
    assertEquals(
      lg(508125184, -784066052),
      lg(-807341493, 286689824) << -1938771891)
    assertEquals(
      lg(-551288832, 439734876),
      lg(-382832750, -2134078182) << 1537970769)
    assertEquals(
      lg(-1409069728, 1129787),
      lg(-580904341, 939559401) << 1856717061)
    assertEquals(
      lg(1711276032, 1295846454),
      lg(-198125160, 663832884) << 1561097110)
    assertEquals(
      lg(-1004724328, -940313723),
      lg(-1199332365, -1728151952) << 858801923)
    assertEquals(
      lg(-1029298112, -1523092059),
      lg(773140802, -181814355) << 1110910853)
    assertEquals(
      lg(536870912, 200145086),
      lg(1601160689, 869229832) << -338843811)
    assertEquals(lg(0, -1735502848), lg(-1919381932, -201750119) << -813015128)
    assertEquals(
      lg(-1727917056, 2104066035),
      lg(-52019067, -102802849) << -2122946486)
    ...
    assertEquals(
      lg(-58458112, -1619174179),
      lg(-1368457662, 1747275710) << 1382741393)
    ...
    assertEquals(
      lg(1888485376, 630678170),
      lg(-660169692, 1479330149) << 289081298)
    ...
    assertEquals(
      lg(1156516188, -1812425640),
      lg(578258094, -906212820) << 2074806145)
    assertEquals(lg(0, 1370357760), lg(61151968, -1770168701) << -2062208020)
    assertEquals(
      lg(-402653184, 1642287002),
      lg(1013576541, 460756940) << -902835237)
    assertEquals(
      lg(-1744830464, 1690731362),
      lg(-1731171245, 771836652) << 868975579)
    assertEquals(
      lg(-417260032, 563566725),
      lg(1123258511, 1049676716) << 575477257)
    assertEquals(
      lg(411626816, -1915897795),
      lg(-779579692, 1222433667) << 1238257604)
    ...
    assertEquals(
      lg(-1148788736, -847308273),
      lg(-1594115986, -186853391) << -119255604)
    assertEquals(lg(0, 1940424228), lg(-588635767, 1047291343) << 2089738146)
    assertEquals(
      lg(1726279680, 2137615428),
      lg(-1002017201, -986188138) << 800913356)
    assertEquals(lg(0, 1650633728), lg(1813551275, -400674286) << -1609938966)
    assertEquals(
      lg(-1207959552, 897838789),
      lg(-1333929801, 254558182) << -1518372133)
    assertEquals(lg(0, -1104224256), lg(834127324, 878312672) << -923142549)
    assertEquals(
      lg(-504160320, 305586753),
      lg(126340223, -2008491127) << -252023418)
    assertEquals(lg(0, 0), lg(510931784, -1313923431) << 1174528765)
    assertEquals(
      lg(-1449390900, -1602240664),
      lg(711394099, -400560166) << -967606846)
    assertEquals(lg(0, 1162928128), lg(1319282800, -1994311032) << 1237159401)
    assertEquals(
      lg(-1749421258, 1809275319),
      lg(-874710629, -1242845989) << 484063041)
  }

  @Test
  def shift_logical_right_>>>(): Unit = {
    ...
    assertEquals(
      lg(827423626, 419765),
      lg(-1560865755, 214919778) >>> 1191603401)
    assertEquals(
      lg(376475826, 25773988),
      lg(944265510, -995896821) >>> 485744647)
    ...
    assertEquals(
      lg(-684574597, 28915),
      lg(473794659, 947514265) >>> -1409717873)
    ...
    assertEquals(
      lg(-800511856, 59336150),
      lg(306848777, -497453644) >>> 1584315654)
    assertEquals(lg(25694, 0), lg(-1689341833, -927188015) >>> 1300572337)
    assertEquals(
      lg(237982231, 3229829),
      lg(396954515, 413418119) >>> 1180537031)
    assertEquals(
      lg(1319611409, 10188),
      lg(1478732342, 1335401807) >>> -1668840943)
    assertEquals(
      lg(-530293557, 9),
      lg(-1326271298, -1643756084) >>> -2118687716)
    assertEquals(lg(26, 0), lg(1205635051, 875594107) >>> 350453433)
    assertEquals(
      lg(1698203097, 57089),
      lg(-2049358216, -553556680) >>> -1203541232)
    assertEquals(
      lg(-308392901, 40188),
      lg(1278981121, -1661145698) >>> 254766480)
    assertEquals(
      lg(-1667461656, 7259908),
      lg(1313272948, 929268302) >>> 1175504903)
    ...
    assertEquals(
      lg(-152492078, 258),
      lg(-384174131, -2122615661) >>> -1278414057)
    assertEquals(
      lg(-1650335224, 9146646),
      lg(-1579022332, -1953425763) >>> 2134440904)
    ...
    assertEquals(
      lg(868056695, -1200391723),
      lg(868056695, -1200391723) >>> 93595840)
    ...
    assertEquals(
      lg(-1160719403, 3135),
      lg(-1633078438, 1644025478) >>> -1297864237)
    assertEquals(lg(27660, 0), lg(1159483779, 906375175) >>> -1204888593)
    assertEquals(
      lg(1096217739, 131290637),
      lg(179807326, 1050325098) >>> -1598422013)
  ...
  @Test
  def shift_arithmetic_right_>>(): Unit = {
    assertEquals(
      lg(144041519, 2813487),
      lg(-1780076655, 720252680) >> -1316031160)
    ...
    assertEquals(
      lg(-1283367734, 14309038),
      lg(-1062312593, 1831556953) >> 1545082311)
    assertEquals(lg(523169438, 0), lg(-1568293714, 523169438) >> -2119005984)
    assertEquals(
      lg(-1704853904, -731301),
      lg(-2013675422, -748851607) >> 511130378)
    ...
    assertEquals(
      lg(-587262921, -3246345),
      lg(-30904807, -1662128199) >> -638486135)
    ...
    assertEquals(
      lg(1601141595, 1298147),
      lg(1870355258, 332325727) >> -434372344)
    assertEquals(
      lg(-1047936567, -129548),
      lg(1886551280, -2122502046) >> -763866098)
    assertEquals(lg(-72307, -1), lg(-1169141408, -592336405) >> -1841005139)
    assertEquals(lg(72262, 0), lg(686282122, 295988927) >> 69079212)
    assertEquals(
      lg(-1582088844, -23862710),
      lg(1825529126, -1527213400) >> 1371712838)
    ...
    assertEquals(
      lg(-1472236443, 19900875),
      lg(-1472236443, 19900875) >> 373478400)
    ...
    assertEquals(
      lg(-868447412, 13901269),
      lg(507881044, 1779362534) >> -508943033)
    ...
    assertEquals(
      lg(-1683940185, 34921),
      lg(-1907127360, 1144311248) >> -2131012273)
    assertEquals(lg(-121723, -1), lg(756366897, -1994294687) >> -1642432978)
    assertEquals(
      lg(-644688038, 9473),
      lg(-1363894143, 1241756453) >> 1681307793)
    ...
    assertEquals(
      lg(-2101780246, 11998),
      lg(-1043053889, 1572668786) >> 309495249)
  ...
  def divide_/(): Unit = {
    ...
    assertEquals(
      lg(932715295, 204683),
      lg(-1211847018, -609137255) / lg(-2976, -1))
    assertEquals(
      lg(189814434, 0),
      lg(-457166837, -15040808) / lg(-340331202, -1))
    assertEquals(
      lg(-1116045071, -1131771),
      lg(-104570473, -117704108) / lg(104, 0))
    ...
    assertEquals(
      lg(-862273257, -2),
      lg(610589058, 36481453) / lg(-30381877, -1))
    assertEquals(
      lg(-761280647, -71),
      lg(410700182, 503953004) / lg(-7181145, -1))
    ...
    assertEquals(
      lg(-292170842, -76359),
      lg(1693696214, 18402294) / lg(-241, -1))
    assertEquals(
      lg(2104544550, -41349584),
      lg(-1932788158, 206747917) / lg(-5, -1))
    assertEquals(
      lg(-1928473941, -17816),
      lg(1427262980, -60732866) / lg(3409, 0))
    ...
    assertEquals(
      lg(-1706875941, 0),
      lg(-405257725, -2271799) / lg(-3770075, -1))
    assertEquals(
      lg(1540708852, 10909),
      lg(-1893733008, -6491069) / lg(-595, -1))
    assertEquals(lg(-1563665409, -358), lg(-1343018634, -2584815) / lg(7233, 0))
    assertEquals(
      lg(278715917, -374389),
      lg(-1224507547, 122799570) / lg(-328, -1))
    assertEquals(
      lg(1421525100, 0),
      lg(-2082712791, -15998594) / lg(-48337828, -1))
    assertEquals(
      lg(1574832373, -2193811),
      lg(-2147318181, -32907160) / lg(15, 0))
    assertEquals(
      lg(-1260116915, -61610),
      lg(1074158039, 118905936) / lg(-1930, -1))
    assertEquals(lg(130856059, -15612), lg(1270835097, -2201288) / lg(141, 0))
    assertEquals(
      lg(-110248455, 2347),
      lg(320077861, -446108079) / lg(-189997, -1))
    ...
    assertEquals(
      lg(-1312994937, -23952),
      lg(-654120591, 33364168) / lg(-1393, -1))
    assertEquals(lg(-178073210, -1), lg(302695822, -2432394) / lg(58667176, 0))
    assertEquals(
      lg(1316938460, 142),
      lg(523451067, -54366538) / lg(-382038, -1))
    assertEquals(lg(-1457978633, 17556853), lg(-78968601, 52670560) / lg(3, 0))
    assertEquals(
      lg(-1760960552, 505129611),
      lg(-773046192, -1010259224) / lg(-2, -1))
    assertEquals(
      lg(1210355204, 2314),
      lg(1515488136, -21874592) / lg(-9452, -1))
    assertEquals(
      lg(-1625685934, 862807773),
      lg(-1043595428, -1725615548) / lg(-2, -1))
    assertEquals(
      lg(184379181, 4),
      lg(-1217231978, 1516494005) / lg(375097846, 0))
    assertEquals(
      lg(1243945230, 0),
      lg(-1873413508, -236381131) / lg(-816152673, -1))
    assertEquals(
      lg(-1540093941, -876),
      lg(265593875, 26513736) / lg(-30289, -1))
    assertEquals(
      lg(-1304692919, 543912),
      lg(106204837, -839801203) / lg(-1544, -1))
    assertEquals(
      lg(-806250591, 23),
      lg(815576040, -55524975) / lg(-2331779, -1))
    assertEquals(
      lg(-2106907248, -3),
      lg(-2053929476, -1795047022) / lg(720742474, 0))
    assertEquals(
      lg(893100234, -124),
      lg(1552099699, 65024502) / lg(-525272, -1))
    assertEquals(
      lg(-1109915706, 1255),
      lg(-194253417, -12405472) / lg(-9879, -1))
    assertEquals(
      lg(-1177955013, 0),
      lg(412309016, 112344162) / lg(154800321, 0))
    assertEquals(
      lg(-1975688052, -51023804),
      lg(343591192, -102047607) / lg(2, 0))
    assertEquals(lg(-728332094, -309956), lg(1756765281, 8058834) / lg(-26, -1))
    assertEquals(
      lg(10173004, 1227),
      lg(1762668787, -960735493) / lg(-782994, -1))
    assertEquals(
      lg(1157067129, 5766),
      lg(1523935530, -109345767) / lg(-18963, -1))
    assertEquals(
      lg(1226263794, 42306948),
      lg(-1256703941, 1438436241) / lg(34, 0))
    assertEquals(lg(1502167534, -439314), lg(-444491016, -6150392) / lg(14, 0))

    // big / int53
    assertEquals(
      lg(88399, 0),
      lg(-1883357942, 360257606) / lg(1478768728, 4075))
    assertEquals(
      lg(-45459, -1),
      lg(-1991900757, -48856999) / lg(-1087694619, 1074))
    assertEquals(lg(4395497, 0), lg(518426119, 218946975) / lg(-808940852, 49))
    assertEquals(
      lg(3198134, 0),
      lg(-946567777, 600381050) / lg(-1165957306, 187))
    ...
    assertEquals(
      lg(167728, 0),
      lg(1445602310, 420550818) / lg(1397186900, 2507))
    assertEquals(
      lg(25700177, 0),
      lg(1822058703, 522114268) / lg(1355449555, 20))
    assertEquals(
      lg(-35822646, -1),
      lg(532749659, -130990067) / lg(-1474774415, 3))
    assertEquals(lg(-348, -1), lg(1329707986, -2121642) / lg(-63366094, 6086))
    assertEquals(
      lg(-2179, -1),
      lg(1028585430, -118524228) / lg(1655878874, 54392))
    ...
    assertEquals(
      lg(-137450, -1),
      lg(-1910257093, -16610962) / lg(-640594227, 120))
    ...
    assertEquals(
      lg(-247360, -1),
      lg(-1958380469, -855713410) / lg(1631833189, 3459))
    ...
    assertEquals(
      lg(56005, 0),
      lg(1189085620, 611543209) / lg(1619962756, 10919))
    assertEquals(
      lg(-90057, -1),
      lg(-1072173311, -18503031) / lg(1971480267, 205))
    ...
    assertEquals(
      lg(-381407, -1),
      lg(-1756338345, -38928780) / lg(283612141, 102))
    assertEquals(lg(1217514, 0), lg(-495049835, 37161263) / lg(-2052025512, 30))
    assertEquals(
      lg(-17, -1),
      lg(1606509747, -10876159) / lg(1068727249, 635715))
    assertEquals(
      lg(4880327, 0),
      lg(-1857686692, 1918485655) / lg(454913535, 393))
    assertEquals(
      lg(-1023070, -1),
      lg(-502107392, -511268482) / lg(-1118977400, 499))
    ...
    assertEquals(
      lg(-5332527, -1),
      lg(1737846340, -614952982) / lg(1379175047, 115))
    assertEquals(
      lg(-435180, -1),
      lg(-406629212, -528407898) / lg(973577032, 1214))
    assertEquals(
      lg(27837, 0),
      lg(-597461306, 538945619) / lg(-1867966522, 19360))
    assertEquals(
      lg(-396, -1),
      lg(-1906945200, -371170760) / lg(151858506, 936902))
    assertEquals(
      lg(-115583279, -1),
      lg(-1366510, -207691415) / lg(-872314548, 1))
    assertEquals(
      lg(-6783543, -1),
      lg(-1280665444, -104856505) / lg(1964875665, 15))
    assertEquals(
      lg(-1464006069, -1),
      lg(897601097, -1352132581) / lg(-328204224, 0))
    ...
    assertEquals(
      lg(-230, -1),
      lg(1693350453, -4127304) / lg(-1671879801, 17931))
    assertEquals(lg(249094, 0), lg(-492682302, 64433722) / lg(-1408841594, 258))

    // big / big
    assertEquals(
      lg(-10, -1),
      lg(1450795502, -706709103) / lg(742056886, 64843937))
    assertEquals(lg(0, 0), lg(-392893244, 72026637) / lg(1419676270, 875736789))
    assertEquals(
      lg(-2, -1),
      lg(-1861146463, 8382761) / lg(-724412724, -3000735))
    assertEquals(
      lg(0, 0),
      lg(1373482238, 23344691) / lg(1835527248, -294342355))
    assertEquals(
      lg(-37, -1),
      lg(1956796392, 107480459) / lg(-560958184, -2839471))
    assertEquals(lg(3, 0), lg(422228275, 30436377) / lg(-2023395425, 8226201))
    assertEquals(
      lg(-3, -1),
      lg(1747624836, -215352612) / lg(-1349940168, 58723974))
    ...
    assertEquals(
      lg(5, 0),
      lg(1943726712, 869895175) / lg(-627430826, 169278540))
    assertEquals(lg(0, 0), lg(1872895982, 98966340) / lg(1347573135, 529034148))
    assertEquals(
      lg(-2, -1),
      lg(16010610, 187913494) / lg(-848952152, -81951424))
    assertEquals(lg(0, 0), lg(830929771, -4393252) / lg(1829525088, 52659897))
    assertEquals(
      lg(22, 0),
      lg(-2093526384, 133319293) / lg(-464927151, 6049576))
    assertEquals(
      lg(0, 0),
      lg(1056318793, 13467735) / lg(1970348162, -672507521))
    assertEquals(lg(0, 0), lg(-28853693, -169722715) / lg(-83877421, 770900857))
    assertEquals(
      lg(-27, -1),
      lg(1743854071, -302158995) / lg(80117835, 11113120))
    assertEquals(
      lg(-6, -1),
      lg(635796581, -146765250) / lg(441664676, 23716738))
    assertEquals(
      lg(0, 0),
      lg(-1048312948, -37662905) / lg(1319664078, 208772026))
    assertEquals(
      lg(0, 0),
      lg(-784292680, -14102823) / lg(2037268040, 744987722))
    assertEquals(
      lg(176, 0),
      lg(-1116104092, -2073525743) / lg(1766685765, -11731135))
    assertEquals(
      lg(0, 0),
      lg(-1991687284, 19448294) / lg(-1731357606, -202272807))
    assertEquals(lg(6, 0), lg(-2042068328, -52956481) / lg(370482897, -7759903))
    assertEquals(
      lg(1, 0),
      lg(334395247, 1906338595) / lg(342095090, 1248830168))
    assertEquals(
      lg(0, 0),
      lg(-309616588, 44123460) / lg(2040055580, -476494291))
    assertEquals(lg(0, 0), lg(137178123, 36336421) / lg(-360221107, -515689970))
    assertEquals(
      lg(0, 0),
      lg(-422856762, -16760844) / lg(-334268074, -43984484))
    assertEquals(lg(0, 0), lg(-24820293, 25823996) / lg(390711705, 288223876))
    assertEquals(
      lg(0, 0),
      lg(1170265006, 2998984) / lg(-134995170, -2123267074))
    assertEquals(
      lg(0, 0),
      lg(-1501380980, -6088910) / lg(-1175861016, -56027408))
    assertEquals(
      lg(-56, -1),
      lg(307880183, 196786483) / lg(-1107761890, -3480429))
    assertEquals(
      lg(0, 0),
      lg(-588606997, -37732967) / lg(-1124435958, -77404915))
    ...
    assertEquals(
      lg(0, 0),
      lg(1123427761, 55212863) / lg(-1081219733, 233090714))
    assertEquals(
      lg(0, 0),
      lg(1447869812, -3646400) / lg(-1237950546, -27122943))
    assertEquals(
      lg(-13, -1),
      lg(-1399920635, 110072031) / lg(-398678056, -8069387))
    ...
    assertEquals(
      lg(0, 0),
      lg(-1594024534, -144937584) / lg(177399758, 200473672))
    assertEquals(
      lg(-1, -1),
      lg(447753993, -23591908) / lg(1399162166, 12505918))
    assertEquals(lg(0, 0), lg(1500283330, 5361180) / lg(348398676, 156400271))
    assertEquals(
      lg(-1, -1),
      lg(-216115001, 670826068) / lg(1759253954, -470062110))
    assertEquals(
      lg(0, 0),
      lg(-1251659767, 18831569) / lg(-669341445, -34474821))
    assertEquals(lg(31, 0), lg(817032953, 218701872) / lg(-176557210, 6899121))
    assertEquals(
      lg(-19, -1),
      lg(1365998269, 613319842) / lg(319204438, -30758748))
    ...
    assertEquals(
      lg(-2, -1),
      lg(-769114167, 137614183) / lg(-929091402, -67103082))
  ...
  def modulo_%(): Unit = {
    ...
    assertEquals(
      lg(-267334310, -1),
      lg(-267334310, -1) % lg(1537718115, -134598983))
    ...
    assertEquals(
      lg(-20155233, -1),
      lg(-20155233, -1) % lg(-49989774, -25498857))
    ...
    assertEquals(
      lg(-25650126, -1),
      lg(-25650126, -1) % lg(-1317209725, -16141386))
    ...
    assertEquals(
      lg(-1160726496, -1),
      lg(-1160726496, -1) % lg(-913371934, -9441145))
    ...
    assertEquals(
      lg(-383633650, -1),
      lg(-383633650, -1) % lg(1609519787, 8262009))
    ...
    assertEquals(
      lg(-171009725, 445),
      lg(-171009725, 445) % lg(-1167557775, 307982))
    assertEquals(
      lg(8166883, 15498),
      lg(1848497503, 78519) % lg(1533824479, 15755))
    assertEquals(
      lg(-1752533311, 17),
      lg(-1752533311, 17) % lg(1904799096, 73566))
    assertEquals(
      lg(-1641266817, 46),
      lg(-1641266817, 46) % lg(-31936789, 751199))
    assertEquals(
      lg(-350685679, 656),
      lg(-637954451, 32352) % lg(-10259599, 1131))
    assertEquals(
      lg(-1671876486, 0),
      lg(-1657673170, 122149) % lg(-534342412, 0))
    assertEquals(
      lg(-660565679, 235),
      lg(-660565679, 235) % lg(-897090894, 14655))
    assertEquals(
      lg(-1798560222, 612),
      lg(-1798560222, 612) % lg(-236039758, 2924))
    assertEquals(
      lg(-28767936, 5704),
      lg(1010899296, 62798) % lg(-1974205776, 9515))
    ...
    assertEquals(
      lg(-1275175525, 44),
      lg(-1275175525, 44) % lg(162799342, 861329))
    assertEquals(
      lg(1187224322, 14),
      lg(-516916094, 191396) % lg(-1920802608, 30))
    assertEquals(lg(-1461747946, 0), lg(-1627551726, 4499) % lg(1200735793, 1))
    assertEquals(
      lg(453535447, 39039),
      lg(453535447, 39039) % lg(520791957, 141909))
    ...
    assertEquals(
      lg(-232837834, 5049),
      lg(-232837834, 5049) % lg(1000581509, 15836))
    ...
    assertEquals(
      lg(-2140209952, 7),
      lg(1535735456, 276446) % lg(-1930593680, 7))
    assertEquals(
      lg(-1703068243, 11),
      lg(2079501385, 97596) % lg(-1803771626, 21))
    assertEquals(
      lg(-1025858772, 33402),
      lg(286993796, 174379) % lg(656426284, 70488))
    assertEquals(
      lg(-578045904, 11724),
    ...
    assertEquals(
      lg(-1728890579, 468),
      lg(-559850131, 11989) % lg(1366001936, 2880))
    assertEquals(lg(1341547600, 13), lg(-1071198220, 2182) % lg(1526886260, 17))
    assertEquals(
      lg(-896451936, 45),
      lg(-896451936, 45) % lg(2132477227, 164356))
    assertEquals(
      lg(-1538011120, 53),
      lg(-561327714, 1420) % lg(-368698210, 151))
    assertEquals(
      lg(1880884956, 621),
      lg(2112956103, 118429) % lg(-374507565, 859))
    assertEquals(lg(902909663, 0), lg(380445410, 8) % lg(-1822479769, 1))
    assertEquals(
      lg(-652149100, 56),
      lg(-1867274924, 105813) % lg(175641312, 79))
    ...
    assertEquals(
      lg(-930109303, 3),
      lg(-930109303, 3) % lg(1606982787, 925386547))
    assertEquals(
      lg(-717668907, 16251),
      lg(-717668907, 16251) % lg(2079100937, 7825426))
    assertEquals(lg(265990345, 3), lg(265990345, 3) % lg(-1140922127, -3108870))
    assertEquals(
      lg(-1181318422, 1),
      lg(-1181318422, 1) % lg(1489652251, 75207246))
    assertEquals(
      lg(380276439, 59),
      lg(380276439, 59) % lg(-1062351234, -3631372))
    assertEquals(
      lg(1080382784, 7211),
      lg(1080382784, 7211) % lg(572850722, -139092025))
    assertEquals(
      lg(2020323378, 316),
      lg(2020323378, 316) % lg(1716930349, -16333391))
    assertEquals(
      lg(1302118364, 5),
      lg(1302118364, 5) % lg(-442067036, 1941456592))
    assertEquals(
      lg(-641137972, 602),
      lg(-641137972, 602) % lg(1134212295, -135713760))
    assertEquals(
      lg(-761172703, 499),
      lg(-761172703, 499) % lg(769981236, 12756336))
    assertEquals(
      lg(1601268090, 610),
      lg(1601268090, 610) % lg(448513898, -160887452))
    assertEquals(
      lg(-16483553, 0),
      lg(-16483553, 0) % lg(-1253549192, -1748027086))
    assertEquals(
      lg(-1284021361, 241),
      lg(-1284021361, 241) % lg(13275221, -3818882))
    assertEquals(
      lg(1499414278, 26),
      lg(1499414278, 26) % lg(570654893, -17498947))
    assertEquals(
      lg(-368610421, 5074),
      lg(-368610421, 5074) % lg(685701351, 31070898))
    assertEquals(
      lg(1200134796, 70),
      lg(1200134796, 70) % lg(1230376618, -2490370))
    assertEquals(
      lg(1537764087, 64483),
      lg(1537764087, 64483) % lg(-1252591472, 66761881))
    assertEquals(
      lg(-1981129198, 15),
      lg(-1981129198, 15) % lg(1937978150, 8201544))
    assertEquals(
      lg(32422964, 200),
      lg(32422964, 200) % lg(2051327691, -20319622))
    assertEquals(
      lg(1404616230, 30),
      lg(1404616230, 30) % lg(-748420073, -120320053))
    assertEquals(
      lg(-1860381107, 38),
      lg(-1860381107, 38) % lg(392948122, 60098039))
    assertEquals(
      lg(1050519262, 106431),
      lg(1050519262, 106431) % lg(361773491, -6329760))
    assertEquals(
      lg(460136491, 1681770),
      lg(460136491, 1681770) % lg(1399049044, 759923035))
    assertEquals(
      lg(2065599344, 11089),
      lg(2065599344, 11089) % lg(-465681057, 3484544))
    assertEquals(
      lg(1849358428, 418531),
      lg(1849358428, 418531) % lg(1023666326, 3435570))
    assertEquals(
      lg(1292603836, 80),
      lg(1292603836, 80) % lg(-1114872574, 250120091))
    assertEquals(
      lg(1456627133, 194844),
      lg(1456627133, 194844) % lg(-1256385160, 59427917))
    assertEquals(
      lg(-568179858, 160),
      lg(-568179858, 160) % lg(1142846538, 154324747))
    assertEquals(
      lg(-2133580755, 203337),
      lg(-2133580755, 203337) % lg(111334842, 12695612))
    assertEquals(
      lg(1961218705, 6687),
      lg(1961218705, 6687) % lg(-245612957, 134017780))
    assertEquals(
      lg(335350966, 55096),
      lg(335350966, 55096) % lg(-1815119598, -120983980))
    assertEquals(
      lg(-767561503, 211),
      lg(-767561503, 211) % lg(554589640, -7873602))
    assertEquals(
      lg(1476687067, 3767),
      lg(1476687067, 3767) % lg(552659809, -753378142))
    assertEquals(
      lg(-1107393223, 30),
      lg(-1107393223, 30) % lg(-78383575, -52663801))
    assertEquals(lg(607313614, 2), lg(607313614, 2) % lg(-234099925, 59184919))
    assertEquals(
      lg(-1542671184, 616882),
      lg(-1542671184, 616882) % lg(1370026838, -45628731))
    assertEquals(
      lg(525616384, 1001),
      lg(525616384, 1001) % lg(1995646126, -11226360))
    assertEquals(
      lg(2109958916, 21549),
      lg(2109958916, 21549) % lg(-419960245, -115959896))
    assertEquals(
      lg(-450913111, 32140),
      lg(-450913111, 32140) % lg(-99267096, -3640047))
    assertEquals(
      lg(1515870052, 198),
      lg(1515870052, 198) % lg(1415757861, -110282301))
    assertEquals(
      lg(124639649, 865615),
      lg(124639649, 865615) % lg(-1354782388, 2569606))
    assertEquals(
      lg(557119825, 7205),
      lg(557119825, 7205) % lg(683150209, -15864187))
    assertEquals(
      lg(992846513, 1385110),
      lg(992846513, 1385110) % lg(1578961851, -8380578))
    assertEquals(
      lg(1081385155, 4176),
      lg(1081385155, 4176) % lg(1892231070, 31130825))
    assertEquals(
      lg(-738492748, 8),
      lg(-738492748, 8) % lg(-431212066, 687916944))
    assertEquals(
      lg(-1448153936, 8101),
      lg(-1448153936, 8101) % lg(-584523654, -4814205))
    assertEquals(
      lg(-713251055, 243),
      lg(-713251055, 243) % lg(261411225, 31444708))
    assertEquals(
      lg(881178812, 47057),
      lg(881178812, 47057) % lg(823893049, -5940358))
    assertEquals(
      lg(-506817388, 0),
      lg(-506817388, 0) % lg(-465610822, 10559551))
    assertEquals(
      lg(-420315839, 112832),
    ...
    assertEquals(
      lg(-1699972, -1),
      lg(-1415791920, -26215621) % lg(-2142359, -1))
    ...
    assertEquals(
      lg(-137624717, -1),
      lg(-1766192560, -17443468) % lg(-168087095, -1))
    ...
    assertEquals(
      lg(586891857, 0),
      lg(-1012773943, 223943652) % lg(707359548, 0))
    assertEquals(lg(2, 0), lg(1097288344, 26740237) % lg(-3, -1))
    assertEquals(
      lg(-24053960, -1),
      lg(-1121404205, -87484234) % lg(80229261, 0))
    assertEquals(
      lg(-79944815, -1),
      lg(-1503637931, -163703901) % lg(-983334452, -1))
    ...
    assertEquals(
      lg(1057995305, 4748),
      lg(2008672965, 41566313) % lg(313991275, 18390))
    assertEquals(
      lg(-1074209653, 18),
      lg(1922552561, 28139870) % lg(-2083633557, 19))
    assertEquals(
      lg(1480601143, -11310),
      lg(843627074, -173776705) % lg(1451117493, 14364))
    assertEquals(
      lg(-691687452, -38),
      lg(204865470, -6692402) % lg(-645190286, 413))
    assertEquals(
      lg(-1218791457, -31),
      lg(952830559, -214594684) % lg(-1778162360, 378))
    assertEquals(
      lg(-281609960, -1292),
      lg(1673740333, -69274846) % lg(-1549261605, 2390))
    assertEquals(
      lg(-860426348, 1),
      lg(-1276804811, 367022678) % lg(-678111623, 11))
    assertEquals(
      lg(-1244563205, -1264),
    ...
    assertEquals(
      lg(85696931, 194),
      lg(108363299, 1224097478) % lg(1137551776, 281))
    assertEquals(
      lg(-385517902, -5258),
      lg(-1965834834, -11053948) % lg(-942300324, 6487))
    assertEquals(
      lg(-755355475, 2268),
      lg(-3151939, 171473802) % lg(-2071379940, 3914))
    assertEquals(
      lg(-676865399, -663),
    ...
    assertEquals(
      lg(1210119082, -104892),
      lg(-525597278, -3790314) % lg(2133284776, 127083))
    assertEquals(
      lg(473810731, -5),
      lg(-393124913, -28106221) % lg(958070140, 159))
    assertEquals(
      lg(-1912903061, 25777),
      lg(6929245, 2749730) % lg(1462129294, 43237))
    assertEquals(
      lg(1099532724, -19),
      lg(708024745, -15568245) % lg(1288198049, 56))
    assertEquals(
      lg(920504149, 6836),
      lg(487601139, 13603229) % lg(723875593, 45021))
    assertEquals(
      lg(1778080723, 29),
      lg(-2070321133, 115478389) % lg(-1799479616, 75))
    assertEquals(
      lg(-720480381, 2735),
      lg(-307180735, 3049800) % lg(1043781053, 3319))
    assertEquals(
      lg(1473972065, -1),
      lg(-1073877839, -6538577) % lg(-1408649838, 0))
    assertEquals(
      lg(-1389255096, -200),
      lg(-1892822171, -1698321438) % lg(96164237, 514))
    assertEquals(
      lg(857386403, 29656),
      lg(-674980011, 2764943) % lg(-445529419, 65125))
    assertEquals(
      lg(-419043446, -22164),
    ...
    assertEquals(
      lg(2127427912, 6),
      lg(208769744, 280071599) % lg(-325433064, 14))
    assertEquals(
      lg(-722136158, -1),
      lg(-1527711901, -51564742) % lg(-1019145455, 0))
    assertEquals(
      lg(-1603688570, -2),
      lg(-159182038, -2145592347) % lg(-483720705, 15))
    assertEquals(
      lg(-256578646, 177817),
    ...
    assertEquals(
      lg(251450065, 19154),
      lg(-822280387, 44882065) % lg(-940828508, 22947))
    assertEquals(
      lg(1310986115, 209),
      lg(1465101985, 269803551) % lg(-1953360551, 334))
    assertEquals(
      lg(1436855439, -5),
      lg(-567675197, -8838663) % lg(1903221047, 6))
    assertEquals(
      lg(296887390, -17),
      lg(689376065, -22622471) % lg(1534988921, 63))
    assertEquals(
      lg(1577958450, -39),
      lg(-2017356377, -57717216) % lg(-1390284125, 42))
    assertEquals(
      lg(661387374, 344542),
...
class RuntimeLongOldTest {
  ...
  @Test
  def should_correctly_implement_negation(): Unit = {
  ...
  @Test
  def should_correctly_implement_comparison(): Unit = {
  ...
  @Test
  def should_correctly_implement_addition(): Unit = {
  ...
  @Test
  def should_correctly_implement_subtraction(): Unit = {
    assertHexEquals("fffffffffffffff8", fromInt(7) - fromInt(15))
    assertHexEquals("0", maxInt - maxInt)
  }

  @Test
  def should_correctly_implement_multiplication(): Unit = {
  ...
  @Test
  def should_correctly_implement_division(): Unit = {
  ...
  @Test
  def should_correctly_implement_modulus(): Unit = {
  ...
  @Test
  def should_correctly_implement_toString(): Unit = {
  ...
  @Test
  def should_correctly_implement_fromDouble(): Unit = {
  ...
  @Test
  def should_correctly_implement_numberOfLeadingZeros(): Unit = {
  ...
  @Test
  def should_implement_hashCode_according_to_spec_in_j_l_Long(): Unit = {
