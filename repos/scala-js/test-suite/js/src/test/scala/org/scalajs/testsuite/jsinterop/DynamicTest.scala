...
class DynamicTest {
  ...
  implicit def dyn2Bool(dyn: js.Dynamic): Boolean = dyn.asInstanceOf[Boolean]

  implicit def dyn2Int(dyn: js.Dynamic): Int = dyn.asInstanceOf[Int]

  implicit def dyn2AnyRef(dyn: js.Dynamic): AnyRef = dyn.asInstanceOf[AnyRef]
  ...
  @Test
  def should_allow_to_call_functions_with_arguments_named_x(): Unit = {
    class A {
      def a: Int = 1
    }
  ...
  def should_allow_instantiating_JS_classes_dynamically_with_varargs_issue_708()
    ...
    val obj2 = js.Dynamic
      .newInstance(DynamicTestClassVarArgs)("Scala.js", 42, true)
  ...
  @Test
  def should_provide_an_object_literal_construction(): Unit = {
    ...
    val y = obj(inner = obj(name = "inner obj"), fun = { () => 42 })
  ...
  @Test
  def object_literal_in_statement_position_issue_1627(): Unit = {
  ...
  @Test
  def should_properly_encode_object_literal_property_names(): Unit = {
    import js.Dynamic.{literal => obj}
