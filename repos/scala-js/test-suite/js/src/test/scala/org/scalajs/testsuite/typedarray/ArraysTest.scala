...
class ArraysTest extends javalib.util.ArraysTest {
  ...
  override def Array[T: ClassTag](v: T*): scala.Array[T] =
    classTag[T] match {
      case ClassTag.Byte => new Int8Array(v.asInstanceOf[Seq[Byte]].toJSArray)
          .toArray.asInstanceOf[scala.Array[T]]
      case ClassTag.Short =>
        new Int16Array(v.asInstanceOf[Seq[Short]].toJSArray).toArray
          .asInstanceOf[scala.Array[T]]
      case ClassTag.Int => new Int32Array(v.asInstanceOf[Seq[Int]].toJSArray)
          .toArray.asInstanceOf[scala.Array[T]]
      case ClassTag.Float =>
        new Float32Array(v.asInstanceOf[Seq[Float]].toJSArray).toArray
          .asInstanceOf[scala.Array[T]]
