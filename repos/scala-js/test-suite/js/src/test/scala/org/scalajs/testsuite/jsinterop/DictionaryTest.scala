...
class DictionaryTest {
  ...
  @Test def should_provide_an_equivalent_of_the_JS_delete_keyword_issue_255()
      : Unit = {
  ...
  @Test def should_behave_as_specified_when_deleting_a_non_configurable_property_issue_461_issue_679()
      : Unit = {
