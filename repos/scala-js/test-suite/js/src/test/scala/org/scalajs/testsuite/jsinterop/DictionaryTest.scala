...
class DictionaryTest {
  ...
  @Test
  def `-=_should_ignore_deleting_a_non_existent_key`(): Unit = {
    val obj = js.Dictionary("a" -> "A")
    obj -= "b"
  }

  @Test
  def should_treat_delete_as_a_statement_issue_907(): Unit = {
    val obj = js.Dictionary("a" -> "A")
    obj.delete("a")
  }

  @Test
  def should_provide_keys(): Unit = {
  ...
  @Test
  def should_survive_the_key_hasOwnProperty_issue_1414(): Unit = {
    val obj = js.Dictionary.empty[Int]
  ...
  @Test
  def should_provide_an_iterator(): Unit = {
  ...
  @Test
  def should_desugar_arguments_to_delete_statements_issue_908(): Unit = {
  ...
  @Test
  def should_provide_toJSDictionary(): Unit = {
