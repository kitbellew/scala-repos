...
object Math {
  ...
  @inline
  def abs(a: scala.Int): scala.Int = if (a < 0) -a else a
  @inline
  def abs(a: scala.Long): scala.Long = if (a < 0) -a else a
  @inline
  ...
  @inline
  def max(a: scala.Int, b: scala.Int): scala.Int = if (a > b) a else b
  @inline
  def max(a: scala.Long, b: scala.Long): scala.Long = if (a > b) a else b
  @inline
  ...
  @inline
  def min(a: scala.Int, b: scala.Int): scala.Int = if (a < b) a else b
  @inline
  def min(a: scala.Long, b: scala.Long): scala.Long = if (a < b) a else b
  @inline
  ...
  def rint(a: scala.Double): scala.Double = {
    ...
    if (mod == 0.5 || mod == -0.5) {
      ...
      if (rounded % 2.0 == 0.0) rounded else rounded - 1.0
    } else { rounded }
  }
  ...
  def signum(a: scala.Double): scala.Double = {
    if (a > 0) 1.0 else if (a < 0) -1.0 else a
  }

  @inline
  def signum(a: scala.Float): scala.Float = {
    if (a > 0) 1.0f else if (a < 0) -1.0f else a
  }
  ...
  def nextUp(a: scala.Double): scala.Double = {
    ...
    if (a != a || a == PositiveInfinity) a
    else if (a == NegativeInfinity) MinValue
  ...
  def hypot(a: scala.Double, b: scala.Double): scala.Double = {
    ...
    if (abs(a) == scala.Double.PositiveInfinity || abs(b) == scala.Double
          .PositiveInfinity) scala.Double.PositiveInfinity
    else if (a.isNaN || b.isNaN) scala.Double.NaN
    else if (a == 0 && b == 0) 0.0
    else {
  ...
  def multiplyExact(a: scala.Int, b: scala.Int): scala.Int = {
    ...
    if (!overflow) a * b else throw new ArithmeticException("Integer overflow")
  }

  def multiplyExact(a: scala.Long, b: scala.Long): scala.Long = {
    val overflow = {
      if (b > 0) a > Long.MAX_VALUE / b || a < Long.MIN_VALUE / b
      else if (b < -1) a > Long.MIN_VALUE / b || a < Long.MAX_VALUE / b
      else if (b == -1) a == Long.MIN_VALUE
      else false
    }
    if (!overflow) a * b else throw new ArithmeticException("Long overflow")
  }
  ...
  def floorDiv(a: scala.Int, b: scala.Int): scala.Int = {
    val quot = a / b
    if ((a < 0) == (b < 0) || quot * b == a) quot else quot - 1
  }
  ...
  def floorMod(a: scala.Int, b: scala.Int): scala.Int = {
    val rem = a % b
    if ((a < 0) == (b < 0) || rem == 0) rem else rem + b
  }
