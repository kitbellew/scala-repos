...
class TaskIdTest extends FunSuite with Matchers {
  ...
  test("Old TaskIds can be converted") {
    val taskId = Task.Id(
      TaskID.newBuilder().setValue(
        "app_682ebe64-0771-11e4-b05d-e0f84720c54e").build)
