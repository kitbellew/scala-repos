...
object IntervalSeqSampleCheck extends Properties("IntervalSeq.Sample") {
  ...
  def trinarySampleTest(
    ...
    support.forall { value =>
      val sameBefore = r
        .below(value) === op(a.below(value), b.below(value), c.below(value))
      val sameAt = r.at(value) === op(a.at(value), b.at(value), c.at(value))
      val sameAfter = r
        .above(value) === op(a.above(value), b.above(value), c.above(value))
      sameBefore & sameAt & sameAfter
    }
  }
  ...
  property("hull") = forAll { a: IntervalSeq[Int] =>
    ...
    val allInside = a
      .intervals
      .forall(i => hullSet.isSupersetOf(IntervalSeq(i)))
  ...
  /**
    ...
    */
  property("intersects/intersection") = forAll {
    (a: IntervalSeq[Int], b: IntervalSeq[Int]) =>
