...
class BitStringTest extends SpireTests {
  ...
  test("BitString[Byte]") {
    ...
    testCases(
      I(b"0", 0, b"0", b"0", 8, 8) :: I(b"7", 3, b"4", b"1", 5, 0) ::
        I(b"62", 5, b"32", b"2", 2, 1) :: I(b"127", 7, b"64", b"1", 1, 0) ::
        I(b"-128", 1, b"-128", b"-128", 0, 7) ::
        I(b"-1", 8, b"-128", b"1", 0, 0) :: Nil)
  }

  test("BitString[Short]") {
    import spire.syntax.literals._
    testCases(
      I(h"0", 0, h"0", h"0", 16, 16) :: I(h"7", 3, h"4", h"1", 13, 0) ::
        I(h"62", 5, h"32", h"2", 10, 1) :: I(h"127", 7, h"64", h"1", 9, 0) ::
        ...
        I(h"-1", 16, h"32768", h"1", 0, 0) :: Nil)
  }

  test("BitString[Int]") {
    testCases(
      I(0, 0, 0, 0, 32, 32) :: I(7, 3, 4, 1, 29, 0) :: I(62, 5, 32, 2, 26, 1) ::
        I(127, 7, 64, 1, 25, 0) :: I(128, 1, 128, 128, 24, 7) ::
        I(255, 8, 128, 1, 24, 0) :: I(256, 1, 256, 256, 23, 8) ::
        I(23985, 9, 16384, 1, 17, 0) :: I(32767, 15, 16384, 1, 17, 0) ::
        I(65535, 16, 32768, 1, 16, 0) :: I(65535, 16, 32768, 1, 16, 0) ::
        I(293859800, 14, 268435456, 8, 3, 3) ::
        I(2147483647, 31, 1073741824, 1, 1, 0) ::
        I(-2147483648, 1, -2147483648, -2147483648, 0, 31) ::
        I(-1, 32, -2147483648, 1, 0, 0) :: Nil)
  }

  test("BitString[Long]") {
    testCases(
      I(0L, 0, 0L, 0L, 64, 64) :: I(7L, 3, 4L, 1L, 61, 0) ::
        I(62L, 5, 32L, 2L, 58, 1) :: I(127L, 7, 64L, 1L, 57, 0) ::
        I(128L, 1, 128L, 128L, 56, 7) :: I(255L, 8, 128L, 1L, 56, 0) ::
        I(256L, 1, 256L, 256L, 55, 8) :: I(23985L, 9, 16384L, 1L, 49, 0) ::
        I(32767L, 15, 16384L, 1L, 49, 0) :: I(65535L, 16, 32768L, 1L, 48, 0) ::
        ...
        I(4294967295L, 32, 2147483648L, 1L, 32, 0) :: Nil)
  }
...
class BitStringCheck extends SpireProperties {
  property("operator mappings") {
    ...
    forAll { (n: Byte, i: Int) => byOp(n, i) shouldBe byName(n, i) }
  }
}
