...
class PowBenchmarks extends MyBenchmark {
  ...
  def timeLongPowForInt(reps: Int) =
    run(reps) {
      var t = 0
      ints.foreach { n =>
  ...
  def timeDoublePowForInt(reps: Int) =
    run(reps) {
      var t = 0
      ints.foreach { n =>
  ...
  def timeBigIntPowForInt(reps: Int) =
    run(reps) {
      var t = 0
      ints.foreach { n =>
  ...
  def timeLongPowForLong(reps: Int) =
    run(reps) {
      var t = 0L
      longs.foreach { n =>
  ...
  def timeDoublePowForLong(reps: Int) =
    run(reps) {
      var t = 0L
      longs.foreach { n =>
  ...
  def timeBigIntPowForLong(reps: Int) =
    run(reps) {
      var t = 0L
      longs.foreach { n =>
  ...
  def timeDoublePowForDouble(reps: Int) =
    run(reps) {
      var t = 0.0
      longs.foreach { n =>
