...
final case class WriterT[F[_], W, A](run: F[(W, A)]) { self =>
  ...
  def mapValue[X, B](f: ((W, A)) => (X, B))(implicit
      F: Functor[F]): WriterT[F, X, B] =
    writerT(F.map(run)(f))
  ...
  def bimap[C, D](f: W => C, g: A => D)(implicit F: Functor[F]) =
    writerT[F, C, D](F.map(run)({ case (a, b) =>
      (f(a), g(b))
    }))
  ...
  def wpoint[G[_]](implicit
    ...
    writerT(F.map(self.run) { case (w, a) =>
      (P.point(w), a)
    })
...
sealed abstract class WriterTInstances14 extends WriterTInstances15 {
  ...
  implicit def writerTPlusEmpty[F[_], W](implicit
      F0: PlusEmpty[F]): PlusEmpty[WriterT[F, W, ?]] =
...
sealed abstract class WriterTInstances13 extends WriterTInstances14 {
  implicit def writerTFunctor[F[_], W](implicit
      F0: Functor[F]): Functor[WriterT[F, W, ?]] =
...
sealed abstract class WriterTInstances11 extends WriterTInstances12 {
  implicit def writerBindRec[W](implicit
      W0: Semigroup[W]): BindRec[Writer[W, ?]] =
...
sealed abstract class WriterTInstances10 extends WriterTInstances11 {
  implicit def writerTApply[F[_], W](implicit
      W0: Semigroup[W],
...
sealed abstract class WriterTInstances9 extends WriterTInstances10 {
  implicit def writerTBind[F[_], W](implicit
      W0: Semigroup[W],
...
sealed abstract class WriterTInstances8 extends WriterTInstances9 {
  implicit def writerTApplicative[F[_], W](implicit
      W0: Monoid[W],
      F0: Applicative[F]): Applicative[WriterT[F, W, ?]] =
...
sealed abstract class WriterTInstances7 extends WriterTInstances8 {
  implicit def writerTBindRec[F[_], W](implicit
      W0: Semigroup[W],
      F0: BindRec[F],
      F1: Applicative[F]): BindRec[WriterT[F, W, ?]] =
...
sealed abstract class WriterTInstance5 extends WriterTInstances6 {
  implicit def writerTMonad[F[_], W](implicit
      W0: Monoid[W],
...
sealed abstract class WriterTInstances4 extends WriterTInstance5 {
  ...
  implicit def writerEqual[W, A](implicit
      E: Equal[(W, A)]): Equal[Writer[W, A]] =
    E.contramap((_: Writer[W, A]).run)

  implicit def writerTMonadError[F[_], E, W](implicit
      F0: MonadError[F, E],
      W0: Monoid[W]): MonadError[WriterT[F, W, ?], E] =
...
sealed abstract class WriterTInstances0 extends WriterTInstances1 {
  implicit def writerTBitraverse[F[_]](implicit
      F0: Traverse[F]): Bitraverse[WriterT[F, ?, ?]] =
    new WriterTBitraverse[F] {
      implicit def F = F0
    }
  implicit def writerTTraverse[F[_], W](implicit
      F0: Traverse[F]): Traverse[WriterT[F, W, ?]] =
...
sealed abstract class WriterTInstances extends WriterTInstances0 {
  implicit def writerTMonadListen[F[_], W](implicit
      F0: Monad[F],
  ...
  implicit def writerTHoist[W](implicit
      W0: Monoid[W]): Hoist[λ[(α[_], β) => WriterT[α, W, β]]] =
    new WriterTHoist[W] {
      implicit def W = W0
    }

  implicit def writerTShow[F[_], W, A](implicit
      F0: Show[F[(W, A)]]): Show[WriterT[F, W, A]] =
...
trait WriterTFunctions {
  ...
  def put[F[_], W, A](value: F[A])(w: W)(implicit
      F: Functor[F]): WriterT[F, W, A] =
  ...
  def putWith[F[_], W, A](value: F[A])(w: A => W)(implicit
      F: Functor[F]): WriterT[F, W, A] =
...
private trait WriterTApply[F[_], W]
  ...
  override def ap[A, B](fa: => WriterT[F, W, A])(f: => WriterT[F, W, A => B]) =
    fa ap f
}
...
private trait WriterTBind[F[_], W]
  ...
  override final def bind[A, B](fa: WriterT[F, W, A])(
      f: A => WriterT[F, W, B]) = fa flatMap f
}
...
private trait WriterTFoldable[F[_], W]
    extends Foldable.FromFoldr[WriterT[F, W, ?]] {
  implicit def F: Foldable[F]

  override def foldRight[A, B](fa: WriterT[F, W, A], z: => B)(
      f: (A, => B) => B) = fa.foldRight(z)(f)
}
...
private trait WriterTHoist[W] extends Hoist[λ[(α[_], β) => WriterT[α, W, β]]] {
  ...
  implicit def apply[M[_]: Monad]: Monad[WriterT[M, W, ?]] =
