...
sealed abstract class LazyTuple2Instances0 {
  ...
  implicit def lazyTuple2Semigroup[A1, A2](implicit
      A1: Semigroup[A1],
      A2: Semigroup[A2]): Semigroup[LazyTuple2[A1, A2]] =
  ...
  implicit val lazyTuple2Associative: Associative[LazyTuple2] =
    new Associative[LazyTuple2] {
      def reassociateLeft[A, B, C](
          f: LazyTuple2[A, LazyTuple2[B, C]]): LazyTuple2[LazyTuple2[A, B], C] =
        LazyTuple2(LazyTuple2(f._1, f._2._1), f._2._2)
      def reassociateRight[A, B, C](
          f: LazyTuple2[LazyTuple2[A, B], C]): LazyTuple2[A, LazyTuple2[B, C]] =
...
sealed abstract class LazyTuple2Instances extends LazyTuple2Instances0 {
  ...
  implicit def lazyTuple2Show[A1, A2](implicit
      A1: Show[A1],
  ...
  implicit def lazyTuple2Order[A1, A2](implicit
      A1: Order[A1],
  ...
  implicit def lazyTuple2Monoid[A1, A2](implicit
      A1: Monoid[A1],
  ...
  implicit def lazyTuple2Monad[A1](
      implicit A1: Monoid[A1]): Monad[LazyTuple2[A1, ?]] =
...
sealed abstract class LazyTuple3Instances0 {
  implicit def lazyTuple3Semigroup[A1, A2, A3](implicit
      A1: Semigroup[A1],
      A2: Semigroup[A2],
      A3: Semigroup[A3]): Semigroup[LazyTuple3[A1, A2, A3]] =
  ...
  implicit def lazyTuple3Equal[A1, A2, A3](implicit
      A1: Equal[A1],
      A2: Equal[A2],
      A3: Equal[A3]): Equal[LazyTuple3[A1, A2, A3]] =
...
sealed abstract class LazyTuple3Instances extends LazyTuple3Instances0 {
  ...
  implicit def lazyTuple3Show[A1, A2, A3](implicit
      A1: Show[A1],
      A2: Show[A2],
      A3: Show[A3]): Show[LazyTuple3[A1, A2, A3]] =
  ...
  implicit def lazyTuple3Order[A1, A2, A3](implicit
      A1: Order[A1],
      A2: Order[A2],
      A3: Order[A3]): Order[LazyTuple3[A1, A2, A3]] =
  ...
  implicit def lazyTuple3Monoid[A1, A2, A3](implicit
      A1: Monoid[A1],
      A2: Monoid[A2],
      A3: Monoid[A3]): Monoid[LazyTuple3[A1, A2, A3]] =
  ...
  implicit def lazyTuple3Monad[A1, A2](implicit
      A1: Monoid[A1],
...
sealed abstract class LazyTuple4Instances0 {
  implicit def lazyTuple4Semigroup[A1, A2, A3, A4](implicit
      A1: Semigroup[A1],
      A2: Semigroup[A2],
      A3: Semigroup[A3],
      A4: Semigroup[A4]): Semigroup[LazyTuple4[A1, A2, A3, A4]] =
  ...
  implicit def lazyTuple4Equal[A1, A2, A3, A4](implicit
      ...
      A2: Equal[A2],
      A3: Equal[A3],
      A4: Equal[A4]): Equal[LazyTuple4[A1, A2, A3, A4]] =
...
sealed abstract class LazyTuple4Instances extends LazyTuple4Instances0 {
  ...
  implicit def lazyTuple4Show[A1, A2, A3, A4](implicit
      A1: Show[A1],
      A2: Show[A2],
      A3: Show[A3],
      A4: Show[A4]): Show[LazyTuple4[A1, A2, A3, A4]] =
  ...
  implicit def lazyTuple4Order[A1, A2, A3, A4](implicit
      A1: Order[A1],
      A2: Order[A2],
      A3: Order[A3],
      A4: Order[A4]): Order[LazyTuple4[A1, A2, A3, A4]] =
  ...
  implicit def lazyTuple4Monoid[A1, A2, A3, A4](implicit
      A1: Monoid[A1],
      A2: Monoid[A2],
      A3: Monoid[A3],
      A4: Monoid[A4]): Monoid[LazyTuple4[A1, A2, A3, A4]] =
  ...
  implicit def lazyTuple4Monad[A1, A2, A3](implicit
      A1: Monoid[A1],
      A2: Monoid[A2],
      A3: Monoid[A3]): Monad[LazyTuple4[A1, A2, A3, ?]] =
...
private trait LazyTuple4Functor[A1, A2, A3]
    extends Functor[LazyTuple4[A1, A2, A3, ?]] {
...
private trait LazyTuple2Semigroup[A1, A2]
...
private trait LazyTuple4Semigroup[A1, A2, A3, A4]
    extends Semigroup[LazyTuple4[A1, A2, A3, A4]] {
  implicit def _1: Semigroup[A1]
  implicit def _2: Semigroup[A2]
  implicit def _3: Semigroup[A3]
...
private trait LazyTuple3Equal[A1, A2, A3]
    extends Equal[LazyTuple3[A1, A2, A3]] {
  implicit def _1: Equal[A1]
  implicit def _2: Equal[A2]
...
private trait LazyTuple4Equal[A1, A2, A3, A4]
    extends Equal[LazyTuple4[A1, A2, A3, A4]] {
  implicit def _1: Equal[A1]
  implicit def _2: Equal[A2]
  implicit def _3: Equal[A3]
  ...
  override def equal(
    ...
    _1.equal(f1._1, f2._1) && _2.equal(f1._2, f2._2) && _3.equal(f1._3, f2._3) && _4
      .equal(f1._4, f2._4)
}
...
private trait LazyTuple4Show[A1, A2, A3, A4]
    extends Show[LazyTuple4[A1, A2, A3, A4]] {
  implicit def _1: Show[A1]
  implicit def _2: Show[A2]
  implicit def _3: Show[A3]
...
private trait LazyTuple4Order[A1, A2, A3, A4]
    extends Order[LazyTuple4[A1, A2, A3, A4]]
    with LazyTuple4Equal[A1, A2, A3, A4] {
  implicit def _1: Order[A1]
  implicit def _2: Order[A2]
  implicit def _3: Order[A3]
...
private trait LazyTuple3Monoid[A1, A2, A3]
    extends Monoid[LazyTuple3[A1, A2, A3]]
    with LazyTuple3Semigroup[A1, A2, A3] {
  implicit def _1: Monoid[A1]
  implicit def _2: Monoid[A2]
  implicit def _3: Monoid[A3]
  def zero: LazyTuple3[A1, A2, A3] = LazyTuple3(_1.zero, _2.zero, _3.zero)
}
private trait LazyTuple4Monoid[A1, A2, A3, A4]
    extends Monoid[LazyTuple4[A1, A2, A3, A4]]
    with LazyTuple4Semigroup[A1, A2, A3, A4] {
  implicit def _1: Monoid[A1]
  implicit def _2: Monoid[A2]
  implicit def _3: Monoid[A3]
  implicit def _4: Monoid[A4]
  def zero: LazyTuple4[A1, A2, A3, A4] =
    LazyTuple4(_1.zero, _2.zero, _3.zero, _4.zero)
}
...
private trait LazyTuple4Monad[A1, A2, A3]
    extends Monad[LazyTuple4[A1, A2, A3, ?]]
    with LazyTuple4Functor[A1, A2, A3] {
  implicit def _1: Monoid[A1]
  implicit def _2: Monoid[A2]
  implicit def _3: Monoid[A3]
  def bind[A, B](fa: LazyTuple4[A1, A2, A3, A])(
