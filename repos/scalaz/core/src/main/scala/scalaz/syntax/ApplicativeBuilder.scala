...
private[scalaz] trait ApplicativeBuilder[M[_], A, B] {
  ...
  sealed abstract class ApplicativeBuilder3[C] {
    ...
    def apply[D](f: (A, B, C) => D)(implicit ap: Apply[M]): M[D] =
      ap.apply3(a, b, c)(f)
    ...
    sealed abstract class ApplicativeBuilder4[D] {
      ...
      def apply[E](f: (A, B, C, D) => E)(implicit ap: Apply[M]): M[E] =
        ap.apply4(a, b, c, d)(f)
      ...
      sealed abstract class ApplicativeBuilder5[E] {
        ...
        def apply[F](f: (A, B, C, D, E) => F)(implicit ap: Apply[M]): M[F] =
          ap.apply5(a, b, c, d, e)(f)

        def tupled(implicit ap: Apply[M]): M[(A, B, C, D, E)] = apply(
          Tuple5.apply)
        ...
        sealed abstract class ApplicativeBuilder6[F] {
          ...
          def apply[G](f: (A, B, C, D, E, F) => G)(implicit
              ap: Apply[M]): M[G] = ap.apply6(a, b, c, d, e, ff)(f)

          def tupled(implicit ap: Apply[M]): M[(A, B, C, D, E, F)] = apply(
            Tuple6.apply)
          ...
          sealed abstract class ApplicativeBuilder7[G] {
            ...
            def apply[H](f: (A, B, C, D, E, F, G) => H)(implicit
                ap: Apply[M]): M[H] = ap.apply7(a, b, c, d, e, ff, g)(f)

            def tupled(implicit ap: Apply[M]): M[(A, B, C, D, E, F, G)] = apply(
              Tuple7.apply)
            ...
            sealed abstract class ApplicativeBuilder8[H] {
              ...
              def apply[I](f: (A, B, C, D, E, F, G, H) => I)(implicit
                  ap: Apply[M]): M[I] = ap.apply8(a, b, c, d, e, ff, g, h)(f)
              ...
              sealed abstract class ApplicativeBuilder9[I] {
                ...
                def apply[J](f: (A, B, C, D, E, F, G, H, I) => J)(implicit
                    ap: Apply[M]): M[J] =
                  ap.apply9(a, b, c, d, e, ff, g, h, i)(f)

                def tupled(implicit
                    ap: Apply[M]): M[(A, B, C, D, E, F, G, H, I)] = apply(
                  Tuple9.apply)
                ...
                sealed abstract class ApplicativeBuilder10[J] {
                  ...
                  def apply[K](f: (A, B, C, D, E, F, G, H, I, J) => K)(implicit
                      ap: Apply[M]): M[K] =
                    ap.apply10(a, b, c, d, e, ff, g, h, i, j)(f)

                  def tupled(implicit
                      ap: Apply[M]): M[(A, B, C, D, E, F, G, H, I, J)] = apply(
                    Tuple10.apply)
                  ...
                  sealed abstract class ApplicativeBuilder11[K] {
                    ...
                    def apply[L](f: (A, B, C, D, E, F, G, H, I, J, K) => L)(
