...
sealed abstract class Unapply_5 {
  ...
  implicit def unapplyMFABCDE5[
      ...
      D0,
      E0](implicit
      TC0: TC[M0[F, A0, B0, C0, D0, ?]]): Unapply[TC, M0[F, A0, B0, C0, D0, E0]] {
...
sealed abstract class Unapply_3 extends Unapply_4 {
  ...
  implicit def unapplyMFABC1and2[TC[_[_]], F[_], M0[F[_], _, _, _], A0, B0](
      implicit TC0: TC[λ[α => M0[F, α, α, B0]]]): Unapply[TC, M0[F, A0, A0, B0]] {
...
sealed abstract class Unapply_1 extends Unapply_2 {
  ...
  implicit def unapplyMABCDEFG7[
      ...
      E0,
      F0,
      G0](implicit TC0: TC[M0[A0, B0, C0, D0, E0, F0, ?]])
  ...
  implicit def unapplyMABCDEF6[
      ...
      E0,
      F0](implicit
      TC0: TC[M0[A0, B0, C0, D0, E0, ?]]): Unapply[TC, M0[A0, B0, C0, D0, E0, F0]] {
...
object Unapply21 {
  ...
  implicit def unapply210MFABC[
      ...
      A0,
      B0,
      C](implicit TC0: TC[λ[(α, β) => M0[F[α, ?], C, β]], A0])
