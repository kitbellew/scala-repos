...
object IListTest extends SpecLite {
  ...
  "intercalate is same as a.intersperse(b).flatten" !
    forAll { (a: IList[IList[Int]], b: IList[Int]) =>
  ...
  "count" !
    forAll { (ns: IList[Int], p: Int => Boolean) =>
  ...
  "dropRightWhile" !
    forAll { (ns: IList[Int], p: Int => Boolean) =>
      ns.dropRightWhile(p).toList must_===
        ns.toList.reverse.dropWhile(p).reverse
    }
  ...
  "filterNot" !
    forAll { (ns: IList[Int], f: Int => Boolean) =>
  ...
  "interleave" !
    forAll { (xs: IList[Int], ys: IList[Int]) =>
  ...
  "patch" !
    forAll { (ns: IList[Int], a: Int, ms: IList[Int], b: Int) =>
  ...
  "reduceLeftOption" !
    forAll { (ns: IList[Int], f: (Int, Int) => Int) =>
  ...
  "scanLeft" !
    forAll { (ss: IList[String], f: (Int, String) => Int) =>
  ...
  "scanRight" !
    forAll { (ss: IList[String], f: (String, Int) => Int) =>
  ...
  "slice" !
    forAll { (ns: IList[Int], a: Int, b: Int) =>
      ns.slice(a, b).toList must_=== ns.toList.slice(a, b)
    }

  "sortBy" !
    forAll { (ss: IList[String], f: String => Int) =>
      ss.sortBy(f).toList must_=== ss.toList.sortBy(f)
    }

  "sorted" !
    forAll { (ss: IList[String]) =>
  ...
  "takeRightWhile" !
    forAll { (ns: IList[Int], f: Int => Boolean) =>
      ns.takeRightWhile(f).toList must_===
        ns.toList.reverse.takeWhile(f).reverse
    }
  ...
  "updated" !
    forAll { (ns: IList[Int], i: Int, n: Int) =>
      if (i < 0 || i >= ns.length) {
