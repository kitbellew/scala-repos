...
object ApplyTest extends SpecLite {
  ...
  "mapN" in {
    ...
    Apply[Option].apply3(some("1"), some("2"), some("3"))(_ + _ + _) must_=== (some(
      "123"))
  ...
  "apN" in {
    Apply[Option].ap2(some("1"), some("2"))(some((_: String) + (_: String))) must_=== (some(
      "12"))
    ...
    Apply[Option].ap5(some("1"), some("2"), some("3"), some("4"), some("5"))(
      some((_: String) + (_: String) + (_: String) + (_: String) + (_: String))) must_=== (some(
      "12345"))
  }
