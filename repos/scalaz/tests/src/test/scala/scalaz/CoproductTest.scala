...
object CoproductTest extends SpecLite {
  ...
  object instances {
    ...
    def contravariant[F[_]: Contravariant, G[_]: Contravariant] =
      Contravariant[Coproduct[F, G, ?]]
    def cobind[F[_]: Cobind, G[_]: Cobind] = Cobind[Coproduct[F, G, ?]]
    def traverse[F[_]: Traverse, G[_]: Traverse] = Traverse[Coproduct[F, G, ?]]
    def traverse1[F[_]: Traverse1, G[_]: Traverse1] =
      Traverse1[Coproduct[F, G, ?]]
    def comonad[F[_]: Comonad, G[_]: Comonad] = Comonad[Coproduct[F, G, ?]]

    // checking absence of ambiguity
    def invariantfunctor[F[_]: Comonad: Traverse: Contravariant, G[
        _]: Comonad: Traverse: Contravariant] =
      InvariantFunctor[Coproduct[F, G, ?]]
    def invariantfunctor[F[_]: Functor: Contravariant, G[
        _]: Functor: Contravariant] = InvariantFunctor[Coproduct[F, G, ?]]
    ...
    def foldable[F[_]: Traverse1, G[_]: Traverse1] =
      Foldable[Coproduct[F, G, ?]]
    def traverse[F[_]: Traverse1, G[_]: Traverse1] =
      Traverse[Coproduct[F, G, ?]]
