...
object EitherTest extends SpecLite {
  ...
  checkAll(
    ...
    order.laws[Either.LeftProjection[Int, Int] @@ First])
  checkAll(
  ...
  checkAll(
    "Either.RightProjection @@ Last",
    monoid.laws[Either.RightProjection[Int, Int] @@ Last])
  ...
  checkAll(
    "Either.LeftProjection @@ First",
    monad.laws[λ[α => Either.LeftProjection[α, Int] @@ First]])
  checkAll(
    "Either.RightProjection @@ First",
    monad.laws[λ[α => Either.RightProjection[Int, α] @@ First]])
  checkAll(
    "Either.LeftProjection @@ Last",
    monad.laws[λ[α => Either.LeftProjection[α, Int] @@ Last]])
  checkAll(
    "Either.RightProjection @@ Last",
    monad.laws[λ[α => Either.RightProjection[Int, α] @@ Last]])
