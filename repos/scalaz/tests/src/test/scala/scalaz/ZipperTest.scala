...
object ZipperTest extends SpecLite {
  ...
  "Mapping on a zipper should be the same as mapping on the elements of the stream" !
    forAll { (xs: Stream[Int], a: Int) =>
      val fun: Int => Int = _ + a

      (for (z <- xs.toZipper;
            zM <- (xs map fun).toZipper)
        yield z.map(fun) must_=== (zM)) getOrElse {
        xs.length must_=== (0)
      }
    }
  ...
  "Next changes focus, lefts and rights " !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
      if (r.length > 0) {
  ...
  "Zipper next returns Some when rights is nonempty, none otherwise." !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
      if (r.length > 0)
  ...
  "Zipper nextOr returns a new zipper when used on empty rights or Some of next" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int], alt: Zipper[Int]) =>
      val z = zipper(l, f, r)
      if (r.length > 0) {
  ...
  "Previous Affects Lengths" !
    forAll { (xs: Stream[Int]) =>
      (for (z <- xs.zipperEnd;
            zn <- z.previous)
        yield zn.lefts.length must_===
          (z.lefts.length - 1) and
          (zn.rights.length must_=== (z.rights.length + 1))) getOrElse {
        xs.length mustBe_< (2)
      }
    }

  "previousC moves focus or loops" !
    forAll { z: Zipper[Int] =>
      val zp = z.previousC
  ...
  "Previous changes the focus, lefts and rights " !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
      if (l.length > 0) {
  ...
  "Zipper previousOr returns a new zipper when used on empty rights or Some of next" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int], alt: Zipper[Int]) =>
      val z = zipper(l, f, r)
      if (l.length > 0) {
  ...
  "Zipper tryPrevious returns Some of next or throws" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
      val z = zipper(l, f, r)
      if (l.length > 0) {
  ...
  "deleteRightC moves the focus to the right or if not possible to the first element" !
    forAll { z: Zipper[Int] =>
      (for {
        zd <- z.deleteRightC
      } yield {
  ...
  "deleteRightCOr should return Some of deleteLeftC or an alternative" !
    forAll { (z: Zipper[Int], alt: Zipper[Int]) =>
  ...
  "DeleteRight Affects Lengths and Moves Left if at end" !
    forAll { (xs: Stream[Int]) =>
      (for (z <- xs.zipperEnd;
            zn <- z.deleteRight)
  ...
  "deleteRight moves the focus to the right or if not possible left" !
    forAll { z: Zipper[Int] =>
      (for {
        zd <- z.deleteRight
      } yield {
  ...
  "deleteRightOr should return Some of deleteLeft or an alternative" !
    forAll { (z: Zipper[Int], alt: Zipper[Int]) =>
  ...
  "deleteLeft moves the focus to the left or if not possible right" !
    forAll { z: Zipper[Int] =>
      (for {
        zd <- z.deleteLeft
      } yield {
  ...
  "deleteLeftC moves the focus to the left or if not possible to the last element" !
    forAll { z: Zipper[Int] =>
      (for {
        zd <- z.deleteLeftC
      } yield {
  ...
  "deleteLeftCOr should return Some of deleteLeftC or an alternative" !
    forAll { (z: Zipper[Int], alt: Zipper[Int]) =>
  ...
  "DeleteLeft Affects Lengths and Moves Right if at start" !
    forAll { (xs: Stream[Int]) =>
      (for (z <- xs.toZipper;
            zn <- z.deleteLeft)
        yield zn.rights.length must_=== (z.rights.length - 1)) getOrElse
  ...
  "deleteLeftOr should return Some of deleteLeft or an alternative" !
    forAll { (z: Zipper[Int], alt: Zipper[Int]) =>
      if (z.lefts.length == 0 && z.rights.length == 0)
        z.deleteLeftOr(alt) must_=== (alt)
      else {
  ...
  "DeleteRightC Affects Lengths and Cycles to Start if at end" !
    forAll { (xs: Stream[Int]) =>
      (for (z <- xs.zipperEnd;
            zn <- z.deleteRightC)
  ...
  "DeleteLeftC Affects Lengths and Cycles to end if at start" !
    forAll { (xs: Stream[Int]) =>
      (for (z <- xs.toZipper;
            zn <- z.deleteLeftC)
  ...
  "Move" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int, n: Short) =>
  ...
  "moveOr should return some of move or an alternative" !
    forAll {
  ...
  "Length should return the size of the zipper" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
      zipper(l, f, r).length must_=== (l.length + 1 + r.length)
    }

  "The zipper should be atStart when the lefts stream is empty" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
  ...
  "withFocus should pair only the focus with true, false otherwise" !
    forAll { z: Zipper[Int] =>
      val zf = z.withFocus
  ...
  "start should set the zipper at the start" !
    forAll { z: Zipper[Int] =>
      val zs = z.start
  ...
  "end should set the zipper at the end" !
    forAll { z: Zipper[Int] =>
      val ze = z.end
  ...
  "The zipper should be atEnd when the right stream is empty" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
  ...
  "Find" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int, n: Int, m: Int) =>
      val p = (i: Int) => i < n && i > m
  ...
  "findZ shouldn't change elements" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int, n: Int, m: Int) =>
      val p = (i: Int) => i < n && i > m
      zipper(xs, f, ys)
        .findZ(p)
  ...
  "findZor returns some of find or an alternative" !
    forAll { (z: Zipper[Int], n: Int, m: Int, alt: Zipper[Int]) =>
      val p = (i: Int) => i < n && i > m

      if (z.lefts.find(p).isDefined || p(z.focus) ||
          z.rights.find(p).isDefined) {
  ...
  "findBy if given a function that returns None should not return anything" !
    forAll { z: Zipper[Int] =>
  ...
  "given nextC findBy should return Some if the element exists" !
    forAll(intZipperWithExistingElement) {
      case (z, e) =>
        z.findBy(z => some(z.nextC))(x => x == e).isDefined
    }

  "findBy should not blow the stack" !
    prop { z: Zipper[Int] =>
      var limit = 10 * 1000
      z.findBy(z =>
        if (limit > 0) {
  ...
  "findNext should not blow the stack" !
    forAll(minSizeIntZipper(10 * 1000)) { z =>
      var limit = 10 * 1000
      z.start
        .findNext { x =>
          limit -= 1;
  ...
  "findPrevious should not blow the stack" !
    forAll(minSizeIntZipper(10 * 1000)) { z =>
      var limit = 10 * 1000
      z.end
        .findPrevious { x =>
  ...
  "Update Modifies Zipper Correctly" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int, u: Int) =>
      zipper(xs, f, ys).update(u) must_=== (zipper(xs, u, ys))
    }

  "Modify Modifies Zipper Correctly" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int, u: Int) =>
  ...
  "Start" !
    forAll { (xs: Stream[Int], ys: Stream[Int], f: Int) =>
  ...
  "positions should return a zippers with focus on this" !
    forAll { z: Zipper[Int] =>
      z.positions.focus must_=== (z)
    }

  "positions should return a zippers with all possible positions of a zipper" !
    forAll { z: Zipper[Int] =>
      val indeces =
        z.positions
          .map {
  ...
  "index returns the position of the focus" !
    forAll { (l: Stream[Int], f: Int, r: Stream[Int]) =>
