...
object Binding {
  ...
  private class DefaultBinding[I, A](
    ...
    def validateWith(validators: BindingValidator[T]*): Binding =
      new DefaultBinding(
        field.validateWith(validators: _*),
...
trait BindingSyntax extends BindingValidatorImplicits {
  ...
  def asBoolean(name: String): FieldDescriptor[Boolean] =
    FieldDescriptor[Boolean](name)
  def asByte(name: String): FieldDescriptor[Byte] = FieldDescriptor[Byte](name)
  def asShort(name: String): FieldDescriptor[Short] =
    FieldDescriptor[Short](name)
  ...
  def asFloat(name: String): FieldDescriptor[Float] =
    FieldDescriptor[Float](name)
  def asDouble(name: String): FieldDescriptor[Double] =
    FieldDescriptor[Double](name)
  def asBigDecimal(name: String): FieldDescriptor[BigDecimal] =
    FieldDescriptor[BigDecimal](name)
  def asString(name: String): FieldDescriptor[String] =
