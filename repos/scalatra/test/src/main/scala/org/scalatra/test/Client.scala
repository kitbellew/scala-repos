...
trait Client extends ImplicitConversions {
  ...
  def head[A](
      ...
      params: Iterable[(String, String)] = Seq.empty,
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("HEAD", uri, params, headers) {
      f
    }
  ...
  def post[A](
      ...
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("POST", uri, Seq.empty, headers, body) {
      f
    }
  def post[A](
      uri: String,
    ...
    post(uri, params, files, Seq.empty) {
      f
    }
  def post[A](
      uri: String,
    ...
    submitMultipart("POST", uri, params, headers, files) {
      f
    }
  ...
  def put[A](
    ...
    submit("PUT", uri, Seq.empty, headers, body) {
      f
    }
  def put[A](
      uri: String,
      params: Iterable[(String, String)],
      files: Iterable[(String, Any)])(f: => A): A =
    put(uri, params, files, Seq.empty) {
      f
    }
  def put[A](
      uri: String,
      ...
      files: Iterable[(String, Any)],
      headers: Iterable[(String, String)])(f: => A): A =
    submitMultipart("PUT", uri, params, headers, files) {
      f
    }
  ...
  def delete[A](
      ...
      params: Iterable[(String, String)] = Seq.empty,
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("DELETE", uri, params, headers) {
      f
    }
  ...
  def options[A](
      ...
      params: Iterable[(String, String)] = Seq.empty,
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("OPTIONS", uri, params, headers) {
      f
    }
  ...
  def trace[A](
      ...
      params: Iterable[(String, String)] = Seq.empty,
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("TRACE", uri, params, headers) {
      f
    }
  ...
  def connect[A](
      ...
      params: Iterable[(String, String)] = Seq.empty,
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("CONNECT", uri, params, headers) {
      f
    }
  ...
  def patch[A](
      ...
      body: Array[Byte] = Array(),
      headers: Iterable[(String, String)] = Seq.empty)(f: => A): A =
    submit("PATCH", uri, Seq.empty, headers, body) {
      f
    }
