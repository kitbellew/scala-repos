...
class DataTypeSpec extends Specification {
  ...
  "DataType.apply[T]" should {
    ...
    "return a correct Collection datatype" in {
      ...
      DataType[java.util.Collection[String]] must_== DataType
        .GenArray(DataType.String)
      DataType[java.util.Set[String]] must_== DataType.GenSet(DataType.String)
      DataType[collection.immutable.Seq[String]] must_== DataType
        .GenList(DataType.String)
      DataType[collection.immutable.List[String]] must_== DataType
        .GenList(DataType.String)
      DataType[collection.immutable.Set[String]] must_== DataType
        .GenSet(DataType.String)
      DataType[collection.mutable.Seq[String]] must_== DataType
        .GenList(DataType.String)
      DataType[collection.mutable.Buffer[String]] must_== DataType
        .GenList(DataType.String)
      DataType[collection.mutable.ListBuffer[String]] must_== DataType
        .GenList(DataType.String)
      DataType[collection.mutable.Set[String]] must_== DataType
        .GenSet(DataType.String)
    }
